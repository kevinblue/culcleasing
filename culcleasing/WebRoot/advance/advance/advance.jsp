...
<form name="form1" method="post" action="advance_save.jsp" onSubmit="return checkdata(this);">	
<div id=bgDiv>
...
<table border="0" cellspacing="0" cellpadding="0" height="30">
	  <tr>
		<td><a href="advance_update.jsp?czid=<%= czid %>"  accesskey="m" title="修改(Alt+M)" class="fontcolor">
