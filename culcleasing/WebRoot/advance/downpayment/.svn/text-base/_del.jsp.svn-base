...
String sqlstr = "select dbo.FK_GETVouchNo(views.contract_id) VouchNo,info.contract_id,info.equip_sn,views.device_type,views.cust_name,stock_place,views.leas_mode,views.sale_name,isnull(views.peroid_payment,0) peroid_payment,isnull(dbo.fk_getfactmoney(views.contract_id),0) factmoney,dbo.fk_getfactinfo(views.contract_id) fact_info,isnull(views.peroid_payment,0)-isnull(dbo.fk_getfactmoney(views.contract_id),0) equals,views.insurance_flag,views.insurance,views.csa_cost,info.remark,info.confirm_date from downpayment_info info join contract_view views on info.contract_id = views.contract_id where info.downpayment_id = '"+czid+"'";
...
<table border="0" cellspacing="0" cellpadding="0" width="98%" align="center" class="tab_table_title">
  ...
  <tr>
    ...
    <td>实收情况</td>
    <td><input name="fact_info" type="text" size="20" maxB="50" readonly value="<%= fact_info %>"></td>
  </tr>
  <tr>
    <td>首付差额</td>
  ...
  <tr>
    ...
    <td>确认日期</td>
    <td><input name="confirm_date" type="text" size="20" maxB="50" readonly value="<%= confirm_date %>"></td>
    <td>VouchNo</td>
    <td><input name="VouchNo" type="text" size="20" maxB="50" readonly value="<%= VouchNo %>"></td>
  </tr>
  <tr>
    <td>备注</td>
    <td colspan="3"><textarea name="remark" cols="20" rows="5" maxb="100" style="width:536px" readonly><%= remark %></textarea></td>
  </tr>
</table>
<br>
