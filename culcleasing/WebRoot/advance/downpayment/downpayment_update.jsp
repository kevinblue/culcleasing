...
int canedit=0;
if (right.CheckRight("advance-downpayment-mod",dqczy)>0) canedit=1;
...
if ( rs.next() ) {
	stock_place = getDBStr( rs.getString("stock_place") );
		...
		notarial_charge = getMoneyStr( rs.getString("notarial_charge") );
...
<table border="0" cellspacing="0" cellpadding="0" width="98%" align="center" class="tab_table_title">
  <tr>
    <td>机编号</td>
    <td><input name="equip_sn" type="text"  size="20" maxB="50" readonly Require="true" value="<%= equip_sn %>"><input type="hidden" name="contract_id" value="<%= contract_id %>"><!--<img src="../../images/sbtn_more.gif" alt="选" width="19" height="19" align="absmiddle"  style="cursor:pointer" onClick="OpenDataWindow('','','','','机编号',  'downpayment_view','equip_sn','contract_id|cust_name|leas_mode|sale_name|peroid_payment|factmoney|fact_info|equals|insurance_flag|insurance|csa_cost|VouchNo','equip_sn','','','form1.equip_sn','form1.contract_id|form1.cust_name|form1.leas_mode|form1.sale_name|form1.peroid_payment|form1.factmoney|form1.fact_info|form1.equals|form1.insurance_flag|form1.insurance|form1.csa_cost|form1.VouchNo');">-->
   ...
   <tr>
    ...
    <td>库存</td>
    <td><input name="kucun" type="text" size="20" maxB="50" readonly></td>
    <td>分公司</td> 
  ...
  <tr>
    ...
    <td>实收情况</td>
    <td><input name="fact_info" type="text" size="20" maxB="500" readonly value="<%= fact_info %>"></td>
  </tr>
  <tr>
    <td>首付差额</td>
  ...
  <tr>
    <td>CSA</td>
    <td><input name="csa_cost"  type="text" size="15" maxlength="10"  readonly value="<%= csa_cost %>"></td>   
    <td>VouchNo</td>
...
<td>公证费 </td>
    <td><input name="notarial_charge" type="text" size="20" maxB="50"  value="<%= notarial_charge %>" dateType="Money"> </td>
    <td></td><td></td><td></td>
</tr>
  <tr>
    <td>备注</td>
