...
<table border="0" cellspacing="0" cellpadding="0" width="98%" align="center" class="tab_table_title">
  ...
  <tr>    
    ...
    <td>特批延期付款天数</td>
    <td><input name="special_date"  type="text" value="<%= special_date_number %>" size="15" maxlength="10"  onChange="delaydate()" readonly></td>
  </tr>
  <tr>    
    <td>最终还款期限</td>
    <td><input name="income_total" type="text" onChange="delay()" value="<%= special_date %>" size="20" maxB="50"  readonly></td>
    <td></td>
    <td></td>
    <td></td>
    <td></td>
