...
<form name="form1" method="post" action="dunarea_save.jsp" onSubmit="return Validator.Validate(this,3);">
<div id=bgDiv>
...
<%
	...
	String sqlstr = "SELECT jb_csxx.id as csid,jb_csxx.csmc,jb_ssxx.sfmc,base_user.name,base_user.id as userid FROM base_user RIGHT OUTER JOIN dunning_area ON base_user.id = dunning_area.dun RIGHT OUTER JOIN jb_csxx LEFT OUTER JOIN jb_ssxx ON jb_csxx.sfid = jb_ssxx.id ON dunning_area.city_id = jb_csxx.id where jb_csxx.id='" + czid + "'"; 
