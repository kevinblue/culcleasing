...
int canedit=0;
if (right.CheckRight("baseinfo-ebankacc-add",dqczy)>0) canedit=1;
%>
<script>
if (<%=canedit%>==0){
	window.close();
...
<table border="0" cellspacing="0" cellpadding="0" width="98%" align="center" class="tab_table_title">
  <tr>
    <td>银行账户</td>
    <td><input name="account" type="text" size="20" maxB="50" Require="true">
    <span class="biTian">*</span></td>

    <td>对应代码</td>
    <td><input name="code" type="text" size="20" maxB="50" Require="true">
    <span class="biTian">*</span></td>
  </tr>
</table>
</div>
