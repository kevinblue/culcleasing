...
<form name="form1" method="post" action="module_save.jsp" onSubmit="return Validator.Validate(this,3);">
<div id=bgDiv>
...
<table class="tab_table_title" border="0" cellspacing="0" cellpadding="0" width="100%">
  <tr>
    <td>模块编号</td>
    <td><input name="module_id" type="text" size="20" maxB="50" Require="true" value="<%= module_id%>" readonly>
    <span class="biTian">*</span></td>

    <td>模块名称</td>
    <td><input name="module_name" type="text" size="20" maxB="100" Require="true" value="<%= module_name%>">
    <span class="biTian">*</span></td>
  </tr>
