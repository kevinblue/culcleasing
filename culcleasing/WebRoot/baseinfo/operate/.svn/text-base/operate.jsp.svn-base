...
<form name="form1" method="post" action="operate_save.jsp" onSubmit="return checkdata(this);">	
<div id=bgDiv>
...
<table border="0" cellspacing="0" cellpadding="0" height="30">
	  <tr>
		<td><a href="operate_mod.jsp?czid=<%= czid %>"  accesskey="m" title="修改(Alt+M)" class="fontcolor">
...
<table border="0" cellspacing="0" cellpadding="0" width="98%" align="center" class="tab_table_title">
  <tr>
    <td scope="row" nowrap width="20%">操作编号：</td>
    <td><%=operate_id %></td>
