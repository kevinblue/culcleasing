...
sqlstr+= "rate_subsidy,discount_rate,other_income,other_expenditure,consulting_fee_in,consulting_fee,insure_money,start_date";
sqlstr+= " from proj_condition_temp where proj_id='"+proj_id+"' and measure_id='"+doc_id+"'";
/* 
名称	收支情况
1-设备金额	支  equip_amt
...
//2.1先删除资金计划付款前提数据
sqlstr = "delete from proj_fund_fund_charge_condition_temp where payment_id in(select payment_id from proj_fund_fund_charge_plan_temp ";
...
sqlstr = "insert into proj_fund_fund_charge_plan_temp(measure_id,proj_id,pay_type,fee_type,fee_num,plan_date,plan_money,currency,pay_obj,";
sqlstr+=" pay_bank_name,pay_bank_no,pay_way,fpnote,creator,create_date,modificator,modify_date)";
// 付款 -- 设备款
sqlstr+=" select '"+doc_id+"','"+proj_id+"',null,'17','1',null,'"+equip_amt+"','"+currency+"',null,";
...
if(!"".equals(discount_rate) && discount_rate!=null && !"0".equals(discount_rate) && !"0.00".equals(discount_rate)){
	sqlstr+=" union select '"+doc_id+"','"+proj_id+"',null,'24','1',null,'"+discount_rate+"','"+currency+"',null,";
	sqlstr+=" null,null,'付款',null,'"+dqczy+"','"+datestr+"','"+dqczy+"','"+datestr+"'";
} 
...
if(!"".equals(other_expenditure) && other_expenditure!=null && !"0".equals(other_expenditure) && !"0.00".equals(other_expenditure)){
	sqlstr+=" union select '"+doc_id+"','"+proj_id+"',null,'21','1',null,'"+other_expenditure+"','"+currency+"',null,";
	sqlstr+=" null,null,'付款',null,'"+dqczy+"','"+datestr+"','"+dqczy+"','"+datestr+"'";
}
// 付款 -- 14-咨询费支出	支  consulting_fee
if(!"".equals(consulting_fee) && consulting_fee!=null && !"0".equals(consulting_fee) && !"0.00".equals(consulting_fee)){
	sqlstr+=" union select '"+doc_id+"','"+proj_id+"',null,'18','1',null,'"+consulting_fee+"','"+currency+"',null,";
	sqlstr+=" null,null,'付款',null,'"+dqczy+"','"+datestr+"','"+dqczy+"','"+datestr+"'";
}
// 付款 -- 15-保费金额	支  insure_money
if(!"".equals(insure_money) && insure_money!=null && !"0".equals(insure_money) && !"0.00".equals(insure_money)){
	sqlstr+=" union select '"+doc_id+"','"+proj_id+"',null,'26','1',null,'"+insure_money+"','"+currency+"',null,";
	sqlstr+=" null,null,'付款',null,'"+dqczy+"','"+datestr+"','"+dqczy+"','"+datestr+"'";
}
// 收款 -- 2-首付款   	收  first_payment
sqlstr+=" union select '"+doc_id+"','"+proj_id+"',null,'11','1','"+start_date+"','"+first_payment+"','"+currency+"','"+cust_id+"',";
...
if(!"".equals(caution_money) && caution_money!=null && !"0".equals(caution_money)  && !"0.00".equals(caution_money)){
	sqlstr+=" union select '"+doc_id+"','"+proj_id+"',null,'15','1','"+start_date+"','"+caution_money+"','"+currency+"','"+cust_id+"',";
	sqlstr+=" null,null,'收款',null,'"+dqczy+"','"+datestr+"','"+dqczy+"','"+datestr+"'";
}
...
if(!"".equals(handling_charge) && handling_charge!=null && !"0".equals(handling_charge) && !"0.00".equals(handling_charge)){
	sqlstr+=" union select '"+doc_id+"','"+proj_id+"',null,'14','1','"+start_date+"','"+handling_charge+"','"+currency+"','"+cust_id+"',";
	sqlstr+=" null,null,'收款',null,'"+dqczy+"','"+datestr+"','"+dqczy+"','"+datestr+"'";
}
// 收款 -- 5-管理费	    收  management_fee
if(!"".equals(management_fee) && management_fee!=null && !"0".equals(management_fee) && !"0.00".equals(management_fee)){
	sqlstr+=" union select '"+doc_id+"','"+proj_id+"',null,'16','1','"+start_date+"','"+management_fee+"','"+currency+"','"+cust_id+"',";
	sqlstr+=" null,null,'收款',null,'"+dqczy+"','"+datestr+"','"+dqczy+"','"+datestr+"'";
}
// 收款 -- 6-残值收入	收  nominalprice
if(!"".equals(nominalprice) && nominalprice!=null && !"0".equals(nominalprice) && !"0.00".equals(nominalprice)){
	sqlstr+=" union select '"+doc_id+"','"+proj_id+"',null,'23','1','"+start_date+"','"+nominalprice+"','"+currency+"','"+cust_id+"',";
	sqlstr+=" null,null,'收款',null,'"+dqczy+"','"+datestr+"','"+dqczy+"','"+datestr+"'";
}
// 收款 -- 7-厂商返利	收  return_amt
if(!"".equals(return_amt) && return_amt!=null && !"0".equals(return_amt) && !"0.00".equals(return_amt)){
	sqlstr+=" union select '"+doc_id+"','"+proj_id+"',null,'13','1','"+start_date+"','"+return_amt+"','"+currency+"','"+cust_id+"',";
	sqlstr+=" null,null,'收款',null,'"+dqczy+"','"+datestr+"','"+dqczy+"','"+datestr+"'";
}
...
if(!"".equals(before_interest) && before_interest!=null && !"0".equals(before_interest) && !"0.00".equals(before_interest)){
	sqlstr+=" union select '"+doc_id+"','"+proj_id+"',null,'22','1','"+start_date+"','"+before_interest+"','"+currency+"','"+cust_id+"',";
	sqlstr+=" null,null,'收款',null,'"+dqczy+"','"+datestr+"','"+dqczy+"','"+datestr+"'";
}
// 收款 -- 9-利息补贴	收  rate_subsidy
if(!"".equals(rate_subsidy) && rate_subsidy!=null && !"0".equals(rate_subsidy) && !"0.00".equals(rate_subsidy)){
	sqlstr+=" union select '"+doc_id+"','"+proj_id+"',null,'27','1','"+start_date+"','"+rate_subsidy+"','"+currency+"','"+cust_id+"',";
	sqlstr+=" null,null,'收款',null,'"+dqczy+"','"+datestr+"','"+dqczy+"','"+datestr+"'";
}
// 收款 -- 11-其他收入	收  other_income
if(!"".equals(other_income) && other_income!=null && !"0".equals(other_income) && !"0.00".equals(other_income)){
	sqlstr+=" union select '"+doc_id+"','"+proj_id+"',null,'20','1','"+start_date+"','"+other_income+"','"+currency+"','"+cust_id+"',";
	sqlstr+=" null,null,'收款',null,'"+dqczy+"','"+datestr+"','"+dqczy+"','"+datestr+"'";
}
...
if(!"".equals(consulting_fee_in) && consulting_fee_in!=null && !"0".equals(consulting_fee_in) && !"0.00".equals(consulting_fee_in)){
	sqlstr+=" union select '"+doc_id+"','"+proj_id+"',null,'25','1','"+start_date+"','"+consulting_fee_in+"','"+currency+"','"+cust_id+"',";
	sqlstr+=" null,null,'收款',null,'"+dqczy+"','"+datestr+"','"+dqczy+"','"+datestr+"'";
}
