...
System.out.println("名称======="+uploadFileName);
//if("不规则".equals(uploadFileName.substring(0,3))){
//conditionBean.setSettle_method("RentCalcType10");//不规则强行转换
//}else{
	   ...
	   if(saObjectFile[j]!=null&&!saObjectFile[j].equals("")){
		  ...
		  if(execlBean.isFlag()){
				...
				**/
				...
				System.out.println("irr========================= "+conditionBean.getPlan_irr());
				//--实际Irr与计划plan_irr保持一致
				conditionBean.setIrr(conditionBean.getPlan_irr());
				System.out.println("irr========================= "+conditionBean.getIrr());
				//达标Irr 与是否达标
