...
<%
	...
	System.out.println("测试irr数据===="+conditionBean.getIrr());
...
System.out.println("没有数据"+conditionBean.getEquip_amt());
System.out.println("没有数据"+conditionBean.getRate_float_amt());
%>
	...
	<div id="TD_tab_0">
		<table  border="0" cellspacing="0" cellpadding="0" width="100%" height=100%" align="center" class="tab_table_title">
			...
			<tr>
		        ...
		        &nbsp;&nbsp;|
				<BUTTON class="btn_2" id="uplLoadBt" onClick="dataHander('add_modal','cond_upload.jsp?contract_id=<%=contract_id %>&doc_id=<%=doc_id %>');">
		  ...
		  <tr>	
		   ...
		   <tr>
		    ...
		    <td>
		    	<input name="assets_value" type="text" value="0" dataType="Money" size="13" maxlength="20" maxB="20" />
			</td>
		  </tr>
		...
		<tr>
		    ...
		    <td colspan="">
		    	<input name="pena_rate" id="pena_rate" type="text" value="10"  
		         size="13" maxlength="20" dataType="Double" size="13" maxB="20"  Require="true" />%%
