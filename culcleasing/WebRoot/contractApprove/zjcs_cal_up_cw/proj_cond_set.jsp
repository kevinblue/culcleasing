...
//表单提交事件
	...
	//保险方式变更
	function insureType(insure){
		if("insure_type2"==insure){
			$("select[name='insure_pay_type']").removeAttr("disabled");
		}else{
			$("select[name='insure_pay_type']").val("root.insurPayType.004");  
			$("select[name='insure_pay_type']").attr("disabled","disabled");
		}
	}
</script>
</head>
...
System.out.println("没有数据"+conditionBean.getSettle_method());
%>
	...
	<div id="TD_tab_0">
		<table  border="0" cellspacing="0" cellpadding="0" width="100%" height=100%" align="center" class="tab_table_title">
			...
			<tr>
		        ...
		        &nbsp;&nbsp;|
				<BUTTON class="btn_2" onClick="dataHander('add_modal','cond_upload.jsp?contract_id=<%=contract_id %>&doc_id=<%=doc_id %>');">
		  ...
		  <tr>
		    ...
		    <td>
		    	<input name="equip_amt" id="equip_amt" type="text" 
		    		...
		    		dataType="Money" size="13" maxlength="50" maxB="50"  Require="true" readonly="readonly"/>
		       	<span class="biTian">*</span>
		     </td>
		   ...
		   <td scope="row" nowrap>租赁本金</td>
		    ...
		    <td colspan="">
		    	<input name="management_fee" id="management_fee" type="text" value="0"  
		    		dataType="Money" size="13" maxlength="20" maxB="20"  Require="true" onchange="" readonly="readonly"/> 
				<span class="biTian">*</span>
			</td>
		  </tr>
		  ...
		  <tr>
			<td scope="row" nowrap>咨询费收入</td>
		  	<td>
		  		<input name="consulting_fee_in" id="consulting_fee_in" type="text" value="0"  
					dataType="Money" size="13" maxlength="20" maxB="20"  Require="true" onchange="assignment()" readonly="readonly"/>
				<span class="biTian">*</span>
			</td>
			...
			<td>
				<input name="other_income" id="other_income" type="text" value="0" dataType="Money"
					  size="13" maxlength="20" onchange="assignment()" readonly="readonly" />
			</td>
		  ...
		  <tr>	
			...
			<td>
				<input name="nominalprice" id="nominalprice" type="text" value="0" onchange="assignment()"
					dataType="Money" size="13" maxlength="20" maxB="20"  Require="true" readonly="readonly"/>
				<span class="biTian">*</span>
			</td>
		   ...
		   <tr>
			...
			<td scope="row" nowrap>利息补贴</td>
		  	<td>
		  		<input name="rate_subsidy" id="rate_subsidy" type="text" value="0"  
					dataType="Money" size="13" maxlength="20" maxB="20"  Require="" onchange="assignment()" readonly="readonly"/>
				<span class="biTian"></span>
			</td>
		    ...
		    <td>
		    	<input name="assets_value" id="assets_value" type="text" value="0" dataType="Money" size="13" maxlength="20" maxB="20" readonly="readonly" />
			</td>
		  </tr>
		   ...
		   <td  scope="row" nowrap>租赁年利率</td>
			<td nowrap="nowrap">
				<input name="year_rate" id="year_rate" type="text" value="0.00"  
					dataType="Double" size="13" maxlength="13" maxB="13"  Require="true" readonly="readonly"/>%
				<span class="biTian">*</span>
			</td>
	    ...
	    <tr>
			...
			<td>
			<select style="width:130" name="insure_type" id="insure_type" Require="true" label="投保方式"  onchange="insureType(this.value)" >
			<%
			ERPDataSource erp = new ERPDataSource();
			String invoiceStr = "select title,name from ifelc_conf_dictionary where parentid = 'insure_type' and useflag='0' order by name ";
			ResultSet rsdic= erp.executeQuery(invoiceStr);
			while(rsdic.next()){
				String title = rsdic.getString("title");
				String name = rsdic.getString("name");
				%>
			...
			<td  scope="row" nowrap>保费收取方式</td>
			<td>
			<select style="width:100" name="insure_pay_type" id="insure_pay_type" Require="true" label="保费收取方式"  >
			 <%
			ERPDataSource erp1 = new ERPDataSource();
			String invoiceStr1 = "select title,name from ifelc_conf_dictionary where parentid = 'root.insurPayType' and useflag='0' order by name ";
			ResultSet rsdic1= erp1.executeQuery(invoiceStr1);
			while(rsdic1.next()){
				String title = rsdic1.getString("title");
				String name = rsdic1.getString("name");
				%>
				<option value ="<%=name %>"><%=title %></option>
				<%
			}
			...
			%>
				...
				<!--
				<select style="width:100" name="insure_pay_type" id="insure_pay_type" Require="true" label="保费收取方式"></select>
				<script language="javascript" class="text">
			...
			<td>
			<select style="width:100" name="tax_type_invoice" id="tax_type_invoice" Require="true" label="增值税发票类型">
					  <script type="text/javascript">
	    ...
	    <tr>
		    ...
		    <td>
		    	<input name="assess_adjust" type="text" value="0" dataType="Money" size="13" maxlength="10" maxB="10" onchange="changeFirst_payment()" label="考核调整"/>
			</td>
			 -->
			 <!-- sys考核调整隐藏域 -->
