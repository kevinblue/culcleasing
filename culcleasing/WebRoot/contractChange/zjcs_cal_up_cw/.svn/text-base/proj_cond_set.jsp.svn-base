	...
	<div id="TD_tab_0">
		<table  border="0" cellspacing="0" cellpadding="0" width="100%" height=100%" align="center" class="tab_table_title">
			...
			<tr>
				...
				<img src="../../images/save.gif" align="absmiddle" border="0">合同测算</button>
				<%-- 
				&nbsp;&nbsp;&nbsp;
		  ...
		  <tr>	
		   ...
		   <tr>
		    ...
		    <td>
		    	<input name="assets_value" id="assets_value" type="text" value="0" dataType="Money" size="13" maxlength="10" maxB="10" readonly="readonly" />
			</td>
		  </tr>
		   ...
		   <td  scope="row" nowrap>租赁年利率</td>
			<td nowrap="nowrap">
				<input name="year_rate" id="year_rate" type="text" value="0.00"  
					dataType="Rate" size="13" maxlength="10" maxB="10"  Require="true" readonly="readonly"/>%
				<span class="biTian">*</span>
			</td>
		...
		<tr>
			...
			<td>
				<input name="irr" id="irr" type="text" value="0" size="13" maxlength="10"/>%
			</td> 
