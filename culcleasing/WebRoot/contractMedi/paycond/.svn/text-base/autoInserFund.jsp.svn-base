...
//1查询  合同交易结构临时表的资金计划 Contract_condition_temp
...
sqlstr+= " from contract_condition_medi_temp where contract_id='"+contract_id+"' and doc_id='"+doc_id+"'";
...
//2插入contract_fund_fund_charge_condition_temp 合同资金计划临时表
//2.1先删除合同资金计划付款前提数据
sqlstr = "delete from contract_fund_fund_charge_condition_temp where payment_id in(select payment_id from contract_fund_fund_charge_plan_temp ";
sqlstr +=" where contract_id='"+contract_id+"' and doc_id='"+doc_id+"')";
db.executeUpdate(sqlstr);

//2.2先删除合同资金计划数据
sqlstr = "delete from contract_fund_fund_charge_plan_temp where contract_id='"+contract_id+"' and doc_id='"+doc_id+"'";
db.executeUpdate(sqlstr);
...
sqlstr = "insert into contract_fund_fund_charge_plan_temp(payment_id,doc_id,contract_id,pay_type,fee_type,fee_num,fee_name,plan_date,plan_status,curr_plan_money,plan_money,currency,pay_obj,";
sqlstr+=" pay_bank_name,pay_bank_no,pay_way,fpnote,creator,create_date,modificator,modify_date)";
//付款 -- 设备款
sqlstr+=" select '"+CommonTool.getUUID()+"','"+doc_id+"','"+contract_id+"',null,'17','1','设备款',null,'未核销','"+equip_amt+"','"+equip_amt+"','"+currency+"',null,";
...
if(!"".equals(discount_rate) && discount_rate!=null && !"0".equals(discount_rate) && !"0.00".equals(discount_rate)){
	sqlstr+=" union select '"+CommonTool.getUUID()+"','"+doc_id+"','"+contract_id+"',null,'24','1','贴现息',null,'未核销','"+discount_rate+"','"+discount_rate+"','"+currency+"',null,";
	sqlstr+=" null,null,'付款',null,'"+dqczy+"','"+datestr+"','"+dqczy+"','"+datestr+"'";
} 
...
if(!"".equals(other_expenditure) && other_expenditure!=null && !"0".equals(other_expenditure) && !"0.00".equals(other_expenditure)){
	sqlstr+=" union select '"+CommonTool.getUUID()+"','"+doc_id+"','"+contract_id+"',null,'21','1','其他支出',null,'未核销','"+other_expenditure+"','"+other_expenditure+"','"+currency+"',null,";
	sqlstr+=" null,null,'付款',null,'"+dqczy+"','"+datestr+"','"+dqczy+"','"+datestr+"'";
}
...
if(!"".equals(consulting_fee_out) && consulting_fee_out!=null && !"0".equals(consulting_fee_out) && !"0.00".equals(consulting_fee_out)){
	sqlstr+=" union select '"+CommonTool.getUUID()+"','"+doc_id+"','"+contract_id+"',null,'18','1','咨询费支出',null,'未核销','"+consulting_fee_out+"','"+consulting_fee_out+"','"+currency+"',null,";
	sqlstr+=" null,null,'付款',null,'"+dqczy+"','"+datestr+"','"+dqczy+"','"+datestr+"'";
}
// 付款 -- 15-保费金额	支  insure_money
//if(!"".equals(insure_money) && insure_money!=null && !"0".equals(insure_money) && !"0.00".equals(insure_money)){
	//sqlstr+=" union select '"+CommonTool.getUUID()+"','"+doc_id+"','"+contract_id+"',null,'26','1','保费金额',null,'未核销','"+insure_money+"','"+insure_money+"','"+currency+"',null,";
	//sqlstr+=" null,null,'付款',null,'"+dqczy+"','"+datestr+"','"+dqczy+"','"+datestr+"'";
//}

// 收款 -- 2-首付款   	收  first_payment
if(!"".equals(caution_money) && caution_money!=null && !"0".equals(caution_money)  && !"0.00".equals(caution_money)){
	sqlstr+=" union select '"+CommonTool.getUUID()+"','"+doc_id+"','"+contract_id+"',null,'11','1','首付款','"+rent_start_date+"','未核销','"+first_payment+"','"+first_payment+"','"+currency+"','"+cust_id+"',";
	sqlstr+=" null,null,'收款',null,'"+dqczy+"','"+datestr+"','"+dqczy+"','"+datestr+"'";
}
// 收款 -- 3-租赁保证金	收  caution_money
if(!"".equals(caution_money) && caution_money!=null && !"0".equals(caution_money)  && !"0.00".equals(caution_money)){
	sqlstr+=" union select '"+CommonTool.getUUID()+"','"+doc_id+"','"+contract_id+"',null,'15','1','租赁保证金','"+rent_start_date+"','未核销','"+caution_money+"','"+caution_money+"','"+currency+"','"+cust_id+"',";
	sqlstr+=" null,null,'收款',null,'"+dqczy+"','"+datestr+"','"+dqczy+"','"+datestr+"'";
	
	//生成一笔保证金支付 30 
	sqlstr+=" union select '"+CommonTool.getUUID()+"','"+doc_id+"','"+contract_id+"',null,'30','1','退款保证金',null,'未核销','"+caution_money+"','"+caution_money+"','"+currency+"','"+cust_id+"',";
	sqlstr+=" null,null,'付款',null,'"+dqczy+"','"+datestr+"','"+dqczy+"','"+datestr+"'";
}
...
if(!"".equals(handling_charge) && handling_charge!=null && !"0".equals(handling_charge) && !"0.00".equals(handling_charge)){
	sqlstr+=" union select '"+CommonTool.getUUID()+"','"+doc_id+"','"+contract_id+"',null,'14','1','租赁手续费','"+rent_start_date+"','未核销','"+handling_charge+"','"+handling_charge+"','"+currency+"','"+cust_id+"',";
	sqlstr+=" null,null,'收款',null,'"+dqczy+"','"+datestr+"','"+dqczy+"','"+datestr+"'";
}
// 收款 -- 5-管理费	    收  management_fee
if(!"".equals(management_fee) && management_fee!=null && !"0".equals(management_fee) && !"0.00".equals(management_fee)){
	sqlstr+=" union select '"+CommonTool.getUUID()+"','"+doc_id+"','"+contract_id+"',null,'16','1','管理费','"+rent_start_date+"','未核销','"+management_fee+"','"+management_fee+"','"+currency+"','"+cust_id+"',";
	sqlstr+=" null,null,'收款',null,'"+dqczy+"','"+datestr+"','"+dqczy+"','"+datestr+"'";
}
// 收款 -- 6-残值收入	收  nominalprice
if(!"".equals(nominalprice) && nominalprice!=null && !"0".equals(nominalprice) && !"0.00".equals(nominalprice)){
	sqlstr+=" union select '"+CommonTool.getUUID()+"','"+doc_id+"','"+contract_id+"',null,'23','1','残值收入','"+rent_start_date+"','未核销','"+nominalprice+"','"+nominalprice+"','"+currency+"','"+cust_id+"',";
	sqlstr+=" null,null,'收款',null,'"+dqczy+"','"+datestr+"','"+dqczy+"','"+datestr+"'";
}
// 收款 -- 7-厂商返利	收  return_amt
if(!"".equals(return_amt) && return_amt!=null && !"0".equals(return_amt) && !"0.00".equals(return_amt)){
	sqlstr+=" union select '"+CommonTool.getUUID()+"','"+doc_id+"','"+contract_id+"',null,'13','1','厂商返利','"+rent_start_date+"','未核销','"+return_amt+"','"+return_amt+"','"+currency+"','"+cust_id+"',";
	sqlstr+=" null,null,'收款',null,'"+dqczy+"','"+datestr+"','"+dqczy+"','"+datestr+"'";
}
...
if(!"".equals(before_interest) && before_interest!=null && !"0".equals(before_interest) && !"0.00".equals(before_interest)){
	sqlstr+=" union select '"+CommonTool.getUUID()+"','"+doc_id+"','"+contract_id+"',null,'22','1','租前息','"+rent_start_date+"','未核销','"+before_interest+"','"+before_interest+"','"+currency+"','"+cust_id+"',";
	sqlstr+=" null,null,'收款',null,'"+dqczy+"','"+datestr+"','"+dqczy+"','"+datestr+"'";
}
// 收款 -- 9-利息补贴	收  rate_subsidy
if(!"".equals(rate_subsidy) && rate_subsidy!=null && !"0".equals(rate_subsidy) && !"0.00".equals(rate_subsidy)){
	sqlstr+=" union select '"+CommonTool.getUUID()+"','"+doc_id+"','"+contract_id+"',null,'27','1','利息补贴','"+rent_start_date+"','未核销','"+rate_subsidy+"','"+rate_subsidy+"','"+currency+"','"+cust_id+"',";
	sqlstr+=" null,null,'收款',null,'"+dqczy+"','"+datestr+"','"+dqczy+"','"+datestr+"'";
}
// 收款 -- 11-其他收入	收  other_income
if(!"".equals(other_income) && other_income!=null && !"0".equals(other_income) && !"0.00".equals(other_income)){
	sqlstr+=" union select '"+CommonTool.getUUID()+"','"+doc_id+"','"+contract_id+"',null,'20','1','其他收入','"+rent_start_date+"','未核销','"+other_income+"','"+other_income+"','"+currency+"','"+cust_id+"',";
	sqlstr+=" null,null,'收款',null,'"+dqczy+"','"+datestr+"','"+dqczy+"','"+datestr+"'";
}
...
if(!"".equals(consulting_fee_in) && consulting_fee_in!=null && !"0".equals(consulting_fee_in) && !"0.00".equals(consulting_fee_in)){
	sqlstr+=" union select '"+CommonTool.getUUID()+"','"+doc_id+"','"+contract_id+"',null,'25','1','咨询费收入','"+rent_start_date+"','未核销','"+consulting_fee_in+"','"+consulting_fee_in+"','"+currency+"','"+cust_id+"',";
	sqlstr+=" null,null,'收款',null,'"+dqczy+"','"+datestr+"','"+dqczy+"','"+datestr+"'";
}
...
LogWriter.logDebug(request, "自动生成合同的资金计划，合同编号："+contract_id);

String sqlLog = LogWriter.getSqlIntoDB(request, "签约审批", "资金计划", "自动生成合同："+contract_id+" 资金计划数据", sqlstr.substring(0,20));
