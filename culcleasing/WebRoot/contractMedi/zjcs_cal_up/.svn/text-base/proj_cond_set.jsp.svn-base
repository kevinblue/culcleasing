...
<%
	...
	//1.加载ConditionBean
	ConditionMediBean conditionMediBean = ConditionMediService.initConditionContractBean(contract_id, doc_id);
		...
		<table  border="0" cellspacing="0" cellpadding="0" width="100%" height=100%" align="center" class="tab_table_title">
			...
			<tr>
				<td colspan="8" align="left">
					<BUTTON class="btn_2" onClick="verification()">
		  ...
		  <tr>
		  	...
		  	<td>
	    		<input type="radio" name="is_floor" value="是" onclick="changeFloor()" checked="checked">是
	    		<input type="radio" name="is_floor" value="否" onclick="changeFloor()">否
		  	</td>
