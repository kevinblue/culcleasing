...
//获取计划收款银行、账号
sqlstr = "SELECT plan_bank_name,plan_bank_no FROM contract_condition_medi_temp where contract_id='"+contract_id+"' and doc_id='"+doc_id+"' ";
ResultSet rs = null;
...
//执行插入医疗管理租金计划
//1.0删除
sqlstr = "Delete from fund_rent_plan_contract_bd_medi_temp where contract_id='"+contract_id+"' and doc_id='"+doc_id+"'";
