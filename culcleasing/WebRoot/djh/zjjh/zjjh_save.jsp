...
ResultSet rs=null;
	...
	String allpath =path + "\\upload\\zjjh\\"+datestr+"\\";
		...
		System.out.print(allpath+saObjectFile[j]);
			...
			if(execlBean.getFlag()){
				...
				for(int row=0;row<obj.length;row++){
					...
					String id=formatNumberDoubleZero(objrow[0]);
					String invoice_no =formatNumberDoubleZero(objrow[29]);
					sqlstr="update fund_rent_income set invoice_no='"+invoice_no+"' where id='"+id+"'";
	...
	%>
    <script>
		opener.window.location.href = "zjjh_list.jsp";
		this.close();
	</script>