...
<title>资金支付管理 - 单据号上传</title>
<link href="../../css/global.css" rel="stylesheet" type="text/css">
<script src="../../js/comm.js"></script>
</head>

<body>
<form name="list" action="zjjh_save.jsp" enctype="multipart/form-data" method="post" onSubmit="">
				...
				<tr>
					<td>
						<table border="0" cellspacing="0" cellpadding="0">    
							<tr class="maintab_dh">
								<td nowrap id="saveTd">
									<BUTTON class="btn_2" name="btnSave" value="保存清单数据"  type="submit">
									<img src="../../images/save.gif" align="absmiddle" border="0">保存清单数据</button>
								</td>
							</tr>
						</table>
					</td>
...
function fun_save(){
	if(confirm("确认要上传该清单文件"+document.forms[0].name1.value)){
	document.forms[0].action="zjjh_save.jsp";
