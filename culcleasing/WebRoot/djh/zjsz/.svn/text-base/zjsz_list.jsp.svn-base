    ...
    <tr class="maintab">
      <td align="left" width="30%"><table border="0" cellspacing="0" cellpadding="0" >
          ...
          <td>显示规则:<select name="searchFld"><script>w(mSetOpt("<%= searchFld %>","无单据号|有单据号|全部显示"));</script></select><input name="image" type="image" src="../../images/tbtn_searh.gif" alt="查询" align="absmiddle"  onclick="searchbar.submit();"></td>
            <td><a href="#" accesskey="u" onClick="dataHander('add_modal','zjsz_upload.jsp',dataNav.itemselect);"><img src="../../images/sbtn_2Excel.gif" alt="导入(Alt+U)" width="19" height="19" align="absmiddle"></a></td>
            <td><a href="zjsz_out.jsp"><img src="../../images/sbtn_down.gif" alt="导出(Alt+U)" width="19" height="19" align="absmiddle"></td>
          </tr>
        </table></td>
