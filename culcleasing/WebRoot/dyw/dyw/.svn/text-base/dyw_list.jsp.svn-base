...
<title>抵押物列表- 抵押物</title>
<link href="../../css/global.css" rel="stylesheet" type="text/css">
<script src="../../js/comm.js"></script>
</head>

<body>
<form action="dyw_list.jsp" name="dataNav" onSubmit="return goPage()">
...
%>
      ...
      <tr class="cwDLRow" >
		...
		<td align="left"><a href="dyw.jsp?id=<%= getDBStr( rs.getString("id") ) %>" target="_blank"><%= getDBStr( rs.getString("eqip_name") ) %></a></td> 
        ...
        <td><%=getDBStr( rs.getString("deal_info") ) %></td>
        <td><%=getDBDateStr( rs.getString("deal_date") ) %></td>
