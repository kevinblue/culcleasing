...
sqlstr ="select *,dict.title as paymethod from apply_info left join dbo.ifelc_conf_dictionary dict ";
sqlstr+=" on dict.name=apply_info.pay_method where apply_info.id='"+czid+"'";
...
<table border="0" cellspacing="0" cellpadding="0" width="98%" align="center" class="tab_table_title">
 <tr>
    ...
    <td>&nbsp;
     ...
     <td scope="row">应付日期:&nbsp;&nbsp;<b style="color:#E46344;"><%=pay_date %></b></td>
    <td>&nbsp;</td>
  </tr>
