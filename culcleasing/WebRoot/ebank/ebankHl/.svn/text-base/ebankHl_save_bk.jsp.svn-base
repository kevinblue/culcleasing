...
//凭证号
	...
	sqlstr="insert into inter_evidence_info (create_date,evidence_type,evidence_number,evidence_summary,subject_number,debit,credit,acc_set_number,acc_year,acc_month,type_number,line_number,subject_name,client_abbr,vndr_addr,subject_opposite,status,exp_flag) values('"+curr_date+"','银行凭证','"+evidence_number+"','"+evidence_summary+"','"+subject_number+"',"+debit+","+credit+",'0028',"+curr_date.substring(0,4)+","+curr_date.substring(5,7)+",'银',1,'"+subject_name+"','其它','','"+subject_opposite+"','有效','否')";
	...
	sqlstr="insert into inter_evidence_info (create_date,evidence_type,evidence_number,evidence_summary,subject_number,debit,credit,acc_set_number,acc_year,acc_month,type_number,line_number,subject_name,client_abbr,vndr_addr,subject_opposite,status,exp_flag) values('"+curr_date+"','银行凭证','"+evidence_number+"','"+evidence_summary+"','"+subject_number+"',"+debit+","+credit+",'0028',"+curr_date.substring(0,4)+","+curr_date.substring(5,7)+",'银',2,'"+subject_name+"','','其它','"+subject_opposite+"','有效','否')";
