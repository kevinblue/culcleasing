...
%>
<form name="searchbar" action="bank_info.jsp">
...
<%
String sqlstr="select * from base_account where 1=1 "+wherestr+" order by id";//name-name 
ResultSet rs = null;
rs=db.executeQuery(sqlstr); 

%>
<select name="datalist" size="15" ondblclick="ListSelect('ebank_upload_form.bank_name','ebank_upload_form.bank_no');" style="height:80%">
...
<tr>
    <td align="center">
    <input  class="btn3_mouseout" type="button" value="确定" onClick="ListSelect('ebank_upload_form.bank_name','ebank_upload_form.bank_no');">  
