...
sqlstr="select apply.*,dl.skyy as yh,dl.skzh as zh,title,khmc from apply_info  apply left join dl_mpxx dl ";
sqlstr+=" on apply.dld_id=dl.khbh left join dbo.ifelc_conf_dictionary on ifelc_conf_dictionary.name=apply.pay_method "+wherestr+filterAgent+" and pay_type ='资金' and apply.status<>'已驳回'  and isnull(is_sub,'')='已提交' ";
