...
<table border="0" cellspacing="0" cellpadding="0" width="98%" align="center" class="tab_table_title">
 <tr>
    ...
    <td>&nbsp;</td>
	<td scope="row">发起人:&nbsp;&nbsp;<b style="color:#E46344;"><%=subiter %></b></td>
    <td>&nbsp;</td>
    <td scope="row">发起日期:&nbsp;&nbsp;<b style="color:#E46344;"><%=plan_date %></b></td>
    <td>&nbsp;</td>
  </tr>
...
<tbody id="data">
<%
sqlstr = "select vefh.* from vi_ebank_rent_hire_detail vefh where vefh.id in( select plan_id from apply_info_detail where apply_id='"+czid+"' )order by begin_id,rent_list";
