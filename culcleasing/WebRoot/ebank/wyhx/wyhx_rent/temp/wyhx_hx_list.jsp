...
if(!start_date.equals("")){
	wherestr +=" and qz_date>='"+start_date+"'";
}
if(!end_date.equals("")){
	wherestr +=" and qz_date<='"+end_date+"'";
}
if(!proj_id.equals("")){
...
<tr>
<td>客户名称:<input name="cust_name" type="text" size="11" value="<%=cust_name %>"></td>
...
<tr>
<td>代 理 商:<input name="dld_name" type="text" size="11" value="<%=dld_name %>"></td>
<!-- 
