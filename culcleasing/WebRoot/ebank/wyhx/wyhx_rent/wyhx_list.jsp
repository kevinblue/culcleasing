...
<td>客户类型:
	<select name="cust_type" style="width:100px;">
		<script>w(mSetOpt("<%=cust_type %>","|个人|法人"));</script>
	</select>
</td>
<td>
	...
	<tr class="maintab">
		...
		<table border="0" cellspacing="0" cellpadding="0" >    
			<tr class="maintab">
				...
				<td nowrap>
					<input name="ck_all" type="checkbox">页面全选
					<input name="data_ck_all" type="checkbox">数据全选					
				</td>
			</tr>
		</table>
		</td><!--操作按钮结束-->
