...
<table class="tab_table_title" border="0" cellspacing="0" cellpadding="0" width="100%">  
  <tr>
   ...
   <tr>
	...
	<tr>
	<td nowrap class="text">利息互换日：</td>
	<td nowrap class="text">
	
	<input name="fxr_date" type="text" style="width:150px;" readonly="readonly" dataType="Date"  value="<%=getDBDateStr(rs.getString("fxr_date")) %>">
    <img  onClick="openCalendar(fxr_date);return false" style="cursor:pointer; " src="../../images/tbtn_overtime.gif" width="20" 
    height="19" border="0" align="absmiddle">
