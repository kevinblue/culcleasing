	...
	if(savaType.equals("mod")){//修改2次判断
		...
		//	}else{
			   ...
			   sql.append(" UPDATE fund_standard_interest ")
			      .append(" SET start_date = '"+start_date+"' ")
			      .append(" ,rate_half = '"+rate_half+"' ")
			      .append(" ,rate_one = '"+rate_one+"' ")
			      .append(" ,rate_three = '"+rate_three+"' ")
			      .append(" ,rate_five = '"+rate_five+"' ")
			      .append(" ,rate_abovefive = '"+rate_abovefive+"' ")
			      .append(" ,base_rate_half = '"+base_rate_half+"' ")
			      .append(" ,base_rate_one = '"+base_rate_one+"' ")
			      .append(" ,base_rate_three = '"+base_rate_three+"' ")
			      .append(" ,base_rate_five = '"+base_rate_five+"' ")
			      .append(" ,base_rate_abovefive = '"+base_rate_abovefive+"' ")
			      .append(" ,creator = '"+creator+"' ")
			      .append(" ,create_date = '"+create_date+"' ")
			      .append(" ,modificator = '"+modificator+"' ")
			      .append(" ,modify_date = '"+modify_date+"' ")
			      .append(" ,fina_adjust_flag = '"+adjust_flag+"' ")
