...
<%
	...
	//2.查询该项目已签约项目金额
	//String usedMoney = ConditionService.getUsedEquipAmt(contract_id);
...
$(document).ready(function(){
	...
	$("input[name='settle_method']").val("<%=conditionBean.getSettle_method() %>");
	$("select[name='settle_method2']").val("<%=conditionBean.getSettle_method() %>");
	//付租类型： period_type
	//$("#period_type").val("<%=conditionBean.getPeriod_type() %>");
	$("#period_type").val("<%=conditionBean.getPeriod_type() %>");
	$("input[name='period_type']").val("<%=conditionBean.getPeriod_type() %>");
	//设备金额 equip_amt
	...
	$("input[name='income_number_year']").val("<%=conditionBean.getIncome_number_year() %>");
...
<tr valign="top">
	...
	<div id="TD_tab_0">
		<table  border="0" cellspacing="0" cellpadding="0" width="100%" height=100%" align="center" class="tab_table_title">
			...
			<tr>
				...
				<div id="bj_2" style="display: none;float: left;margin-left: 24px;">
		   			<input name="ratio_param" type="text" dataType="Double" value="0.00" size="13" maxlength="10" maxB="10" readonly="readonly" disabled="disabled">
				</div>
				...
				<img src="../../images/save.gif" align="absmiddle" border="0">商务变更</button>
		  ...
		  <tr>
		    ...
		    <td>
		    	<input name="contract_id" id="contract_id" type="text" value="<%=contract_id%>" 
		    		  size="35" maxlength="50" disabled="disabled"/>
		   ...
		   <td scope="row" nowrap>设备金额</td>
		    <td>
		    	<!-- <input name="equip_amt" id="equip_amt" type="text" 
		    		value="<%=proj_money %>" onchange="changeFirst_payment()" 
		    		onblur="checkDataInvalid('<%=proj_money %>','0')"
		    		dataType="Money" size="13" maxlength="50" maxB="50" Require="true"/>
		       	
		       	 -->
		       	 
		       	 
			<input type=text name="equip_amt" id="equip_amt" size="13" value="" 
					dataType="Money" onchange="changeFirst_payment()" onblur="checkDataInvalid('<%=proj_money %>','0')"  disabled="disabled"/>
		     </td>
		      ...
		      <td>
		    	...
		    	maxB="50"  Require="true"  disabled="disabled"/>
		    	<span class="biTian">*</span>
		   	   </td> 
		  ...
		  <tr>
		   ...
		   <td scope="row" nowrap>租赁本金</td>
		     <td>
		    	...
		    	Require="true"  disabled="disabled"/>
		    	<span class="biTian">*</span>
			 </td>
			...
			<td>
				<input name="caution_money" id="caution_money" value="0" 
					...
					onchange="assignment()" type="text" disabled="disabled"/>
				<span class="biTian">*</span>
			</td>
			...
			<td>
				<input name="handling_charge" id="handling_charge" type="text" value="0" 
				 	...
				 	maxB="20"  Require="true" onchange="assignment()" disabled="disabled"/>
				<span class="biTian">*</span>
			</td>
			<td scope="row" nowrap>管理费</td>
		    <td colspan="">
		    	<input name="management_fee" id="management_fee" type="text" value="0"  
		    		dataType="Money" size="13" maxlength="20" maxB="20"  Require="true" onchange="" disabled="disabled"/> 
				<span class="biTian">*</span>
			</td>
		  </tr>
		  ...
		  <tr>
			<td scope="row" nowrap>咨询费收入</td>
		  	<td>
		  		<input name="consulting_fee_in" id="consulting_fee_in" type="text" value="0"  
					dataType="Money" size="13" maxlength="20" maxB="20"  Require="true" onchange="assignment()" disabled="disabled"/>
				<span class="biTian">*</span>
			</td>
			...
			<td>
				<input name="other_income" id="other_income" type="text" value="0" dataType="Money"
					  size="13" maxlength="20" onchange="assignment()"  disabled="disabled"/>
			</td>
		  ...
		  <tr>	
			...
			<td>
				<input name="nominalprice" type="text" value="0" onchange="assignment()"
					dataType="Money" size="13" maxlength="20" maxB="20"  Require="true" disabled="disabled"/>
				<span class="biTian">*</span>
			</td>
			...
			<td>
				<input name="plan_irr" type="text" value="0" size="13" maxlength="10" readonly="readonly" disabled="disabled"/>%
			</td> 
		  </tr>
		   ...
		   <tr>
		    ...
		    <td>
		    	<input name="before_interest" id="before_interest" type="text" value="0"  onchange="changeTwoData()"
		    		dataType="Money" size="13" maxlength="20" maxB="20"  Require="true"  disabled="disabled"/>
		    		是否算本
		    		<input type="radio" name="before_interest_type" value="是" disabled="disabled">是
		    		<input type="radio" name="before_interest_type" value="否" checked="checked" disabled="disabled">否
		    	<span class="biTian">*</span>
			</td>
			<td scope="row" nowrap>利息补贴</td>
		  	<td>
		  		<input name="rate_subsidy" id="rate_subsidy" type="text" value="0"  
					dataType="Money" size="13" maxlength="20" maxB="20"  Require="" onchange="assignment()" disabled="disabled"/>
				<span class="biTian"></span>
			</td>
		    ...
		    <td>
		    	<input name="assets_value" type="text" value="0" dataType="Money" size="13" maxlength="20" maxB="20"  disabled="disabled"/>
			</td>
		  </tr>
		  ...
		  <tr>
		    ...
		    <td>
		    	...
		    	dataType="Money" size="13" maxlength="20" maxB="20" disabled="disabled"/> 
		    		净融资额比例
    				<input name="actual_fund_ratio" id="actual_fund_ratio" type="text" 
					value="" size="5" 
					maxlength="10" readonly="readonly" 
					onclick="getlmp_value()" Require="true"  disabled="disabled"/>% 
    				<span class="biTian">*</span>
			</td>
		  	  <td scope="row" nowrap>付租方式</td>
		    <td >
		    <!-- sys 付租方式 begin-->
		    	<!--<input type="hidden"  name="income_number_year" style="width: 100px;" value="" readonly="readonly" disabled="disabled">
		    	<% if(conditionBean.getIncome_number_year().equals("1")){%>
		    	<input type="text"  name="income_number_year1" style="width: 100px;" value="月付" readonly="readonly" disabled="disabled">
		    	<%}else if(conditionBean.getIncome_number_year().equals("2")){%>
		    	<input type="text"  name="income_number_year1" style="width: 100px;" value="双月付" readonly="readonly" disabled="disabled">
		    	<%}else if(conditionBean.getIncome_number_year().equals("3")){%>
		    	<input type="text"  name="income_number_year1" style="width: 100px;" value="季付" readonly="readonly" disabled="disabled">
		    	<%}else if(conditionBean.getIncome_number_year().equals("6")){%>
		    	<input type="text"  name="income_number_year1" style="width: 100px;" value="半年付" readonly="readonly" disabled="disabled">
		    	<%}else if(conditionBean.getIncome_number_year().equals("12")){%>
		    	<input type="text"  name="income_number_year1" style="width: 100px;" value="年付" readonly="readonly" disabled="disabled">
		    	<%} %>
		    	<!-- end -->
		    	<!--sys -->
		    ...
		    <td>
		    	<input name="income_number" id="income_number" type="text" value="0" onChange="changLeaseT_value()"
		    		dataType="Integer" size="13" maxlength="10" maxB="10"  Require="true" readonly="readonly"  disabled="disabled"/>
		    	<span class="biTian">*</span>
			</td>
		   	<!-- 根据付租方式判断 -->
		    ...
		    <td>
		    	<input name="lease_term" id="lease_term" type="text" value="0"  onClick="changLeaseT_value()" 
		    		dataType="Integer" size="13" maxlength="10" maxB="10"  Require="true" readonly disabled="disabled"/>
		    	<span class="biTian">*</span>
			</td>
		   ...
		   <td  scope="row" nowrap>租赁年利率</td>
			<td nowrap="nowrap">
				<input name="year_rate" id="year_rate" type="text" value="0.00"  
					dataType="Double" size="13" maxlength="13" maxB="13"  Require="true" readonly="readonly" disabled="disabled"/>%
				<span class="biTian">*</span>
			</td>
		...
		<tr>
		    ...
		    <td >
		    	<select name="adjust_style"  style="width:140" disabled="disabled">
			        <script type="text/javascript">
			...
			<td>
				<input name="start_date" id="start_date" type="text" value="<%=nowDateTime%>"  
					 size="13" maxlength="20"  Require="true" readonly="readonly" disabled="disabled"/>
		    ...
		    <td colspan="">
		    	<input name="pena_rate" id="pena_rate" type="text" value="10"  
		         size="13" maxlength="20" dataType="Double" size="13" maxlength="10" maxB="10"  Require="true"  disabled="disabled"/>%%
		    ...
		    <td> 
		    	<input name="free_defa_inter_day" id="free_defa_inter_day" type="text" value="3"  
		            ...
		            alert('请正确输入逾期宽限日');document.all.free_defa_inter_day.focus();}" disabled="disabled"/>
		    	<span class="biTian">*</span>
			</td>
		</tr>
		 <tr>
	    <td scope="row" nowrap>利率浮动类型</td>
		    <td>
		    	<select name="rate_float_type" onchange="changeOne()" style="width:140"  disabled="disabled">
		        <script type="text/javascript">
		    ...
		    <td>
		    	<input name="rate_float_amt" type="text" value="0"  onblur="alertChange()"
		    		dataType="Double" size="13" maxlength="13" maxB="13"  Require="true" disabled="disabled" />
		    	<span class="biTian">*</span>
			</td>
	    </tr>
		<tr>
		    ...
		    <td>
		    	<input type="text" dataType="Double" style="width: 140" name="StandardIrr" value="0"  disabled="disabled"/>%
				  是否达标
		        <input type="radio" name="StandardF" value="是" checked="checked" disabled="disabled">是
		    	<input type="radio" name="StandardF" value="否" disabled="disabled">否
		    	<span class="biTian">*</span>
			</td>
	    ...
	    <tr>
			...
			<select style="width:140px;" name="invoice_type" id="invoice_type" Require="true" label="租金开票方式">
				...
				<!--
				<select style="width:140px;" name="invoice_type" id="invoice_type" Require="true" label="租金开票方式" disabled="disabled"></select>
				<script language="javascript">
			...
			<select style="width:100" name="insure_type" id="insure_type" Require="true" label="投保方式">
				...
				<!--
				<select style="width:100" name="insure_type" id="insure_type" Require="true" label="投保方式" disabled="disabled"></select>
				<script language="javascript" class="text">
			...
			<select style="width:100" name="insure_pay_type" id="insure_pay_type" Require="true" label="保险收取方式">
				...
				<!--
				<select style="width:100" name="insure_pay_type" id="insure_pay_type" Require="true" label="保险收取方式" disabled="disabled"></select>
				<script language="javascript" class="text">
...
<script  type="text/javascript" src="../../js/leasing_rentcalc_shangwu.js"></script>
<script type="text/javascript">
$(document).ready(function() {
