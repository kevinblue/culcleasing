...
<%
	...
	System.out.println("aaaaaaaaaa"+conditionBean.getIrr());
	...
	String sqlstr="update contract_condition_temp set irr='"+irr+"',invoice_type='"+invoice_type+"',insure_type='"+insure_type+"',insur_pay_type='"+insur_pay_type+"'";
