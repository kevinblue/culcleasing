...
$(document).ready(function(){
	...
	//投保方式 insure_type
	$("select[name='insure_type']").val("<%=conditionBean.getInsure_type() %>");
	//预计起租日 start_date
...
<tr valign="top">
	...
	<div id="TD_tab_0">
			...
			<tr>
				...
				<input type="hidden" name="settle_method">
				 <select style="width:130px;" name="settle_method2" id="settle_method" 
					Require="true" onchange="changeCalcWay()"  disabled="disabled">
					<script type="text/javascript">
						w(mSetOpt('',
				...
				<img src="../../images/save.gif" align="absmiddle" border="0">商务条件变更</button>
		   ...
		   <td  scope="row" nowrap>租赁年利率</td>
			<td nowrap="nowrap">
				<input name="year_rate" id="year_rate" type="text" value="0.00"  
					dataType="Double" size="13" maxlength="11" maxB="11"  Require="true" readonly="readonly"/>%
				<span class="biTian">*</span>
			</td>
		...
		<tr>
		    ...
		    <td >
		    	<select name="adjust_style"  style="width:140"  disabled="disabled">
		      	  ...
		      	  批量调息
		        <input type="radio" name="into_batch" value="是" checked="checked" readonly="readonly" style="border: 0px;" disabled="disabled">是
		    	<input type="radio" name="into_batch" value="否" readonly="readonly" style="border: 0px;" disabled="disabled">否
		    	<span class="biTian">*</span>
			</td>
		    ...
		    <td colspan="">
		    	<input name="pena_rate" id="pena_rate" type="text" value="10"  
		         size="13" maxlength="20" dataType="Double" size="13" maxlength="10" maxB="10"  Require="true"  readonly="readonly"/>%%
		    ...
		    <td> 
		    	<input name="free_defa_inter_day" id="free_defa_inter_day" type="text" value="3"  
		            ...
		            alert('请正确输入逾期宽限日');document.all.free_defa_inter_day.focus();}" readonly="readonly"/>
		    	<span class="biTian">*</span>
			</td>
		</tr>
		 <tr>
		...
		<tr>
		    ...
		    <td>
		    	<input type="text" dataType="Double" style="width: 140" name="StandardIrr" value="0" readonly="readonly"/>%
				  是否达标
		        <input type="radio" name="StandardF" value="是" checked="checked" readonly="readonly" style="border: 0px;" disabled="disabled">是
		    	<input type="radio" name="StandardF" value="否" readonly="readonly" style="border: 0px;" disabled="disabled">否
		    	<span class="biTian">*</span>
			</td>
	    ...
	    <tr>
			...
			<select style="width:140px;" name="invoice_type" id="invoice_type" Require="true" label="租金开票方式">
				...
				<!--
				<select style="width:140px;" name="invoice_type" Require="true" label="租金开票方式" disabled="disabled"></select>
				<script language="javascript">
			...
			<select style="width:100" name="insure_type" id="insure_type" Require="true" label="投保方式">
				...
				<!--
				<select style="width:100" name="insure_type" Require="true" label="投保方式" disabled="disabled"></select>
				<script language="javascript" class="text">
			...
			<select style="width:100" name="insure_pay_type" id="insure_pay_type" Require="true" label="保险收取方式">
				...
				<!--
				<select style="width:100" name="insure_pay_type" Require="true" label="保险收取方式" disabled="disabled"></select>
				<script language="javascript" class="text">
			...
			<td>
			<select style="width:100" name="tax_type_invoice" id="tax_type_invoice" Require="true" label="保险收取方式"  disabled="disabled" >
					  <script type="text/javascript">
