...
if(outFlag==0){//没有超出则插入数据库
	...
	sqlstr +="plan_bank_name='"+plan_bank_name+"',plan_bank_no='"+plan_bank_no+"',pay_type='"+pay_type+"',fpnote='"+fpnote+"',tax_type_invoice='"+tax_type_invoice+"',modificator='"+dqczy+"',modify_date='"+datestr+"' where id='"+item_id+"'";
