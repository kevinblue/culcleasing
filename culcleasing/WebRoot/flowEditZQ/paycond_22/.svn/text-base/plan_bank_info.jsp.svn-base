...
%>
<select name="datalist" size="15" ondblclick="ListSelect('form1.plan_bank_name','form1.plan_bank_no');" style="height:80%">
...
<tr>
    <td align="center">
    <input  class="btn3_mouseout" type="button" value="确定" onClick="ListSelect('form1.plan_bank_name','form1.plan_bank_no');">  
