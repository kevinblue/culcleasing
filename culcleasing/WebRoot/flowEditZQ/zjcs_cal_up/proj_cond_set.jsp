	...
	<div id="TD_tab_0">
		<table  border="0" cellspacing="0" cellpadding="0" width="100%" height=100%" align="center" class="tab_table_title">
			...
			<tr>
		        ...
		        &nbsp;&nbsp;|
				<BUTTON class="btn_2" id="uplLoadBt" onClick="dataHander('add_modal','cond_upload.jsp?proj_id=<%=proj_id %>&doc_id=<%=doc_id %>');">
		  ...
		  <tr>
			...
			<input type=text name="equip_amt" id="equip_amt" size="13"  value="" 
					dataType="Money" onchange="changeFirst_payment()" onblur="checkDataInvalid('<%=proj_money %>','0')" />
		     </td>
		      ...
		      <td>
		    	...
		    	maxB="50"  Require="true" label="首付款"/>
		    	<span class="biTian">*</span>
		   	   </td> 
		   ...
		   <td scope="row" nowrap>租赁本金</td>
			...
			<td>
				<input name="caution_money" id="caution_money" value="0" 
					...
					onchange="assignment()" type="text" label="租赁保证金"/>
				<span class="biTian">*</span>
			</td>
			...
			<td>
				<input name="handling_charge" id="handling_charge" type="text" value="0" 
				 	...
				 	maxB="20"  Require="true" onchange="assignment()" label="租赁手续费"/>
				<span class="biTian">*</span>
			</td>
			<td scope="row" nowrap>管理费</td>
		    <td colspan="">
		    	<input name="management_fee" id="management_fee" type="text" value="0"  
		    		dataType="Money" size="13" maxlength="20" maxB="20"  Require="true" onchange="" label="管理费"/> 
				<span class="biTian">*</span>
			</td>
		  </tr>
			...
			<td scope="row" nowrap>咨询费收入</td>
		  	<td>
		  		<input name="consulting_fee_in" id="consulting_fee_in" type="text" value="0"  
					dataType="Money" size="13" maxlength="20" maxB="20"  Require="true" onchange="assignment()" label="咨询费收入"/>
				<span class="biTian">*</span>
			</td>
		  	<td scope="row" nowrap>咨询费支出</td>
		  	<td>
		  		<input name="consulting_fee_out" id="consulting_fee_out" type="text" value="0"  
					dataType="Money" size="13" maxlength="20" maxB="20"  Require="true" onchange="assignment()" label="咨询费支出"/>
				<span class="biTian">*</span>
			</td>
		  ...
		  <tr>	
			...
			<td>
				<input name="nominalprice" type="text" value="0" onchange="assignment()"
					dataType="Money" size="13" maxlength="20" maxB="20"  Require="true" label="残值收入"/>
				<span class="biTian">*</span>
			</td>
		    <td  scope="row" nowrap>厂商返利</td>
			<td>
				<input name="return_amt" id="return_amt" type="text" value="0"  
					dataType="Money" size="13" maxlength="20" maxB="20"  Require="true" onchange="assignment()" label="厂商返利"/>
				<span class="biTian">*</span>
			</td>
			<td scope="row" nowrap>保费金额</td>
		    <td colspan="">
		   	 <input name="insure_money" id="insure_money" type="text" value="0"  
					dataType="Money" size="13" maxlength="20" maxB="20"  Require="true" onchange="assignment()" label="保费金额"/>
			</td>
			<td  scope="row" nowrap>预计IRR</td>
			<td>
				<input name="plan_irr" type="text" value="0" size="13" maxlength="10" readonly="readonly" label="预计IRR"/>%
			</td> 
		  </tr>
		   ...
		   <tr>
		    ...
		    <td>
		    	<input name="before_interest" id="before_interest" type="text" value="0"  onchange="changeTwoData()"
		    		dataType="Money" size="13" maxlength="20" maxB="20"  Require="true" label="租前息"/>
		    		是否算本
			...
			<td scope="row" nowrap>利息补贴</td>
		  	<td>
		  		<input name="rate_subsidy" id="rate_subsidy" type="text" value="0"  
					dataType="Money" size="13" maxlength="20" maxB="20"  Require="" onchange="assignment()" label="利息补贴"/>
				<span class="biTian"></span>
			</td>
			<td scope="row" nowrap>贴现息</td>
		  	<td>
		  		<input name="discount_rate" id="discount_rate" type="text" value="0"  
					dataType="Money" size="13" maxlength="20" maxB="20"  Require="" onchange="assignment()" label="贴现息"/>
				<span class="biTian"></span>
			</td>
			<td scope="row" nowrap>资产余值</td>
		    <td>
		    	<input name="assets_value" type="text" value="0" dataType="Money" size="13" maxlength="20" maxB="20" label="资产余值"/>
			</td>
		  </tr>
		  ...
		  <tr>
		    ...
		    <td>
		    	...
		    	dataType="Money" size="13" maxlength="20" maxB="20" label="净融资额"/> 
		    		净融资额比例
		    ...
		    <td>
		    	<input name="income_number" id="income_number" type="text" value="0" onChange="changLeaseT_value()"
		    		dataType="Integer" size="13" maxlength="10" maxB="10"  Require="true" label="还租次数" />
		    	<span class="biTian">*</span>
			</td>
		   	<!-- 根据付租方式判断 -->
		   ...
		   <td  scope="row" nowrap>租赁年利率</td>
			<td nowrap="nowrap">
				<input name="year_rate" id="year_rate" type="text" value="0.00"  
					dataType="Double" size="13" maxlength="13" maxB="13"  Require="true" label="租赁年利率"/>%
				<span class="biTian">*</span>
			</td>
