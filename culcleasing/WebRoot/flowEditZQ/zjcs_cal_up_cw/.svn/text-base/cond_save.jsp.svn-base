...
<%
	...
	String tax_type=getStr(request.getParameter("tax_type")); //税种
	...
	System.out.println("ooooooooooooooooooo"+conditionBean.getTax_type());
	...
	if("RentCalcType8".equals(settle_method) || "RentCalcType9".equals(settle_method) || "RentCalcType10".equals(settle_method)){
		...
		LogWriter.logDebug(request, "签约审批前 - 租金测算完成，保存租金计划、现金流成功！");
