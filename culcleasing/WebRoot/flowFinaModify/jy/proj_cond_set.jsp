...
<%
	...
	System.out.println("sssss"+savaType);
	...
	if( savaType!=null && "upd".equals(savaType)){
		...
		System.out.println("test============="+beginInfoBean.getTax_type()+"===="+beginInfoBean.getTax_type_invoice());
	}
%> 
...
$(document).ready(function(){
	...
	$("select[name='income_number_year1']").val("<%=beginInfoBean.getIncome_number_year() %>");
	...
	<div id="TD_tab_0">
		<table  border="0" cellspacing="0" cellpadding="0" width="100%" height="80%" align="center" class="tab_table_title">
		  ...
		  <tr>
			...
			<td nowrap="nowrap">
				<input name="year_rate" id="year_rate" type="text" value="0.00"  
					dataType="Double" size="13" maxlength="11" maxB="11"  Require="true" style="width: 100" readonly="readonly"/>%
				<span class="biTian">*</span>
			</td>  
		  ...
		  <tr>
		   ...
		   <td>
		        <input type="hidden"  name="income_number_year" style="width: 100px;" value="" readonly="readonly">
		    	 <select name="income_number_year1" id="income_number_year1" style="width: 100px;" disabled="disabled">
					<script type="text/javascript">
		  ...
		  <tr>
		    ...
		    <td scope="row">
		    <input style="width:150px;" name="plan_bank_no" type="text" readonly="readonly" style="width: 100"  Require="true">
		    ...
		    <td scope="row">
		    <input style="width:150px;" name="plan_bank_name" type="text" readonly="readonly" style="width: 100" Require="true">
			<span class="biTian">*</span>
		    </td>
		  ...
		  <tr>
			...
			<select style="width:140px;" name="invoice_type" id="invoice_type" Require="true" label="租金开票方式">
					  <script type="text/javascript">
						w(mSetOpt('',"先开，租金总额发票|先开，本金收据，利息发票|先开，本利分开|后开，租金总额发票|后开，本金收据，利息发票|后开，本利分开|后开，本利分开两张发票|先开，本利分开两张发票|其它|先开，本金增值税普通发票，利息增值税专用发票|后开，本金增值税普通发票，利息增值税专用发票|全额收据",
						"root.RentInvoice.001|root.RentInvoice.002|root.RentInvoice.003|root.RentInvoice.004|root.RentInvoice.005|root.RentInvoice.006|root.RentInvoice.007|root.RentInvoice.008|root.RentInvoice.009|root.RentInvoice.010|root.RentInvoice.011|root.RentInvoice.012"));
					</script>
				</select>
				<!--
				<select style="width:130px;" name="invoice_type" id="invoice_type" Require="true" label="租金开票方式"></select>
				<script language="javascript">
		  ...
		  <td>
			...
			<td>
				...
				<img onClick="openCalendar(start_date);return false" style="cursor:pointer; " 
				 src="../../images/fdmo_63.gif" width="20" height="19" border="0" align="absmiddle" disabled="disabled">
				<span class="biTian">*</span>
			</td>
			<td scope="row" nowrap>是否保理</td>
		    <td>
		        <input type="radio" name="factoring" value="是">是
		    	<input type="radio" name="factoring" value="否"  checked="checked">否
		    	<span class="biTian">*</span>
			</td>
		   ...
		   <tr>
		    ...
		    <td>
		    	<select name="tax_type" style="width:150px;" >
		        <script type="text/javascript">
			        w(mSetOpt('',"无|营业税|增值税","无|营业税|增值税"));
		        </script>
		        </select> 
		    	<span class="biTian">*</span>
			</td>
		    ...
		    <td>
		    	<select name="tax_type_invoice" style="width:150px;" >
		        <script type="text/javascript">
			        w(mSetOpt('',"无|营业税发票|增值税普通发票|增值税专用发票|收据","无|营业税发票|增值税普通发票|增值税专用发票|收据"));
		        </script>
		        </select> 
		    	<span class="biTian">*</span>
			</td>
