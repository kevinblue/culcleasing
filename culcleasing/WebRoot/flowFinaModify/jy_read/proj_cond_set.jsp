	...
	<div id="TD_tab_0">
		<table  border="0" cellspacing="0" cellpadding="0" width="100%" height="80%" align="center" class="tab_table_title">
		  ...
		  <!--  <img src="../../images/sbtn_more.gif" alt="选" width="19" height="19" align="absmiddle"  
			...
			<td>
				<input type="radio" name="is_open" value="是" disabled>是 &nbsp;
				<input type="radio" name="is_open" value="否" disabled>否 &nbsp;
				<span class="biTian">*</span>
			</td>
		  ...
		  <tr>
		    ...
		    <td> 
		    	<select name="rate_float_type" onchange="changeOne()" style="width:150px;" disabled>
		        <script type="text/javascript">
		    ...
		    <td>
		    	<input name="rate_float_amt" type="text" value="0"  onblur="alertChange()"
		    		dataType="Double" size="13" maxlength="13" maxB="13"  Require="true"  style="width: 100" readonly/>
		    	<span class="biTian">*</span>
			</td>
		  	
		    <td scope="row" nowrap>租金开票方式</td>
			<td>
			<select style="width:140px;" name="invoice_type" id="invoice_type" Require="true" label="租金开票方式" disabled>
					  <script type="text/javascript">
		  ...
		  <td>
		    	<select name="adjust_style" style="width:150px;" disabled>
			        <script type="text/javascript">
			        	w(mSetOpt('2',"按次日|按次期","1|2"));
			        </script>
		        </select> 
		        批量调息
		        <input type="radio" name="into_batch" value="是" disabled>是
		    	<input type="radio" name="into_batch" value="否" disabled>否
		    	<span class="biTian">*</span>
			</td>
		    ...
		    <td>
		        <input type="radio" name="factoring" value="是" disabled>是
		    	<input type="radio" name="factoring" value="否" disabled>否
		    	<span class="biTian">*</span>
			</td>
		    ...
		    <td>
		    	<select name="tax_type" style="width:150px;" disabled>
		        <script type="text/javascript">
		    ...
		    <td>
		    	<select name="tax_type_invoice" style="width:150px;" disabled>
		        <script type="text/javascript">
