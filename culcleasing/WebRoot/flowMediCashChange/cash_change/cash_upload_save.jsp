			...
			if(saObjectFile[j]!=null&&!saObjectFile[j].equals("")){
				...
				System.out.println("22222");
					...
					for(int row=0;row<obj.length;row++){//遍历多行
						...
						//插入数据
						sqlstr = "Insert into dbo.fund_cash_medi_yc_con_temp(doc_id,contract_id,yc_month,yc_hire_date,cash_money,remark)";
						sqlstr+= " Select '"+doc_id+"','"+contract_id+"','"+yc_month+"','"+yc_hire_date+"','"+yc_money+"','预测现金流修订后'";
