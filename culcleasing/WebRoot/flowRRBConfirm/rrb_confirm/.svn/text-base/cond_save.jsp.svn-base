...
<%
	...
	if("是".equals(before_interest_type)){
		...
		sqlstr+= " actual_fund='"+actual_fund+"',actual_fund_ratio='"+actual_fund_ratio+"',modificator='"+modificator+"',modify_date='"+modify_date+"',irr='"+irr+"',rent_start_date='"+rent_start_date+"'";
