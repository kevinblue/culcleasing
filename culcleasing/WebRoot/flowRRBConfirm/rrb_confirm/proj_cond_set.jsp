...
$(document).ready(function(){
	...
	//租赁年利率 year_rate
	//alert("<%=conditionBean.getYear_rate() %>");
	...
	<div id="TD_tab_0">
		<table  border="0" cellspacing="0" cellpadding="0" width="100%" height=100%" align="center" class="tab_table_title">
			...
			<tr>
				...
				<div id="bj_2" style="display: none;float: left;margin-left: 24px;">
		   			<input name="ratio_param" type="text" dataType="Double" value="0.00" size="13" maxlength="10" label="bj_2" maxB="10">
				</div>
		   ...
		   <td scope="row" nowrap>租赁本金</td>
		    ...
		    <td colspan="">
		    	<input name="management_fee" type="text" value="0"  
		    		dataType="Money" size="13" maxlength="10" maxB="10" label="管理费"  Require="true"  /> 
				<span class="biTian">*</span>
			</td>
		  </tr>
		  ...
		  <tr>
		    ...
		    <td colspan="">
		    	<input name="other_expenditure" type="text" value="0" dataType="Money"
		    		  size="13" maxlength="10" label="其他支出"/> 
			</td>
		  </tr>
		  <tr>	
			...
			<td>
				<input name="plan_irr" type="text" value="0" size="13" maxlength="10" label="预计IRR" readonly="readonly"/>%
			</td>
		  </tr>
		   <tr>
		    ...
		    <td>
		    	<input name="assets_value" type="text" value="0" dataType="Money" size="13" maxlength="10" label="资产余值" maxB="10" />
			</td>
		  </tr>
		  <tr>
		    ...
		    <td>
		    	...
		    	<input type="hidden" name="actual_fund_hidden" id="actual_fund_hidden">
					...
					value="" size="5" maxlength="15" readonly="readonly" 
					Require="true"/>% 
		    ...
		    <td>
		    	<input name="income_number" type="text" value="0" 
		    		dataType="Integer" size="13" maxlength="10" maxB="10" label="还租次数" Require="true" />
		    	<span class="biTian">*</span>
			</td>
			<!-- 根据付租方式判断 -->
		    ...
		    <td>
		    	<input name="lease_term" type="text" value="0"  onClick="changLeaseT_value()" 
		    		dataType="Integer" size="13" maxlength="10" maxB="10" label="租赁期限(月)"  Require="true" readonly/>
		    	<span class="biTian">*</span>
			</td>
		  </tr>
		   <tr>
		   <td  scope="row" nowrap>租赁年利率</td>
			<td nowrap="nowrap">
				<input name="year_rate" type="text" value="0.00"  
					dataType="Rate" size="13" maxlength="15" maxB="15" label="租赁年利率"  Require="true"/>%
				<!--  	display: none; 
		  ...
		  <td scope="row" nowrap>是否批量调息</td>
		    ...
		    <td colspan="">
		    	<input name="pena_rate" type="text" value="5"  
		         size="13" maxlength="20" dataType="Double" size="13" maxlength="10" maxB="10" label="罚息日利率"  Require="true" />%%
		    ...
		    <td> 
		    	<input name="free_defa_inter_day" type="text" value="0"  
		    		dataType="Integer" size="13" maxlength="10" maxB="10" label="逾期宽限日"  Require="true"/>
		    	<span class="biTian">*</span>
			</td>
		</tr>
		  <tr>
		  ...
		  <tr>
		    ...
		    <td>
		    	<input name="rate_float_amt" type="text" value="0" 
		    		dataType="Double" size="13" maxlength="10" maxB="10"  label="利率调整值"  onblur="alertChange()" />
		    	<span class="biTian">*</span>
			</td>
		  </tr>
		  <tr>
			...
			<td>
				<input name="dongirr" dataType="Double" type="text" value="0" size="13" maxlength="10" label="动态IRR"  />%
			</td>
	    ...
	    <tr>
		    ...
		    <td>
			 ...
			 -->
			 <!-- sys考核调整隐藏域 -->
			 <input type="hidden" name="assess_adjust" value="0" dataType="Money" size="13" maxlength="10" maxB="10"  label="动态IRR"  onchange="changeFirst_payment()"/>
	    </tr>
		</table>
		</div>
		</div>
