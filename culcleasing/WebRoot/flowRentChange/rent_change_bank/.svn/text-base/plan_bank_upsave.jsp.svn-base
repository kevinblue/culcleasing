...
if((start_list!=null && !start_list.equals("")) && (end_list!=null && !end_list.equals("")) && (plan_bank_name!=null && !plan_bank_name.equals("")) &&		   (plan_bank_no!=null && !plan_bank_no.equals("")) ){
	String sqlstr1="update fund_rent_plan_temp set plan_bank_name='"+plan_bank_name+"',plan_bank_no='"+plan_bank_no+"' ,modificator='"+dqczy+"',modify_date='"+datestr+"' where begin_id='"+begin_id+"' and doc_id='"+doc_id+"' and rent_list>='"+start_list+"' and rent_list<='"+end_list+"' and plan_status='未回笼' and oth_remark='租金变更后'";
