	...
	<div id="TD_tab_0">
		<table  border="0" cellspacing="0" cellpadding="0" width="100%" height="80%" align="center" class="tab_table_title">
		  ...
		  <tr>
		    ...
		    <td scope="row" nowrap>租赁本金</td>
		     <td>
		    	...
		    	size="13" maxlength="100" maxB="100" Require="true" onblur="checkValid()" style="width: 100" readonly="readonly"/>
		    	<span class="biTian">*</span>
			 </td>
		  ...
		  <tr>
		    ...
		    <td>
		    	<input name="assets_value" id="assets_value" style="width: 150" type="text" value="0" dataType="Money" size="13" maxlength="10" maxB="10" />
			</td>
			...
			<td>
				<input name="old_irr" type="text" value="0" size="13" maxlength="10" readonly="readonly" size="13" style="width: 100"/>
			</td>
		  </tr>
...
$("input[type='text']").focus();
	...
	//租赁年利率、还租次数
		...
		return false;
	}else if( $(":input[name='income_number']").val()=="0" || isNaN($(":input[name='income_number']").val())  ){
		//!/^[1-9]*\d$/.test($(":input[name='income_number']").val())
