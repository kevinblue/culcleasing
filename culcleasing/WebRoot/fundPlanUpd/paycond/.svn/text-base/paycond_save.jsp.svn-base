...
sqlstr+= " from contract_condition where contract_id='"+contract_id+"'";
...
if(outFlag==0){//没有超出则插入数据库
	...
	sqlstr+=" pay_bank_name,pay_bank_no,plan_bank_name,plan_bank_no,pay_way,fpnote,oth_remark,creator,create_date,modificator,modify_date)";
	// 付款 -- 设备款
	...
	sqlstr+=" '"+pay_bank_name+"','"+pay_bank_no+"','"+plan_bank_name+"','"+plan_bank_no+"','"+pay_way+"','"+fpnote+"',1,'"+dqczy+"','"+datestr+"','"+dqczy+"','"+datestr+"'";
