...
<title>客户信息管理 - 供应商关联企业及分支机构情况</title>
...
String sqlstr = "select * from vi_mproj_vndr_affiliatedco" + wherestr +" order by modify_date desc"; 
...
<table border="0" cellspacing="0" cellpadding="0" >    
    <tr class="maintab">
		...
		<td><a href="#" accesskey="n" onclick="dataHander('add','glqyqk_add.jsp?project_id=<%=project_id %>',dataNav.itemselect);"><img align="absmiddle"  src="../../images/sbtn_new.gif" alt="新增(Alt+N)" align="absmiddle"></a></td>
		<td><a href="#" accesskey="m" onclick="dataHander('mod','glqyqk_mod.jsp?project_id=<%=project_id %>&czid=',dataNav.itemselect);"><img align="absmiddle"  src="../../images/sbtn_mod.gif" alt="修改(Alt+M)" align="absmiddle" ></a></td>
		<td><a href="#" accesskey="d" onclick="dataHander('del','glqyqk_del.jsp?project_id=<%=project_id %>&czid=',dataNav.itemselect);"><img align="absmiddle" src="../../images/sbtn_del.gif" alt="删除(Alt+D)" align="absmiddle" ></a></td>
    </tr>
</table>
</form>
<!--操作按钮结束-->
...
%>
      ...
      <tr>
        ...
        <td align="left"><a href="glqyqk.jsp?czid=<%= getDBStr( rs.getString("id") ) %>" target="_blank"><%= getDBStr( 	  rs.getString("affiliatedco") ) %></a></td>
