...
String message="";
if ( stype.equals("add") ){ 
sqlstr="insert into mproj_vndr_affiliatedco (vndr_id,proj_id,affiliatedco,individual_flag,id_number,relationship,primary_business,address,legal_representative,registered_capital,equity_ratio,creator,create_date) values (";
...
if ( stype.equals("mod") ){ 
sqlstr="update mproj_vndr_affiliatedco set ";
if(vndr_id!=null&&!vndr_id.equals("")){
...
if ( stype.equals("del") ){ 
sqlstr="delete from mproj_vndr_affiliatedco where  id="+czid;
flag = db.executeUpdate(sqlstr);
