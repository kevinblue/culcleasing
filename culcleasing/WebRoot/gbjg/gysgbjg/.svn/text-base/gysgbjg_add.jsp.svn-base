...
<title>客户信息管理 - 新增供应商企业股本结构</title>
...
<table border="0" cellspacing="0" cellpadding="0" width="98%" align="center" class="tab_table_title">
  <tr>
    <td>供应商</td>
    <td><input name="vndr_name" type="text" size="40"  Require="true" readonly><input type="hidden" name="vndr_id" > <img src="../../images/sbtn_more.gif" alt="选" width="19" height="19" align="absmiddle"  style="cursor:pointer" onclick="OpenDataWindow('','','','','客户名称','cust_info','cust_name','cust_id','cust_name','cust_name','asc','form1.vndr_name','form1.vndr_id');">
	<span class="biTian">*</span></td>

    <td>主要股东名称</td>
    <td><input name="shareholder" type="text" size="40" maxB="50" Require="true"><span class="biTian">*</span></td>
  </tr>
  <tr>
    <td>法人/个人</td>
    <td><select name="individual_flag">
        <script>w(mSetOpt('0',"法人|个人","0|1"));</script>
        </select>
	<span class="biTian">*</span></td>
