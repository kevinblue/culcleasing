...
<title>客户信息管理 - 修改供应商企业股本结构</title>
...
<body>
<form name="form1" method="post" action="gysgbjg_save.jsp" onSubmit="return Validator.Validate(this,3);">
<style type="text/css">
...
int canmod=0;
	...
	String sqlstr = "select * from vi_mproj_vndr_capital_struct  where id=" + czid ; 
...
<table border="0" cellspacing="0" cellpadding="0" width="98%" align="center" class="tab_table_title">
  <tr>
    <td>供应商</td>
    <td><input name="vndr_name" type="text" size="40" value="<%=cust_name %>" Require="true" readonly><input type="hidden" name="vndr_id" value="<%=cust_id %>"> <img src="../../images/sbtn_more.gif" alt="选" width="19" height="19" align="absmiddle"  style="cursor:pointer" onclick="OpenDataWindow('','','','','客户名称','cust_info','cust_name','cust_id','cust_name','cust_name','asc','form1.cust_name','form1.cust_id');">
	<span class="biTian">*</span></td>

    <td>主要股东名称</td>
    <td><input name="shareholder" type="text" size="40" value="<%=shareholder %>" maxB="50" Require="true"><span class="biTian">*</span></td>
  </tr>
  <tr>
    <td>法人/个人</td>
    ...
    <td>组织机构代码/身份证号</td>
    <td><input name="id_number"  value="<%=id_number %>" type="text" size="40" maxB="20" Require="true"><span class="biTian">*</span></td>
  </tr>
  <tr>
    <td>主营业务</td>
    <td><input name="primary_business"  value="<%=primary_business %>" type="text" size="40" maxB="150" Require="true">
	<span class="biTian">*</span></td>
  ...
  <tr>
    <td>持股比例</td>
    <td><input name="equity_ratio" type="text" value="<%=equity_ratio %>" size="40" maxB="50" Require="true">
	<span class="biTian">*</span></td>
