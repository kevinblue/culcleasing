...
<table border="0" cellspacing="0" cellpadding="0" width="98%" align="center" class="tab_table_title">
  ...
  <tr>
    <td>主营业务</td>
    <td><input name="primary_business" type="text" size="40" maxB="150">
	</td>
  ...
  <tr>
    <td>法人代表</td>
    <td><input name="legal_representative" type="text" size="40" maxB="10">
	</td>
  ...
  <tr>
    <td>持股比例</td>
    <td><input name="equity_ratio" type="text" size="40" maxB="50">
	</td>
