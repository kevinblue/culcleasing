...
String message="";
if ( stype.equals("add") ){ 
sqlstr="insert into proj_cust_capital_struct (cust_id,proj_id,shareholder,individual_flag,id_number,primary_business,address,legal_representative,registered_capital,equity_ratio,creator,create_date) values (";
...
if ( stype.equals("mod") ){ 
sqlstr="update proj_cust_capital_struct set ";
if(cust_id!=null&&!cust_id.equals("")){
...
if ( stype.equals("del") ){ 
sqlstr="delete from proj_cust_capital_struct where  id="+czid;
flag = db.executeUpdate(sqlstr);
