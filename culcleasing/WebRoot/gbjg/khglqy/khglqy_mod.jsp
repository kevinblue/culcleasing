...
<title>客户信息管理 - 修改客户关联企业及分支机构情况</title>
...
int canmod=0;
	...
	String sqlstr = "select * from vi_proj_cust_affiliatedco  where id=" + czid ; 
...
<table border="0" cellspacing="0" cellpadding="0" width="98%" align="center" class="tab_table_title">
  ...
  <tr>
    ...
    <td>组织机构代码/身份证号</td>
    <td><input name="id_number" type="text" value="<%=id_number %>" size="40" maxB="20"></td>
  </tr>
  <tr>
  	<td>关联关系</td>
    <td><input name="relationship" type="text" value="<%=relationship %>" size="40" maxB="100">
	</td>
    <td>主营业务</td>
    <td><input name="primary_business" type="text" value="<%=primary_business %>" size="40" maxB="150">
	</td>
  </tr>
  <tr>
    <td>地址</td>
  ...
  <tr>
    ...
    <td>持股比例</td>
    <td><input name="equity_ratio"  value="<%=equity_ratio %>" type="text" size="40" maxB="50"></td>
  </tr>
  <tr>
   <td>登记人</td>
    <td ><%=creator%>&nbsp;</td>
