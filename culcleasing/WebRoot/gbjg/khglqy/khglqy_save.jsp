...
String affiliatedco = getStr( request.getParameter("affiliatedco") );
String individual_flag = getStr( request.getParameter("individual_flag") );
String id_number = getStr( request.getParameter("id_number") );
String relationship = getStr( request.getParameter("relationship") );
...
String message="";
if ( stype.equals("add") ){ 
sqlstr="insert into proj_cust_affiliatedco (cust_id,proj_id,affiliatedco,individual_flag,id_number,relationship,primary_business,address,legal_representative,registered_capital,equity_ratio,creator,create_date) values (";
...
if(affiliatedco!=null&&!affiliatedco.equals("")){
	sqlstr+="'"+affiliatedco+"',";
}else{
	sqlstr+="null,";
}
...
message="添加承租客户关联企业及分支机构情况";
}
if ( stype.equals("mod") ){ 
sqlstr="update proj_cust_affiliatedco set ";
if(cust_id!=null&&!cust_id.equals("")){
	sqlstr+="cust_id='"+cust_id+"',";
}else{
	sqlstr+="cust_id=null,";
}
if(affiliatedco!=null&&!affiliatedco.equals("")){
	sqlstr+="affiliatedco='"+affiliatedco+"',";
}else{
	sqlstr+="affiliatedco=null,";
}
if(individual_flag!=null&&!individual_flag.equals("")){
...
if(relationship!=null&&!relationship.equals("")){
	sqlstr+="relationship='"+relationship+"',";
}else{
	sqlstr+="relationship=null,";
}
if(primary_business!=null&&!primary_business.equals("")){
...
flag = db.executeUpdate(sqlstr);
message="修改承租客户关联企业及分支机构情况";
}
if ( stype.equals("del") ){ 
sqlstr="delete from proj_cust_affiliatedco where  id="+czid;
flag = db.executeUpdate(sqlstr);
message="删除承租客户关联企业及分支机构情况";
}
if(flag!=0){
%>
<script>
