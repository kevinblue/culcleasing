...
int canedit=0;
if (right.CheckRight("gps-abnormal-mod",dqczy)>0) canedit=1;
if (canedit==0) response.sendRedirect("../../noright.jsp");
%>
<html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=gbk">
<title>GPS不正常跟踪明细修改 -GPS管理</title>
...
<table  border="0" cellspacing="0" cellpadding="0" width="98%" align="center" class="tab_table_title">
  <tr>
    ...
    <td>跟踪日期</td>
    <td><input name="track_date" type="text" value="<%=track_date%>"  readonly><img  onClick="openCalendar(track_date);return false" style="cursor:pointer; " src="../../images/tbtn_overtime.gif" width="20" height="19" border="0" align="absmiddle"></td>
  </tr>
  <tr>
  <td>是否正常</td>
  ...
  <tr>
  <td>跟踪情况</td>
   <td><textarea name="track_memo"><%=track_memo%></textarea></td>
   <td>操作员</td>
   <td><%=creator%></td>
  </tr>
</table>
