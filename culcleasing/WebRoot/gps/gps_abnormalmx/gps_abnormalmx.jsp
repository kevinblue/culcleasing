...
<form name="form1" method="post" action="gps_abnormalmx_mod.jsp" onSubmit="return Validator.Validate(this,3);">
...
<a href="gps_abnormalmx_mod.jsp?sim_no=<%=sim_no %>&id=<%= id %>"  accesskey="m" title="修改(Alt+M)" class="fontcolor">
