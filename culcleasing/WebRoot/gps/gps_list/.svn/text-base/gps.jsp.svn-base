...
if (rs.next()){
  ...
  gps_right = getDBStr( rs.getString("gps_right") );
...
<form name="form1" method="post" action="gps_mod.jsp" onSubmit="return Validator.Validate(this,3);">
...
<a href="gps_mod.jsp?id=<%= id %>"  accesskey="m" title="修改(Alt+M)" class="fontcolor">
		<img src="../../images/sbtn_mod.gif" width="19" height="19" align="absmiddle" >修改</a>
<BUTTON class="btn_2" name="btnReset" value="取消" onClick="window.close();">
<img src="../../images/hg.gif" align="absmiddle" border="0">取消</button>
<a href="gps_out.jsp?id=<%= id %>">导出GPS信息</a>
    </td></tr>
</table>
<!--操作按钮结束-->
</td>
