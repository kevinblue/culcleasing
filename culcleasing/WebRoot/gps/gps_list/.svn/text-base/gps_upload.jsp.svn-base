...
int canedit=0;
if (right.CheckRight("gps-list-add",dqczy)>0) canedit=1;
...
<body>
<form name="list" action="gps_save.jsp" enctype="multipart/form-data" method="post" onSubmit="">
				...
				<tr>
					<td>
						<table border="0" cellspacing="0" cellpadding="0">    
							<tr class="maintab_dh">
								<td nowrap id="saveTd">
									<BUTTON class="btn_2" name="btnSave" value="保存GPS清单数据"  type="submit">
									<img src="../../images/save.gif" align="absmiddle" border="0">保存GPS清单数据</button>
								</td>
							</tr>
						</table>
					</td>
...
function fun_save(){
	if(confirm("确认要上传GPS安装清单文件"+document.forms[0].name1.value)){
	document.forms[0].action="gps_save.jsp";
