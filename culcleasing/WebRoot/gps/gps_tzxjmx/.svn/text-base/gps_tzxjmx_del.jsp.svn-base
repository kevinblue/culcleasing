...
<!-- end cwCellTop -->
<%
String tzexamine_details = getStr( request.getParameter("id") );
String tzpolling_id = "";
String gpstpye="";
String cai_no="";
String sim_no = "";
...
ResultSet rs;
String sqlstr = "select * from vi_tzexamine_details where tzexamine_details='" + tzexamine_details + "'"; 
...
<input type="hidden" name="id" value="<%=tzexamine_details %>">
<table  border="0" cellspacing="0" cellpadding="0" width="98%" align="center" class="tab_table_title">
  <tr>
  <td>SIM卡号</td>
   <td><%=sim_no%></td>
    <td >巡检明细id</td>
    <td><%=tzexamine_details%>
	</td>
  </tr>
    <tr>
  <td>客户名称 </td>
