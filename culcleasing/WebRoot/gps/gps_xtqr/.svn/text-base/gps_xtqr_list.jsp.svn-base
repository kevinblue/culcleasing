...
<table border="0" cellspacing="0" cellpadding="0" >    
	...
	<!--<td><a href="#" accesskey="n" onClick="dataHander('add','gps_xtqr_add.jsp',dataNav.itemselect);"><img src="../../images/sbtn_new.gif" alt="新增(Alt+N)" width="19" height="19" align="absmiddle"></a></td>
		<td width="40" align="right"><a href="#" accesskey="m" onClick="dataHander('mod','gps_xtqr_mod.jsp?id=',dataNav.itemselect);"><img src="../../images/sbtn_mod.gif" alt="修改(Alt+M)" width="19" height="19" align="absmiddle" ></a></td>
		<td><a href="#" accesskey="d" onClick="dataHander('del','gps_xtqr_del.jsp?id=',dataNav.itemselect);"><img src="../../images/sbtn_del.gif" alt="删除(Alt+D)" width="19" height="19" align="absmiddle" ></a></td>-->
    </tr>
</table>
</td>
