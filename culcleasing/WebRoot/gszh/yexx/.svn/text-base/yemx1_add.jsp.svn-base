...
<table border="0" cellpadding="2" cellspacing="5" class="cwDataInput">
 <tr>
    <th scope="row">帐户</th>
    <td><input name="zh" type="text" size="50" maxlength="50" readonly ><input name="zh1" type="hidden"><img src="../../images/sbtn_more.gif" alt="选" width="19" height="19" align="absmiddle"  style="cursor:pointer"
 onclick="SpecialDataWindow('帐户','jb_nbzhxx','khzh','khzh','khzh','stringfld','khzh','form1.zh','form1.zh1');">
	  </td>
  </tr>
