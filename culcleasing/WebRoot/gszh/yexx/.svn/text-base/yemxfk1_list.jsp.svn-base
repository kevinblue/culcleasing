...
%>
        <form name="searchbar" action="yemxfk1_list.jsp">
         
         <td nowrap>账户名称
          	<input name="searchKeyzhmcdata" type="text" size="15" value="<%=searchKeyzhmc%>"><input name="searchKeyzhmc" type="hidden" value="<%=searchKeyzhmc%>"><img src="../../images/sbtn_more.gif" alt="选" width="19" height="19" align="absmiddle"  style="cursor:pointer" onclick="SpecialDataWindow('账户名称','v_zh_xjyemx','zhmc','zhmc','zhmc','stringfld','zhmc','searchbar.searchKeyzhmcdata','searchbar.searchKeyzhmc');"> 
...
<div id="cwDataNav">
<form action="yemxfk1_list.jsp" name="dataNav" onSubmit="return goPage()">
