...
BigDecimal fkwb1=new BigDecimal("0.00");//收款外
...
%>
        <form name="searchbar" action="yemx_list.jsp">
...
<div id="cwDataNav">
<form action="yemx_list.jsp" name="dataNav" onSubmit="return goPage()">
