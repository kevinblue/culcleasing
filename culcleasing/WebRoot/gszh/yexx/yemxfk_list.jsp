...
if (request.getParameter("zh")!=null && request.getParameter("zh").equals("")==false)
     wherestr=" where szfs='付款' and (zh='"+czzh+"')";
else
   {wherestr=" where szfs='付款'";}
...
%>
        <form name="searchbar" action="yemxfk_list.jsp">
...
<div id="cwDataNav">
<form action="yemxfk_list.jsp" name="dataNav" onSubmit="return goPage()">
