...
if (request.getParameter("zh")!=null && request.getParameter("zh").equals("")==false)
    wherestr=" where szfs='收款' and (zh='"+czzh+"')";
else
   {wherestr=" where szfs='收款'";}
...
{
%>
		<td><a href="#" accesskey="n" onclick="dataHander('add','yemx_add.jsp?czzh=<%=czzh%>&czzhmc=<%=czzhmc%>',list.itemselect);"><img src="../../images/sbtn_new.gif" alt="新增(Alt+N)" width="19" height="19" align="absmiddle"></a></td>
...
%>
        <form name="searchbar" action="yemxsk_list.jsp">
...
日期2<input name="searchKeyjlrq2" accesskey="q" type="text" size="9" value="<%=searchKeyjlrq2%>" dataType="Date"><img  onClick="openCalendar(searchKeyjlrq2);return false" style="cursor:pointer; " src="../../images/tbtn_overtime.gif" width="20" height="19" border="0" align="absmiddle">
            ...
            <input name="zhmc" type="hidden" value="<%=czzhmc%>">
            <input name="zh"  type="hidden" value="<%=czzh%>">			
...
%>
      ...
      <tr class="cwDLRow" >
		...
		<td><a href="yemx.jsp?czid=<%=getDBStr(rs.getString("id"))%>" target="_blank"><%=getDBDateStr(rs.getString("jlrq"))%></a></td>
    
		<td align="center"><%=getDBStr(rs.getString("szfs"))%></td>
...
<div id="cwDataNav">
<form action="yemxsk_list.jsp" name="dataNav" onSubmit="return goPage()">
