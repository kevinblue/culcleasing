...
BigDecimal bz6=new BigDecimal("0.00");
...
BigDecimal bz61=new BigDecimal("0.00");
...
String searchKeyzhmcdata="";
 wherestr=" where (qcyebb IS NOT NULL OR dryebb IS NOT NULL)";
...
expsqlstr="select zh 账号,zhmc 账户名称,drrq 当日日期,qcyebb 期初余额人民币,dtsr 当天收入,dtzc 当天支出,dryebb 当日余额人民币,kyed 可用额度 from v_zh_xjye"+wherestr+" order by drrq";
...
<table id="cwCellToolbar" border="0" cellspacing="5" cellpadding="0" >
   ...
   <form name="expform" action="../../func/exp.jsp" target="_blank" method="post">
	  <td><a href="http://ifelc/K3oA/zjbzy.nsf/AccountDay?openagent" target="_blank"><img src="../../images/sbtn_mod.gif" width="19" height="19" align="absmiddle" > 结算</a></td>
	  <td><a href="http://ifelc/K3oA/zjbzy.nsf/CheckFund?openform" target="_blank"><img src="../../images/sbtn_mod.gif" width="19" height="19" align="absmiddle" > 核算</a></td>
...
%>
        <form name="searchbar" action="yermb1_list.jsp">
...
<%
        ...
        bz51=bz51.add(bz5);
		bz6=(BigDecimal)getDBDecStr(rs.getBigDecimal("kyed",2));
        bz61=bz61.add(bz6);
%>
...
<div id="cwDataNav">
<form action="yermb1_list.jsp" name="dataNav" onSubmit="return goPage()">
...
<table class="cwDataList" width="100%"  border="0"  align="center" cellpadding="2" cellspacing="1" >
	  ...
	  <td><%=formatNumberStr(bz51.toString())%></td>
	    <td><%=formatNumberStr(bz61.toString())%></td>
      </tr>
  </table>
</div>
