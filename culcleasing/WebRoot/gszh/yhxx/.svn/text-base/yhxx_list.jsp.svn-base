...
<div id="cwCellTop">
	...
	<table id="cwCellTopTit" width="100%" border="0" cellpadding="0" cellspacing="0" >
      <tr>
        ...
        <td id="cwCellTopTitTxt">银行信息列表</td>
...
<table id="cwCellToolbar" border="0" cellspacing="5" cellpadding="0" >
      <tr>
		...
		<td><a href="#" accesskey="n" onclick="dataHander('add','yhxx_add.jsp',list.itemselect);"><img src="../../images/sbtn_new.gif" alt="新增(Alt+N)" width="19" height="19" align="absmiddle"></a></td>
		<td><a href="#" accesskey="d" onclick="dataHander('del','yhxx_del.jsp?czid=',list.itemselect);"><img src="../../images/sbtn_del.gif" alt="删除(Alt+D)" width="19" height="19" align="absmiddle" ></a></td>
		<td><a href="#"  accesskey="m" onclick="dataHander('mod','yhxx_mod.jsp?czid=',list.itemselect);"><img src="../../images/sbtn_mod.gif" alt="修改(Alt+M)" width="19" height="19" align="absmiddle" ></a></td>
...
%>
        <form name="searchbar" action="yhxx_list.jsp">
          <td nowrap>银行名称：<input name="searchKey" accesskey="s" type="text" size="15" value="<%=searchKey%>"><input name="image" type="image" src="../../images/tbtn_searh.gif" alt="查询" align="absmiddle"  onclick="searchbar.submit();">
          </td>
        </form>
      </tr>
</table>
...
%>
	...
	<td align="center"><img style="cursor:hand" onClick="expShow('../gszh/gszh_list.jsp?czid=<%=getDBStr(rs.getString("id"))%>&tit=<%=getDBStr(rs.getString("yhmc"))%>','所属帐户')" src="../../images/expbtnopen.gif"></td>
      </tr>
