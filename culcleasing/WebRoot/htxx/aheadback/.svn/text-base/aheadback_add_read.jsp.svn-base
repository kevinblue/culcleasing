...
<body>
<form name="form1" method="post" target="_blank" action="aheadback_save.jsp" onSubmit="return Validator.Validate(this,3);">
<style type="text/css">
...
<%
	...
	sqlstr="select contract_ahead_back.contract_id, contract_ahead_back.applicant, jb_yhxx.xm as applicant_name, contract_ahead_back.apply_date, contract_ahead_back.rent_interval, contract_ahead_back.pay_day, contract_ahead_back.contract_amt, contract_ahead_back.first_payment, contract_ahead_back.lease_money, contract_ahead_back.received_caution_money, contract_ahead_back.nominalprice, contract_ahead_back.received_list, contract_ahead_back.received_rent, contract_ahead_back.undue_list, contract_ahead_back.undue_rent, contract_ahead_back.overdue_list, contract_ahead_back.overdue_rent, contract_ahead_back.overdue_penalty, contract_ahead_back.received_insurance, contract_ahead_back.risk_exposure, contract_ahead_back.billing_manager, contract_ahead_back.billing_date, contract_ahead_back.effective_date, contract_ahead_back.agree_amt, contract_ahead_back.difference_amt, contract_ahead_back.difference_memo, contract_ahead_back.price_factor_name1, contract_ahead_back.price_factor1, contract_ahead_back.price_factor_name2, contract_ahead_back.price_factor2, contract_ahead_back.price_factor_name3, contract_ahead_back.price_factor3, contract_ahead_back.price_factor_name4, contract_ahead_back.price_factor4, contract_ahead_back.price_factor_name5, contract_ahead_back.price_factor5, contract_ahead_back.price_factor_name6, contract_ahead_back.price_factor6, contract_ahead_back.price_factor_name7, contract_ahead_back.price_factor7, contract_ahead_back.price_factor_name8, contract_ahead_back.price_factor8 from contract_ahead_back left join jb_yhxx on contract_ahead_back.applicant=jb_yhxx.id where contract_ahead_back.doc_id='"+doc_id+"'";
	//System.out.println("sqlstr==========================================="+sqlstr);
	rs=db.executeQuery(sqlstr);
	while(rs.next()){
