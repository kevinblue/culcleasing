...
System.out.println("sqlstr66================================="+sqlstr);
rs=db.executeQuery(sqlstr);
if(rs.next()){
...
String flag="";
String message="保存成功!";
sqlstr="select * from contract_ahead_back where doc_id='"+doc_id+"'";
rs=db.executeQuery(sqlstr);
if(rs.next()){
	flag="1";
}rs.close();
...
if(flag.equals("")){
	if(pay_day.equals("")){
		sqlstr="insert into contract_ahead_back(doc_id,contract_id,applicant,apply_date,rent_interval,contract_amt,first_payment,lease_money,received_caution_money,received_insurance,received_list,received_rent,undue_list,undue_rent,overdue_list,overdue_rent,overdue_penalty,nominalprice,risk_exposure) values('"+doc_id+"','"+contract_id+"','"+applicant+"','"+apply_date+"',"+rent_interval+","+contract_amt+","+first_payment+","+lease_money+","+received_caution_money+","+received_insurance+","+received_list+","+received_rent+","+undue_list+","+undue_rent+","+overdue_list+","+overdue_rent+","+overdue_penalty+","+nominalprice+","+risk_exposure+")";
		System.out.println("sqlstr77================================="+sqlstr);
		db.executeUpdate(sqlstr);
	}else{
		sqlstr="insert into contract_ahead_back(doc_id,contract_id,applicant,apply_date,rent_interval,pay_day,contract_amt,first_payment,lease_money,received_caution_money,received_insurance,received_list,received_rent,undue_list,undue_rent,overdue_list,overdue_rent,overdue_penalty,nominalprice,risk_exposure) values('"+doc_id+"','"+contract_id+"','"+applicant+"','"+apply_date+"',"+rent_interval+","+pay_day+","+contract_amt+","+first_payment+","+lease_money+","+received_caution_money+","+received_insurance+","+received_list+","+received_rent+","+undue_list+","+undue_rent+","+overdue_list+","+overdue_rent+","+overdue_penalty+","+nominalprice+","+risk_exposure+")";
		System.out.println("sqlstr77================================="+sqlstr);
		db.executeUpdate(sqlstr);
	}
	...
	if(pay_day.equals("")){
		sqlstr="update contract_ahead_back set applicant='"+applicant+"',apply_date='"+apply_date+"',rent_interval="+rent_interval+",contract_amt="+contract_amt +",first_payment="+first_payment +",lease_money="+lease_money +",received_caution_money="+received_caution_money +",received_insurance="+received_insurance +",received_list="+received_list +",received_rent="+received_rent +",undue_list="+undue_list +",undue_rent="+undue_rent +",overdue_list="+overdue_list +",overdue_rent="+overdue_rent +",overdue_penalty="+overdue_penalty +",nominalprice="+nominalprice +",risk_exposure="+risk_exposure+" where doc_id='"+doc_id+"'";
		System.out.println("sqlstr88================================="+sqlstr);
		db.executeUpdate(sqlstr);
	}else{
		sqlstr="update contract_ahead_back set applicant='"+applicant+"',apply_date='"+apply_date+"',rent_interval="+rent_interval+",pay_day="+pay_day+",contract_amt="+contract_amt +",first_payment="+first_payment +",lease_money="+lease_money +",received_caution_money="+received_caution_money +",received_insurance="+received_insurance +",received_list="+received_list +",received_rent="+received_rent +",undue_list="+undue_list +",undue_rent="+undue_rent +",overdue_list="+overdue_list +",overdue_rent="+overdue_rent +",overdue_penalty="+overdue_penalty +",nominalprice="+nominalprice +",risk_exposure="+risk_exposure+" where doc_id='"+doc_id+"'";
		System.out.println("sqlstr88================================="+sqlstr);
		db.executeUpdate(sqlstr);
	}
}
