...
if(flag.equals("")){
	if(pay_day.equals("")){
		sqlstr="insert into contract_ahead_break(doc_id,contract_id,applicant,apply_date,rent_interval,contract_amt,first_payment,lease_money,received_caution_money,received_insurance,received_list,received_rent,undue_list,undue_rent,overdue_list,overdue_rent,overdue_penalty,nominalprice,risk_exposure) values('"+doc_id+"','"+contract_id+"','"+applicant+"','"+apply_date+"',"+rent_interval+","+contract_amt+","+first_payment+","+lease_money+","+received_caution_money+","+received_insurance+","+received_list+","+received_rent+","+undue_list+","+undue_rent+","+overdue_list+","+overdue_rent+","+overdue_penalty+","+nominalprice+","+risk_exposure+")";
		System.out.println("sqlstr77================================="+sqlstr);
		db.executeUpdate(sqlstr);
	}else{
		sqlstr="insert into contract_ahead_break(doc_id,contract_id,applicant,apply_date,rent_interval,pay_day,contract_amt,first_payment,lease_money,received_caution_money,received_insurance,received_list,received_rent,undue_list,undue_rent,overdue_list,overdue_rent,overdue_penalty,nominalprice,risk_exposure) values('"+doc_id+"','"+contract_id+"','"+applicant+"','"+apply_date+"',"+rent_interval+","+pay_day+","+contract_amt+","+first_payment+","+lease_money+","+received_caution_money+","+received_insurance+","+received_list+","+received_rent+","+undue_list+","+undue_rent+","+overdue_list+","+overdue_rent+","+overdue_penalty+","+nominalprice+","+risk_exposure+")";
		System.out.println("sqlstr77================================="+sqlstr);
		db.executeUpdate(sqlstr);
	}
}else{
	if(pay_day.equals("")){
		sqlstr="update contract_ahead_break set applicant='"+applicant+"',apply_date='"+apply_date+"',rent_interval="+rent_interval+",contract_amt="+contract_amt +",first_payment="+first_payment +",lease_money="+lease_money +",received_caution_money="+received_caution_money +",received_insurance="+received_insurance +",received_list="+received_list +",received_rent="+received_rent +",undue_list="+undue_list +",undue_rent="+undue_rent +",overdue_list="+overdue_list +",overdue_rent="+overdue_rent +",overdue_penalty="+overdue_penalty +",nominalprice="+nominalprice +",risk_exposure="+risk_exposure+" where doc_id='"+doc_id+"'";
