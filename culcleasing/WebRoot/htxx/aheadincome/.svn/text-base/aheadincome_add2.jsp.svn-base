...
<table border="0" cellspacing="0" cellpadding="0" width="98%" align="center" class="tab_table_title">
  ...
  <tr>
    <td>保证金抵扣金额</td>
    <td><input name="caution_deduction_money" type="text" size="20" value="<%=caution_deduction_money%>" dataType="Money" require="true"></td>
    <td>其他（说明）</td>
    <td><input name="other_amt" type="text" size="20" value="<%=other_amt%>" dataType="Money" require="true"></td>
  </tr>
  <tr>
    <td>未付租金折现</td>
