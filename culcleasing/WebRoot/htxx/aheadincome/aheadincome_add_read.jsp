...
<%
	...
	while(rs.next()){
		...
		received_handling_charge=formatNumberStr(getDBStr( rs.getString("received_handling_charge") ),"#,##0.00");
		received_return=formatNumberStr(getDBStr( rs.getString("received_return") ),"#,##0.00");
		...
		received_amt=formatNumberStr(getDBStr( rs.getString("received_amt") ),"#,##0.00");
