...
<%
	...
	if(rs.next()){
		agree_amt=formatNumberStr(getDBStr( rs.getString("agree_amt") ),"#,##0.00");
		difference_amt=formatNumberStr(getDBStr( rs.getString("difference_amt") ),"#,##0.00");
...
<table border="0" cellspacing="0" cellpadding="0" width="98%" align="center" class="tab_table_title">
  ...
  <tr>
    <td>协议留购价</td>
    <td><input name="agree_amt" type="text" size="20" value="<%=agree_amt%>" readonly></td>
    <td>金额差异</td>
    <td><input name="difference_amt" type="text" size="20" value="<%=difference_amt%>" readonly></td>
  </tr>
  <tr>
    <td>差异说明</td>
    <td colspan="3"><textarea name="difference_memo" rows="4" maxB="1000" readonly><%=difference_memo%></textarea></td>
  </tr>
