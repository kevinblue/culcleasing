...
int canedit=0;
if (right.CheckRight("htxx-basediscountrate-view",dqczy)>0) canedit=1;
%>
<script>
if (<%=canedit%>==0){
	window.close();
...
<form name="form1" method="post" action="basediscountrate_save.jsp" onSubmit="return checkdata(this);">	
<div id=bgDiv>
...
<table border="0" cellspacing="0" cellpadding="0" height="30">
	  <tr>
		...
		%>
		<a href="basediscountrate_mod.jsp?czid=<%= czid %>"  accesskey="m" title="修改(Alt+M)" class="fontcolor">
...
<table border="0" cellspacing="0" cellpadding="0" width="98%" align="center" class="tab_table_title">
  <tr>
    <td scope="row" nowrap width="20%">开始日期：</td>
    <td><%=start_date %></td>
    <td scope="row" nowrap width="20%">折现率：</td>
    <td><%=discount_rate %>%</td>
  </tr>
