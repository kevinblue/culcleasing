...
int canedit=0;
if (right.CheckRight("htxx-basediscountrate-add",dqczy)>0) canedit=1;
%>
<script>
if (<%=canedit%>==0){
	window.close();
...
<table border="0" cellspacing="0" cellpadding="0" width="98%" align="center" class="tab_table_title">
  <tr>
    <td>开始日期</td>
    <td><input name="start_date" type="text" size="15" readonly maxlength="10" dataType="Date" Require="ture"> <img  onClick="openCalendar(start_date);return false" style="cursor:pointer; " src="../../images/tbtn_overtime.gif" width="20" height="19" border="0" align="absmiddle">
	<span class="biTian">*</span></td>
	<td>折现率</td>
    <td><input name="discount_rate" type="text" size="20" maxB="25" Require="true" dataType="Double">%<span class="biTian">*</span></td>
