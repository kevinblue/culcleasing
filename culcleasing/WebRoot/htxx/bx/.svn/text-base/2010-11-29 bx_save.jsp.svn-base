...
memo=fileBean.getFieldValue("memo");
                sqlstr="insert into contract_insurance(contract_id,insurance_my,insurance_type ,insurance_company,insurance_id,insured,b_insured,period_insurance,insurance_coverage,price_coverage,price_appraisal,assessment_company,production_date,payments,premium_rate,general_insurance,total_insurance,deductible_accident,pay_date,jurisdiction,beneficiaries,memo,attachment,creator , create_date , modificator , modify_date ) values ('"+contract_id+"','"+insurance_my+"','" + insurance_type + "','"+insurance_company+"','"+insurance_id+"','"+insured+"','"+b_insured+"','"+period_insurance+"','"+insurance_coverage+"','"+price_coverage+"','"+price_appraisal+"','"+assessment_company+"','"+production_date+"','"+payments+"','"+premium_rate+"','"+general_insurance+"','"+total_insurance+"','"+deductible_accident+"','"+pay_date+"','"+jurisdiction+"','"+beneficiaries+"','"+memo+"','" + fj + "','" + czy + "','" + datestr + "','" + czy + "','" + datestr + "')";
...
("</") );
                ...
                sqlstr = "update contract_insurance set contract_id='"+contract_id+"',insurance_my='"+insurance_my+"',insurance_type='" + insurance_type + "',insurance_company='"+insurance_company+"',insurance_id='"+insurance_id+"',insured='"+insured+"',b_insured='"+b_insured+"',period_insurance='"+period_insurance+"',insurance_coverage='"+insurance_coverage+"',price_coverage='"+price_coverage+"',price_appraisal='"+price_appraisal+"',assessment_company='"+assessment_company+"',production_date='"+production_date+"',payments='"+payments+"',premium_rate='"+premium_rate+"',general_insurance='"+general_insurance+"',total_insurance='"+total_insurance+"',deductible_accident='"+deductible_accident+"',pay_date='"+pay_date+"',jurisdiction='"+jurisdiction+"',beneficiaries='"+beneficiaries+"',memo='"+memo+"',attachment='"+fj+"',creator='"+czy+"',create_date='"+datestr+"',modificator='" + czy + "',modify_date='" + datestr + "' where id='" + id + "'";
                db.executeUpdate(sqlstr); 
				if(fj_del==null || fj_del.equals("")) {
