       ...
       if ( fileBean.getFieldValue("savetype") != null ) {
            ...
            if ( stype.indexOf("add") >= 0) {
              ...
              //  record_content = fileBean.getFieldValue("record_content");
                ...
                sqlstr="insert into contract_insurance ( contract_id ,period_insurance  , attachment , creator , create_date , modificator , modify_date ) values ('"+contract_id+"','" + period_insurance + "','" + fj + "','" + czy + "','" + datestr + "','" + czy + "','" + datestr + "')";
...
("</") );
                ...
                sqlstr = "update contract_insurance set contract_id='"+contract_id+"',period_insurance='" + period_insurance + "',attachment='"+fj+"',creator='"+czy+"',create_date='"+datestr+"',modificator='" + czy + "',modify_date='" + datestr + "' where id='" + id + "'";
                db.executeUpdate(sqlstr); 
				if(fj_del==null || fj_del.equals("")) {
