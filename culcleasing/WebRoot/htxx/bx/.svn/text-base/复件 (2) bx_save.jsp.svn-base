...
<%
	...
	System.out.print("+++++++++++");
		sql="insert into contract_insurance(contract_id,insurance_my,insurance_id,buy_insuranceself,period_insurance,colleaction_date,insurance_type,pay_date,payments,insured_amount,creator,create_date,modificator,modify_date)"+
		"values('"+contract_id+"','"+insurance_my+"','"+insurance_id+"','"+buy_insuranceself+"','"+period_insurance+"','"+colleaction_date+"','"+insurance_type+"','"+pay_date+"','"+payments+"','"+insured_amount+"','"+dqczy+"','"+systemDate+"','"+dqczy+"','"+systemDate+"') ";
	...
	if(savaType.equals("mod")){
		...
		"colleaction_date='"+colleaction_date+"',insurance_type='"+insurance_type+"',creator='"+dqczy+"',create_date='"+systemDate+"',modificator='"+dqczy+"',modify_date='"+systemDate+"',pay_date='"+pay_date+"',insured_amount='"+insured_amount+"',payments='"+payments+"'"+
		"where id='"+id+"'";
