...
<td>
	<input  name="insurance_my" type="radio" value="是" checked="checked">
     ...
     <tr>
     	<td>保险类型：</td>
    	<td><input class="text" id="insurance_type" name="insurance_type" type="text" size="30"  value="" maxB="30" ></td>
     	<td>保险公司：</td>
     <td><input class="text" id="insurance_company" name="insurance_company" type="text" size="50"  value="" maxB="50" ></td>
     	</tr>
     	
     	 <tr>
     	<td>保险单号：</td>
	<td><input class="text" id="insurance_id" name="insurance_id" type="text" size="30"  value=""  maxB="20" ><span class="biTian">*</span></td>
     	<td>投保人：</td>
     <td><input class="text" id="insured" name="insured" type="text" size="50"  value="" maxB="50" ></td>
     	</tr>
     	
     		
     	 <tr>
     	<td>被保险人：</td>
	<td><input class="text" id="b_insured" name="b_insured" type="text" size="30"  value=""  maxB="30" ></td>
      <td>保险期限：</td>
	<td><input class="text" id="period_insurance" name="period_insurance" type="text" size="30"  value="" maxB="30" Require="true" dataType="Number"><span class="biTian">*</span></td>
     	 ...
     	 <tr>
     	<td>保险项目：</td>
	<td><input class="text" id="insurance_coverage" name="insurance_coverage" type="text" size="30"  value=""  maxB="30" ></td>
      <td>保险项目原价：</td>
	...
	<td><input class="text" id="payments" name="payments" type="text" size="30"  value="" dataType="Money" ><span class="biTian">*</span></td>
     	</tr>
     	 <tr>
     	<td>保险费率：</td>
	...
	<td><input class="text" id="general_insurance" name="general_insurance" type="text" size="30"  value="" maxB="30"  ></td>
     	 ...
     	 <tr>
     	<td>总保险金额：</td>
	<td><input class="text" id="total_insurance" name="total_insurance" type="text" size="30"  value=""  maxB="30" dataType="Money"></td>
      <td>每次事故免赔额：</td>
	<td><input class="text" id="deductible_accident" name="deductible_accident" type="text" size="30"  value="" maxB="30"  ></td>
     	</tr>
     	 <tr>
     	<td>付费日期：</td>
	<td><input class="text" name="pay_date" type="text" size="30" readonly >
    ...
    <tr>
     	<td>受益人：</td>
	<td><input class="text" id="beneficiaries" name="beneficiaries" type="text" size="30"  value=""  maxB="30" ></td>
      <td>备注：</td>
	<td><input class="text" id="memo" name="memo" type="text" size="30"  value="" maxB="30"  ></td>
     	</tr>
