...
<% 
	String id = getStr( request.getParameter("bid"));
	System.out.println(id+"**");
	String sqlstr;
	sqlstr = "select *,dengjiren=dbo.GETUSERNAME(creator),xiugairen=dbo.GETUSERNAME(modificator) from mproj_company where bid='"+id+"' ";
	//String sqlstr = "select *,proj_info.project_name from contract_guarantee_equip left join contract_info on contract_guarantee_equip.contract_id=contract_info.contract_id left join proj_info on contract_info.proj_id=proj_info.proj_id where bid='"+id+"'"; 
...
<table border="0" cellspacing="0" cellpadding="0" height="30">
	  <tr>
		<td><a href="csbzj_mod.jsp?bid=<%= id %>"  accesskey="m" title="修改(Alt+M)" class="fontcolor">
