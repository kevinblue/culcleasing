...
<table class="tab_table_title" border="0" cellspacing="0" cellpadding="0" width="100%">
  <tr>
    ...
    <td><input class="text" name="contract_id" type="text" size="20"  value="<%=getDBStr(rs.getString("contract_id"))%>"  maxlength="50" dataType="Money" readonly></td>
    <td scope="row">厂商名称：</td>
	  <td><input class="text" name="manuf_name" type="text" size="20"  value="<%=getDBStr(rs.getString("manuf_name"))%>"  maxlength="50" dataType="Money" readonly></td>
  </tr>
  <tr>
   <td scope="row">厂商设备金额：</td>
    ...
    <td><input class="text" name="ensure_payment" type="text" size="20" Require="true"   dataType="Money"  value="<%=formatNumberStr(rs.getString("ensure_payment"),"#,##0.00")%>" maxlength="20"><span class="biTian">*</span></td>
    <td scope="row">保证金现金额：</td>
    <td><input class="text" name="margin_amount" type="text" size="20"  value="<%=formatNumberStr(rs.getString("margin_amount"),"#,##0.00")%>"   maxlength="30" dataType="Money"></td>
