...
if( searchFld.equals("厂商名字") ) {
	searchFld_tmp = "manuf_name";
}else if( searchFld.equals("合同编号") ) {
	searchFld_tmp = "margin_per";
}else if( searchFld.equals("厂商设备金额") ) {
	searchFld_tmp = "initial_margin";
}else{
	searchFld_tmp = "";
}
...
String sqlstr="select *,dengjiren=dbo.GETUSERNAME(creator),xiugairen=dbo.GETUSERNAME(modificator) from contract_manuf"+wherestr;

System.out.println("&*"+sqlstr);
%>
<body onLoad="public_onload(0);" style="border:1px solid #8DB2E3;overflow:auto" >
<form action="csbzj_list_tt.jsp" name="dataNav" onSubmit="return goPage()">
  <!--标题开始-->
  <table border="0" width="100%" cellspacing="0" cellpadding="0" height="25">
    <tr class="tree_title_txt">
      <td nowrap width="100%" class="tree_title_txt" valign="middle" id="cwCellTopTitTxt">厂商保证金管理 &gt;厂商保证金信息</td>
    </tr>
  </table>
  <!--标题结束-->
  <!--副标题和操作区开始-->
    ...
    <tr class="maintab">
      <td align="left" colspan="2">
        <table width="100%" border="0" cellpadding="0" cellspacing="0" >
          <tr class="maintab">
            <td align="left">
				&nbsp;按&nbsp;<select name="searchFld"><script>w(mSetOpt("<%= searchFld %>","|厂商名字|保证金比率|保证金初始金额"));</script></select>
    ...
    <tr class="maintab">
      <td align="left" width="1%"><!--操作按钮开始-->
        <table border="0" cellspacing="0" cellpadding="0" >
			<tr class="maintab">
				<%if(right.CheckRight("csbzj_tt_add",dqczy)>0){%><td><a href="#" accesskey="n" onClick="dataHander('add','csbzj_add_tt.jsp',dataNav.itemselect);"><img   src="../../images/sbtn_new.gif" alt="新增(Alt+N)" align="absmiddle"></a></td><%}%>
					<%if(right.CheckRight("csbzj_tt_mod",dqczy)>0){%><td><a href="#" accesskey="m" onClick="dataHander('mod','csbzj_mod_tt.jsp?id=',dataNav.itemselect);"><img   src="../../images/sbtn_mod.gif" alt="修改(Alt+M)" align="absmiddle" ></a></td><%}%>
					<%if(right.CheckRight("csbzj_tt_del",dqczy)>0){%><td><a href="#" accesskey="d" onClick="dataHander('del','csbzj_del_tt.jsp?id=',dataNav.itemselect);"><img src="../../images/sbtn_del.gif" alt="删除(Alt+D)" align="absmiddle" ></a></td><%}%>
		    </tr>
        </table>
        <!--操作按钮结束--></td>
...
%>
      ...
      <tr>
       ...
       <td align="center"><a href="csbzj_tt.jsp?id=<%=getDBStr( rs.getString("id") )  %>" target="_blank"><%=getDBStr( rs.getString("id") )  %></a></td>
     <td align="center"><%= getDBStr( rs.getString("manuf_name") ) %></td>
