...
String sqlstr="select margin_per,initial_margin from contract_manuf where ";
%>
...
total=total+parseFloat(vendor_payment*caution_money_ratio/100);
...
<tr>
		   <td scope="row" nowrap>保证金比率：</td>
 <td><input class="text" name="margin_per" type="text" size="20"  dataType="Money" maxlength="20" Require="true" onchange="makeV()">
 <span class="biTian">*</span></td> 
   <td scope="row" nowrap>保证金初始金额：</td>
 <td><input class="text" name="" type="text" size="20"  dataType="Money" maxlength="20" Require="true" onchange="makeV()">
 <span class="biTian">*</span></td> 
...
<td scope="row" nowrae="row" nowrap>保证金汇入时间：</td>
  ...
  <td><input class="text" name="export_time" type="text" size="20"  maxlength="40" readonly >
    ...
    <tr>
	  <td>保证金比率：</td>
			 <td><input class="text" name="caution_money_ratio" id="caution_money_ratio" type="text" size="20"  dataType="Money" maxlength="20" Require="true">%
 <span class="biTian">*</span></td>
