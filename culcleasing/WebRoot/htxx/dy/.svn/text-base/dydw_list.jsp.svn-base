...
<form action="dydw_list.jsp" name="dataNav" onSubmit="return goPage()">
  ...
  <table border="0" width="100%" cellspacing="0" cellpadding="0" height="25">
    <tr class="tree_title_txt">
      <td nowrap width="100%" class="tree_title_txt" valign="middle" id="cwCellTopTitTxt">资产管理 &gt; 担保物管理</td>
    </tr>
  </table>
  <!--标题结束-->
  <!--副标题和操作区开始-->
    ...
    <tr class="maintab">
      <td align="left" colspan="2">
        <table width="100%" border="0" cellpadding="0" cellspacing="0" >
          <tr class="maintab">
            <td align="left">
				&nbsp;按&nbsp;<select name="searchFld"><script>w(mSetOpt("<%= searchFld %>","|合同编号|项目名称|物品名称"));</script></select>
    ...
    <tr class="maintab">
      <td align="left" width="1%"><!--操作按钮开始-->
        <table border="0" cellspacing="0" cellpadding="0" >
			<tr class="maintab">
				<%if(right.CheckRight("dyw_add",dqczy)>0){%><td><a href="#" accesskey="n" onClick="dataHander('add','dydw_add.jsp',dataNav.itemselect);"><img   src="../../images/sbtn_new.gif" alt="新增(Alt+N)" align="absmiddle"></a></td><%}%>
				<%if(right.CheckRight("dyw_mod",dqczy)>0){%><td><a href="#" accesskey="m" onClick="dataHander('mod','dydw_mod.jsp?id=',dataNav.itemselect);"><img   src="../../images/sbtn_mod.gif" alt="修改(Alt+M)" align="absmiddle" ></a></td><%}%>
				<%if(right.CheckRight("dyw_del",dqczy)>0){%><td><a href="#" accesskey="d" onClick="dataHander('del','dydw_del.jsp?id=',dataNav.itemselect);"><img src="../../images/sbtn_del.gif" alt="删除(Alt+D)" align="absmiddle" ></a></td><%}%>
		    </tr>
        </table>
        <!--操作按钮结束--></td>
