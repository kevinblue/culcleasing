...
onClick="OpenDataWindow('','','','','项目名称','proj_info','project_name','proj_id','project_name','project_name','asc','form1.project_name','form1.proj_id');"><span class="biTian">*</span></td>
    ...
    <td>
	   <input class="text" type="text" name="lease_contract_num" readonly Require="true">
		...
		<img src="../../images/fdmo_65.gif" alt="选" width="19" height="19" align="absmiddle"  style="cursor:pointer"
		onClick="OpenDataWindow('form1.proj_id','项目名称','proj_id','string','合同编号','v_contract_info_t','lease_contract_num','contract_id','lease_contract_num','lease_contract_num','asc','form1.lease_contract_num','form1.contract_id');">
  ...
  <tr>
  <td scope="row">担保物原值</td>
<td><input class="text" name="original_value" type="text" size="20"  maxlength="40" dataType="Money"></td>
 <td scope="row">担保金额：</td>
    <td><input class="text" name="total_price" type="text" size="20" Require="true" dataType="Money" maxlength="20"><span class="biTian">*</span></td>

  </tr>
    <tr>
  <td scope="row">评估值：</td>
<td><input class="text" name="eval_value" type="text" size="20"  maxlength="40" dataType="Money"></td>
 <td scope="row">评估机构：</td>
<td><input class="text" name="assessment_agencies" type="text" size="20"  maxlength="40" ></td>
   
 </tr>
  <tr>
    <td scope="row">评估日期：</td>

<td nowrap class="text"><input class="text" id="assessment_date" name="assessment_date" type="text" readonly value="">
   <img onClick="openCalendar(assessment_date);return false;" style="cursor:pointer; " src="../../images/fdmo_63.gif" border="0" align="absmiddle">
														</td> 
 <td scope="row">保险情况：</td>
<td><input class="text" name="insurance_situation" type="text" size="20"  maxlength="40"></td>
...
<td scope="row">担保物所在地：</td>
<td><input class="text" name="collateral_place" type="text" size="20"  maxlength="40" dataType="Money"></td>
  </tr>
  <tr>
    <td scope="row">证号：</td>
 ...
 <td>备注：</td>
	<td><textarea class="text" id="memo" name="memo"  value=""  maxB="400"></textarea></td>
   </tr>
</table>
</div>
