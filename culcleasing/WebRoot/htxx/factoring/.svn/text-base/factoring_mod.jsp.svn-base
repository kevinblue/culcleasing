...
ShowTabN(0);
	...
	factoring_date=	getDBStr(rs.getString("factoring_date"));
...
<option id="factoring_2" value="是">是</option>
	   <option id="factoring_1" value="否">否</option>
              ...
              <tr>
                ...
                <td scope="row"  nowrap>保理日期：</td>
                <td  nowrap><input class="text" name="factoring_date" value="<%= factoring_date %>" type="text"  readonly="readonly" ><img  onClick="openCalendar(factoring_date);return false" style="cursor:pointer; " src="../../images/tbtn_overtime.gif" width="20" height="19" border="0" align="absmiddle"></td>
