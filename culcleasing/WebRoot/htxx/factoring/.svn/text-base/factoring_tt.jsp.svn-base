...
//sql="update fund_rent_plan set factoring='是',factoring_pringcipal='"+corpus+"',factoring_rantal='"+interest+"',factoring_date='"+datestr+"' where id='"+id+"' ";
...
sql+="('"+contract_id+"','"+rent_list+"','是','"+corpus+"','"+interest+"','"+datestr+"','"+dqczy+"','"+datestr+"','"+dqczy+"','"+datestr+"')";
