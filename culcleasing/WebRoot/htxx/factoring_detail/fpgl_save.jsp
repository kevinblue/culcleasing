...
String sqlst;
sqlst="update proj_invoice set invoice_number='"+invoice_number+"',invoice_date='"+invoice_date+"',creator='"+dqczy+"',create_date='"+systemDate+"',modificator='"+dqczy+"',modify_date='"+systemDate+"',memo='"+memo+"' where id='"+id+"'";
...
sqlstr="insert into proj_invoice(invoice_number,invoice_name,invoice_total,invoice_date,creator,create_date,modificator,modify_date,memo) values('"+invoice_number+"','"+invoice_name+"','"+invoice_total+"','"+invoice_date+"','"+dqczy+"','"+systemDate+"','"+dqczy+"','"+systemDate+"','"+memo+"')";
