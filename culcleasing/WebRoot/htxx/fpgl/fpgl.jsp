...
int canedit=0;
if (right.CheckRight("htxx-fpgl-view",dqczy)>0) canedit=1;
%>
<script>
if (<%=canedit%>==0){
	window.close();
...
<table border="0" cellspacing="0" cellpadding="0" height="30">
	  <tr>
		...
		%>
		<a href="fpgl_mod.jsp?czid=<%= czid %>"  accesskey="m" title="修改(Alt+M)" class="fontcolor">
...
<table border="0" cellspacing="0" cellpadding="0" width="98%" align="center" class="tab_table_title">
  <tr>
    ...
    <td scope="row" nowrap width="20%">发票号：</td>
    <td><%=invoice_number %></td>
  </tr>
  <tr>
    <td scope="row" nowrap width="20%">发票日期：</td>
    <td><%=invoice_date %></td>

    <td scope="row" nowrap width="20%">发票金额：</td>
    <td><%=invoice_amt %></td>
  </tr>
  <tr>
    <td scope="row" nowrap width="20%">是否已收到全额发票：</td>
