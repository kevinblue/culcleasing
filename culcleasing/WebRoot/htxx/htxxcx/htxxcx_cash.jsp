...
<%
    ...
    strSql = "select count(*) as count from fund_contract_plan where contract_id='" + contract_id + "'";
    ...
    rsCount.close();
	if(int_count>0){
	    strSql = "select * from fund_contract_plan where contract_id='" + contract_id + "' order by plan_list";
	    System.out.println(strSql);
