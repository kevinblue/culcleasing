...
<table border="0" cellspacing="0" cellpadding="0" width="98%" align="center" class="tab_table_title">
  <tr>
    ...
    <td>商定支付本金</td>
    <td><input name="agree_premature_corpus" type="text" size="10" value="<%=agree_premature_corpus%>" require="true" dataType="Money" onPropertyChange="sjjs();"><span class="biTian">*</span></td>
  </tr>
  <tr>
    <td>违约手续费</td>
    <td><input name="break_handling_charge" type="text" size="10" value="<%=break_handling_charge%>" readonly></td>
    <td>商定违约手续费</td>
    <td><input name="agree_handling_charge" type="text" size="10" value="<%=agree_handling_charge%>" require="true" dataType="Money" onPropertyChange="sjjs();"><span class="biTian">*</span></td>
  </tr>
  <tr>
    <td>名义货价</td>
    <td><input name="nominalprice" type="text" size="10" value="<%=nominalprice%>" readonly></td>
    <td>商定名义货价</td>
    <td><input name="agree_nominalprice" type="text" size="10" value="<%=agree_nominalprice%>" require="true" dataType="Money" onPropertyChange="sjjs();"><span class="biTian">*</span></td>
  </tr>
  <tr>
    <td>期间利息</td>
    <td><input name="period_interest" type="text" size="10" value="<%=period_interest%>" readonly></td>
    <td>商定期间利息</td>
    <td><input name="agree_period_interest" type="text" size="10" value="<%=agree_period_interest%>" require="true" dataType="Money" onPropertyChange="sjjs();"><span class="biTian">*</span></td>
  </tr>
  <tr>
    <td>逾期本金</td>
    <td><input name="overdue_corpus" type="text" size="10" value="<%=overdue_corpus%>" readonly></td>
    <td>商定逾期本金</td>
    <td><input name="agree_overdue_corpus" type="text" size="10" value="<%=agree_overdue_corpus%>" require="true" dataType="Money" onPropertyChange="sjjs();"><span class="biTian">*</span></td>
  </tr>
  <tr>
    <td>逾期利息</td>
    <td><input name="overdue_interest" type="text" size="10" value="<%=overdue_interest%>" readonly></td>
    <td>商定逾期利息</td>
    <td><input name="agree_overdue_interest" type="text" size="10" value="<%=agree_overdue_interest%>" require="true" dataType="Money" onPropertyChange="sjjs();"><span class="biTian">*</span></td>
  </tr>
  <tr>
    <td>逾期罚息</td>
    <td><input name="overdue_penalty" type="text" size="10" value="<%=overdue_penalty%>" readonly></td>
    <td>商定逾期罚息</td>
    <td><input name="agree_overdue_penalty" type="text" size="10" value="<%=agree_overdue_penalty%>" require="true" dataType="Money" onPropertyChange="sjjs();"><span class="biTian">*</span></td>
  </tr>
  ...
  <tr>
  	<td colspan="4" align="right"><BUTTON class="btn_2" name="btnSave" value="保存"  type="submit" ><img src="../../images/save.gif" align="absmiddle" border="0">确认</button></td>
  </tr>
