...
<%
	...
	sqlstr="select fund_rent_adjust.start_list,fund_rent_adjust.payday_delay,isnull(fund_rent_adjust.handling_charge,0) as handling_charge from fund_rent_adjust where fund_rent_adjust.measure_id='"+doc_id+"'";
...
<table border="0" cellspacing="0" cellpadding="0">
	<tr class="maintab">
		<td nowrap>
		延期到<input name="zfr_date" type="text" size="15" readonly maxlength="10" dataType="Date" Require="true" value="<%= payday_delay %>"> <img  onClick="openCalendar(zfr_date);return false" style="cursor:pointer; " src="../../images/tbtn_overtime.gif" width="20" height="19" border="0" align="absmiddle">
		,开始期项为第<input name="start_rent_list" type="text" size="5" maxB="3" Require="true" dataType="Integer" value="<%= start_list %>">期
