...
<table border="0" cellspacing="0" cellpadding="0">
	<tr class="maintab">
		<td nowrap>
		延期到<input name="zfr_date" type="text" size="15" readonly maxlength="10" dataType="Date" Require="true" value="<%= payday_delay %>"> 
		,开始期项为第<input name="start_rent_list" type="text" size="5" maxB="3" Require="true" value="<%= start_list %>" readonly>期
		,手续费为<input name="handling_charge" type="text" size="10" Require="true" value="<%= handling_charge %>" readonly>元
		</td>
