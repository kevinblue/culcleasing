...
int canedit=0;
if (right.CheckRight("htxx-penarate-add",dqczy)>0) canedit=1;
%>
<script>
if (<%=canedit%>==0){
	window.close();
...
<table border="0" cellspacing="0" cellpadding="0" width="98%" align="center" class="tab_table_title">
  <tr>
    <td>罚息利率</td>
    <td><input name="pena_rate" type="text" size="20" maxB="10" dataType="Double" Require="ture">%%
	<span class="biTian">*</span></td>
	<td>中文描述</td>
    <td><input name="pena_chs" type="text" size="30" maxB="30" Require="true"><span class="biTian">*</span></td>
