...
<% 
	...
	String sqlstr = "select * from  base_extractscale where id='"+id+"'"; 
...
<table border="0" cellspacing="0" cellpadding="0" height="30">
	  <tr>
		<td><a href="tqbl_mod.jsp?id=<%= id %>"  accesskey="m" title="修改(Alt+M)" class="fontcolor">
...
<div id="TD_tab_0">
	<table border="0" cellspacing="0" cellpadding="0" width="98%" align="center" class="tab_table_title">
	  <tr>
	    <td width="130px">资产分类</td>
	    <td><%=fiveclass %></td>
	  </tr>
	  
	  <tr>
	    <td width="130px">提取比例</td>
	    <td><%=scale %></td>
	  </tr>
