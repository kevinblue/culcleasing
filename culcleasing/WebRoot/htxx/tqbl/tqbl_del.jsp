...
<form name="form1" method="post" action="tqbl_save.jsp">
...
<table border="0" cellspacing="0" cellpadding="0" width="100%" class="tab_table_title">
    ...
    <td class="cwDDLabel"><%=getDBStr(rs.getString("fiveclass"))%></td>
  </tr>
  <tr>
    <td class="cwDDLabel">利率：</td>
    <td class="cwDDLabel"><%=getDBStr(rs.getString("scale"))%></td>
  </tr>
