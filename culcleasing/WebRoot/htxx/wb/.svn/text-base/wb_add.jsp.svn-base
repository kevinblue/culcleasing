...
<table border="1" cellspacing="0" cellpadding="0" width="98%" align="center" class="tab_table_title">
  ...
  <tr>
    <td scope="row">汇率：</td>
    <td><input class="text" name="exchange_rate" type="text" size="20" Require="true" maxlength="40"  ><span class="biTian">*</span></td>
  </tr>
    <tr>
    <td scope="row">利率：</td>
    <td><input class="text" name="interest_rate" type="text" size="20" Require="true" maxlength="40"><span class="biTian">*</span></td>
  </tr>
  <tr>
    <td scope="row">对应费用的人民币金额：</td>
    <td><input class="text" name="amout" type="text" size="20" Require="true" dataType="Money" maxlength="20">元<span class="biTian">*</span></td>
  </tr>
