...
<form name="form1"  method="post" action="wb_save.jsp" onSubmit="return Validator.Validate(this,3);">
...
<table border="0" cellspacing="0" cellpadding="0" width="100%" class="tab_table_title">
   ...
   <tr>
    <td scope="row">汇率：</td>
    <td><input class="text" name="exchange_rate" type="text" size="20"   value="<%=getDBStr(rs.getString("exchange_rate"))%>" maxlength="30"></td>
  </tr>
  <tr>
    <td scope="row">利率：</td>
    <td><input class="text" name="interest_rate" type="text" size="20" value="<%=getDBStr(rs.getString("interest_rate"))%>" maxlength="50"></td>
  </tr>
  <tr>
    <td scope="row">对应费用的人民币金额：</td>
    <td><input class="text" name="amout" type="text" size="20" Require="true"   dataType="Money"  value="<%=formatNumberStr(rs.getString("amout"),"#,##0.00")%>" maxlength="20">元<span class="biTian">*</span></td>
  </tr>
