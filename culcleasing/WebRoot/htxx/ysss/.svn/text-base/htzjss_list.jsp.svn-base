...
String sqlstr = "select fund_rent_income.plan_list,fund_rent_income.hire_date,fund_rent_income.rent,fund_rent_income.corpus,fund_rent_income.interest from fund_rent_income" + wherestr; 
sqlstr+=" order by fund_rent_income.hire_date";
