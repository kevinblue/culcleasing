...
<table border="0" cellspacing="0" cellpadding="0">
	<tr class="maintab">
		...
		日
		,开始期项为第<input name="start_rent_list" type="text" size="5" dataType="Integer" Require="true" value="<%=start_list %>" readonly>期
		,手续费为<input name="handling_charge" type="text" size="10" Require="true" dataType="PMoney" value="<%= handling_charge %>" readonly>元
		</td>
