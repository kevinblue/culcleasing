...
<body style="overflow:auto;">
    <table border="0" style="border-collapse:collapse;" align="center" cellpadding="2"  cellspacing="1" width="100%" class="maintab_content_table">
    	...
    	<form action="managefee_plan_up.jsp" name="form<%=i %>" target="blank" method="get">
	    	<tr>
				<td class="noNewLine"><input type="text"  label="管理服务费期�? Require="true" size="6" id="managefee_list_<%=i %>" 
				name="managefee_list" readonly="readonly" value="<%=getDBStr(rs.getString("managefee_list")) %>"></td>
				<td class="noNewLine"><input type="text" label="租赁物件当月运营月收�? Require="true" id="equip_operation_revenue_<%=i %>" name="equip_operation_revenue"   value="<%=getDBStr(rs.getString("equip_operation_revenue")) %>"><span class="biTian">*</span></td>
				...
				<td class="noNewLine"><input type="text" label="管理方分成比�? Require="true" id="manage_separate_ratio_<%=i %>" name="manage_separate_ratio"  value="<%=getDBStr(rs.getString("manage_separate_ratio")) %>">%<span class="biTian">*</span></td>
				<td class="noNewLine">
    	...
    	<%
    	 ...
    	 %>
			    <tr>		
					<td class="noNewLine"><input type="text" label="管理服务费期�? Require="true" name="managefee_list" size="6" readonly="readonly" value="<%=indexNum %>"></td>
					...
					<td class="noNewLine"><input type="text" label="管理方分成比�? Require="true" id="manage_separate_ratiof" name="manage_separate_ratio" value="">%<span class="biTian">*</span></td>
					<td class="noNewLine">
