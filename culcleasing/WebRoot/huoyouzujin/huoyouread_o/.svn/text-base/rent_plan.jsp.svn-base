...
<body style="overflow:auto;">
    <table border="0" style="border-collapse:collapse;" align="center" cellpadding="2"  cellspacing="1" 
   	...
   	<% 
   		String str="rent_list,equip_operation_revenue,leas_separate_ratio,leas_plan_rent,leas_rent_start_date,leas_rent_end_date,";
   		str +="leas_other_out,leas_fact_rent,leas_all_in,plan_date,plan_bank_name,plan_bank_no,income_hire_date";
   	...
   	%>
    	<tr>
			...
			<td class="noNewLine"><%=getDBDateStr(rs.getString("leas_rent_start_date")) %></td>
			<td class="noNewLine"><%=getDBDateStr(rs.getString("leas_rent_end_date")) %></td>
			...
			<td class="noNewLine"><%=getDBDateStr(rs.getString("income_hire_date")) %></td>
