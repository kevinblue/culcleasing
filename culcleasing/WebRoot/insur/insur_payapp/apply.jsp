...
<table border="0" cellspacing="0" cellpadding="0" width="98%" align="center" class="tab_table_title">
 <tr>
  ...
  <tr>
    ...
    <td>&nbsp; </td>
	<td scope="row">结算方式:&nbsp;&nbsp;<b style="color:#E46344;"><%=pay_method %></b></td>
    <td>&nbsp; </td>
  </tr>
</table>
...
<table border="0" style="border-collapse:collapse;" align="center" cellpadding="2" cellspacing="1" width="95%"
...
<tbody id="data">
<%
sqlstr = "select vefh.* from vi_insur_pay_hire_detail vefh where vefh.id in( select plan_id from apply_info_detail where apply_id='"+czid+"' )order by contract_id";
