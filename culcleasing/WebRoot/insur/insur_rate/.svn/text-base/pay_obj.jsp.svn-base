...
%>
<select name="datalist" size="15" ondblclick="ListSelect('form1.cust_name','form1.cust_id');" style="height:80%">
...
%>
	...
	<%=getDBStr(rs.getString("cust_name"))%>--><%=getDBStr(rs.getString("cust_id"))%>
	</option>
<%} %>
</select>
</div>
...
<tr>
    <td align="center">
    <input  class="btn3_mouseout" type="button" value="确定" onClick="ListSelect('form1.cust_name','form1.cust_id');">  
