...
int canedit=0;
if (right.CheckRight("insurance-caver-del",dqczy)>0) canedit=1;
...
String sqlstr = "select caver.caver_id,views.contract_id,views.cust_name,device_type,views.equip_sn,views.equip_num,views.lease_term months,views.years,views.start_date,views.end_date,views.insurance_date,views.insurance_enddate,views.insurer,views.days,caver.insurance_state,caver.insurance_result from insurance_caver caver left join contract_view views on views.contract_id = caver.contract_id where caver.caver_id = '"+czid+"'";
...
<table border="0" cellspacing="0" cellpadding="0" width="98%" align="center" class="tab_table_title">
  <tr>
    <td>合同号</td>
    <td><input name="contract_id" type="text" size="20" maxB="50" value="<%= contract_id %>" readonly></td>
    <td>客户名</td>
  ...
  <tr>
    ...
    <td>处理状态</td>
    <td><input name="insurance_state" type="text" value="<%="1".equals(insurance_state) ? "已处理" : "待处理" %>" size="20" maxB="50" readonly ></td>
    <td>处理结果</td>
    <td><input name="insurance_result" type="text" value="<%= insurance_result %>" size="20" maxB="50" readonly></td>
  </tr>
</table>
<br>
