...
<table border="0" cellspacing="0" cellpadding="0" >    
    <tr class="maintab">
        <!--<td><a href="#" accesskey="n" onClick="dataHander('add','caver_add.jsp',dataNav.itemselect);"><img align="absmiddle"  src="../../images/sbtn_new.gif" alt="新增(Alt+N)" align="absmiddle"></a></td>-->
		<td><a href="#" accesskey="m" onClick="dataHander('mod','caver_update.jsp?czid=',dataNav.itemselect);"><img align="absmiddle"  src="../../images/sbtn_mod.gif" alt="修改(Alt+M)" align="absmiddle" ></a></td>
		<!--<td><a href="#" accesskey="d" onClick="dataHander('del','caver_del.jsp?czid=',dataNav.itemselect);"><img align="absmiddle" src="../../images/sbtn_del.gif" alt="删除(Alt+D)" align="absmiddle" ></a></td>-->
    </tr>
</table>
<!--操作按钮结束-->
</td>
