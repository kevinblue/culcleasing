...
int canedit=0;
if (right.CheckRight("insurance-caver-mod",dqczy)>0) canedit=1;
...
<input type="hidden" name="caver_id" value="<%= caver_id %>">
<input type="hidden" name="savetype" value="mod">
<input type="hidden" name="czid" value="<%= czid %>">
<table border="0" cellspacing="0" cellpadding="0" width="98%" align="center" class="tab_table_title">
  <tr>
    <td>合同号</td>
    <td><input name="contract_id" type="text" size="20" maxB="50" Require="true" value="<%= contract_id %>" readonly><!--<img src="../../images/sbtn_more.gif" alt="选" width="19" height="19" align="absmiddle"  style="cursor:pointer" onClick="OpenDataWindow('','','','','合同号',  'contract_view','contract_id','cust_name|equip_sn|equip_num|lease_term|years|start_date|end_date|insurance_date|insurance_enddate|insurer|days','contract_id','','','form1.contract_id','form1.cust_name|form1.equip_sn|form1.equip_num|form1.months|form1.years|form1.start_date|form1.end_date|form1.insurance_date|form1.insurance_enddate|form1.insurer|form1.days');">
  ...
  <tr>
    ...
    <td><select name="insurance_state" width="80px" Require="true">
    		<option value="0" <%="1".equals(insurance_state) ? "" : "selected"%>>待处理</option>
            <option value="1" <%="1".equals(insurance_state) ? "selected" : ""%>>已处理</option>
    </select></td>
    <td>处理结果</td>
    <td><input name="insurance_result" type="text" value="<%= insurance_result %>" size="20" maxB="50" ></td>
  </tr>
</table>
</div>
</div>
