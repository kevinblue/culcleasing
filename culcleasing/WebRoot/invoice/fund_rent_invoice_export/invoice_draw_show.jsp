...
<form action="invoice_draw_show.jsp" name="dataNav" onSubmit="return goPage()"  confirm="false" method="post">
...
countSql = "select count(out_no) as amount from vi_invoice_draw_result_show where 1=1 "+wherestr;
...
String expsqlstr = "select "+exportcolumn+" from vi_invoice_draw_result_show where 1=1 "+wherestr; 
System.out.println("vvvvvvvvvvvvv"+expsqlstr);

String updSql="select contract_id,fee_name,fee_num,id from vi_invoice_draw_result_show where 1=1 "+wherestr;
%>
<!--可折叠查询开始-->
...
sqlstr = "select top "+ intPageSize +" * from vi_invoice_draw_result_show where id not in( ";
sqlstr += " select top "+ (intPage-1)*intPageSize +" id from vi_invoice_draw_result_show where 1=1 "+wherestr+" order by id ) "+wherestr ;
sqlstr +=" order by id ";
