...
//导出类型2--数据导出
String expsqlstr = "select '' 单据编号,'' 单据日期,'' 发票号,'' 发票日期, cust_name 客户名称,'第'+convert(varchar(20),fee_num)+'期资金'+fee_name+'(融资租赁)'  商品,'1' 数量,plan_money   单价,plan_money 金额,invoice_remark 备注,'' 收款人,'0' 状态 from vi_invoice_export where 1=1 "+wherestr; 
