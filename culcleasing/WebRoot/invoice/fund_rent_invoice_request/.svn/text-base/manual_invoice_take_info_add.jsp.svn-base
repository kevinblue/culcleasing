...
<tr>
   <td nowrap class="text">含税金额：</td>
    ...
    <td nowrap class="text"><select class="text" Require="true" name="if_tax"><script>w(mSetOpt("<%=getDBStr(rs.getString("if_tax"))%>","|是|否"));</script></select>
     <span class="biTian">*</span></td>
...
<tr>
   ...
   <td nowrap class="text"><select class="text" Require="true" id="invoice_type" name="invoice_type" ><script>w(mSetOpt("<%=getDBStr(rs.getString("invoice_type"))%>","|增值税普通发票|增值税专用发票"));</script></select>
   <span class="biTian">*</span></td>
	  <td nowrap class="text">是否erp数据：</td>
   <td nowrap class="text"><select class="text" Require="true" name="if_erp" ><script>w(mSetOpt("<%=getDBStr(rs.getString("if_erp"))%>","|是|否"));</script></select>
     <span class="biTian">*</span></td>
