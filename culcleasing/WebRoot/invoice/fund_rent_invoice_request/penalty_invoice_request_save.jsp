...
<%
	...
	for(int i=0;i<id_arr.length;i++){
		...
		if(invoice_statues_arr[i].equals("未申请")){
			sql = " insert  into  [dbo].[fund_invoice_info](contract_id,contract_fund_plan,contract_fund_charge,tax_type,tax_type_invoice,"+
		...
		if(invoice_statues_arr[i].equals("已退回")){
					...
					sql+=" where contract_fund_charge='faxi' and  contract_fund_plan='"+cfpi_arr[i]+"' and contract_id='"+contract_arr[i] +"'";
		}
