...
<tbody id="data">
<%
sqlstr = "select vefh.* from vi_insur_pay_hire_detail vefh where vefh.id in( select plan_id from apply_info_detail where apply_id='"+czid+"' )order by contract_id,plan_status desc";
