...
<table border="0" cellspacing="0" cellpadding="0" >    
    <tr class="maintab">
		<td><a href="dfxx_mod.jsp?czid=<%=czid %>&target_id=<%=target_id %>" target="_black" accesskey="n" ><img src="../../images/sbtn_new.gif" alt="评分" width="19" height="19" align="absmiddle">评分</a></td>
...
%>
	...
	<%} %>
	<tr class="cwDLRow">
		<td colspan="3" align="right" >建议风险评分：<%=formatNumberDouble(dsumscore) %> <%=flag?"":"否决" %></td>
