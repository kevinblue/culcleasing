...
<table  border="0" cellspacing="0" cellpadding="0" width="98%" align="center" class="tab_table_title">
  <tr>
    ...
    <td><input name="evaluation_type" type="text" value="<%=evaluation_type %>" size="20" maxlength="50" maxB="50"  Require="true"><span class="biTian">*</span></td>
  	<th>登记人</th>
    <td ><%=creator%>&nbsp;</td>
  </tr>
  <tr>
