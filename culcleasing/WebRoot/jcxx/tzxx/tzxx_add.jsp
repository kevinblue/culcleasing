...
ResultSet rs = null;
String sqlstr = "select evaluation_type from base_evaluation_type where id="+type;
rs=db.executeQuery(sqlstr);
if(rs.next()){
	eval_type = getDBStr(rs.getString("evaluation_type"));
}
ResultSet rsOrder =null;
sqlstr = "select count(*)+1 as max_order_number from base_evaluation_adjust where evaluation_type="+type;
...
<table  border="0" cellspacing="0" cellpadding="0" width="98%" align="center" class="tab_table_title">
  <tr>
    ...
    <td><input name="other_condition" type="text" value="" size="40" maxlength="100" maxB="100"  Require="true"><span class="biTian">*</span>
	</td>
    <th scope="row">评分类型</th>
    <td><input name="evaluation_type_name" type="text" value="<%=eval_type%>" size="40" maxlength="50" maxB="50"  Require="true"><input type="hidden" name="evaluation_type" value ="<%=type%>">
  ...
  <tr>
  	<th scope="row">序号</th>
    <td><input name="order_number" type="text" value="<%=max_order_number.equals("")?"1":max_order_number%>"  dataType="Number" size="10" maxlength="4" maxB="4"  Require="true"><span class="biTian">*</span>
	</td>
	<th  scope="row">评论</th>
	<td><input name="comment" type="text" value="" size="40" maxlength="250" maxB="250"  Require="true"><span class="biTian">*</span></td>
  </tr>	
   <tr>
  	<th scope="row">状态</th>
