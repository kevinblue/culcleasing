...
<table  border="0" cellspacing="0" cellpadding="0" width="98%" align="center" class="tab_table_title">
  <tr>
    ...
    <td><input name="other_condition" type="text" value="<%=other_condition%>" size="40" maxlength="100" maxB="100"  Require="true"><span class="biTian">*</span>
	</td>
  ...
  <tr>
	...
	<th  scope="row">评论</th>
	<td><input name="comment" type="text" value="<%=comment%>" size="40" maxlength="250" maxB="250"  Require="true"><span class="biTian">*</span></td>
  </tr>	
   <tr>
  	<th scope="row">状态</th>
