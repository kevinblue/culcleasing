...
<table id="" border="0" cellspacing="5" cellpadding="0" width="100%" >
      <tr>
        <td nowrap align="right"><%=selfldname%>: <input type="text" name="fv"   value="<%=filtervalue%>" style="width:90px"><input name="image" type="image" src="../images/tbtn_searh.gif" alt="查询" align="absmiddle" >
</td>
      </tr>
</table>
