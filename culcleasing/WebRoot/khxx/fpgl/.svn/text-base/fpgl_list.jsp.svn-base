...
ResultSet rs;
String wherestr = " where isnull(invoice_method,0) <> '非租金' ";
String searchFld_tmp = "";
if( searchFld.equals("发票抬头") ) {
	searchFld_tmp = "invoice_name";
}else if( searchFld.equals("发票金额") ) {
...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
  <tr class="maintab">
   <td>
					&nbsp;按&nbsp;<select class="text" name="searchFld"><script>w(mSetOpt("<%= searchFld %>","|发票抬头|发票金额"));</script></select>
    ...
    <tr class="maintab">
      <td align="left" width="1%"><!--操作按钮开始-->
        <table border="0" cellspacing="0" cellpadding="0" >
			<tr class="maintab">
				<%if(right.CheckRight("fpgl_add",dqczy)>0){%><td><a href="#" accesskey="n" onClick="dataHander('add','fpgl_add_static.jsp',dataNav.itemselect);"><img   src="../../images/sbtn_new.gif" alt="新增(Alt+N)" align="absmiddle"></a></td><%}%>
