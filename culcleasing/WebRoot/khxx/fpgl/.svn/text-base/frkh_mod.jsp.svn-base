...
<td scope="row" nowrap>内部行业：</td>
    <td scope="row" nowrap class="text">
<select class="text" name="industry_type" Require="true" vlaue="<%=industry_type %>"></select>
...
<span class="biTian">*</span>
  ...
  <tr>
    ...
    <td scope="row" nowrap class="text"><input class="text" type="text"  name="lbxldata" readonly Require="ture" maxB="100" value="<%=lbxldata%>">
  ...
  <tr>
  <td scope="row" nowrap class="text">法人代表：</td>
    <td scope="row" nowrap class="text"><input class="text" name="legal_representative" type="text"  value="<%=legal_representative %>"></td>
  <td scope="row" nowrap class="text">法人代表身份证号：</td>
    <td scope="row" nowrap class="text"><input class="text" name="id_card_no" type="text" value="<%=id_card_no %>" Require="ture" dataType="IdCard">
		<span class="biTian">*</span>
	</td>
  ...
  <td scope="row" nowrap class="text">公司地址:</td>
    ...
    <td scope="row" nowrap class="text"><input class="text" name="post_code" type="text" value="<%=post_code %>" Require="ture" minB="6" maxB="6" dataType="Zip">
		<span class="biTian">*</span>
	</td>
  ...
  <td scope="row" nowrap class="text">手机：</td>
    <td scope="row" nowrap class="text"><input class="text" name="mobile_number" type="text"  value="<%=mobile_number %>" dataType="Mobile_T"></td>
  </tr>
  ...
  <tr>
   <td scope="row" nowrap class="text">组织机构代码：</td>
    <td scope="row" nowrap class="text"><input class="text" name="org_code" type="text"  value="<%=org_code %>" onclick="CheckOrgCode()" readonly>
		
	</td>
  <td >贷款证号码：</td>
    <td scope="row" nowrap class="text"><input class="text" name="loan_number" type="text"  value="<%=loan_number %>"></td>
  <td scope="row" nowrap class="text">经营范围(主营)：</td>
    <td scope="row" nowrap class="text"><input class="text" name="biz_scope_primary" type="text" value="<%=biz_scope_primary %>" >
		
	</td>
  </tr>
  
  <tr>
  <td scope="row" nowrap class="text">经营范围(兼营)：</td>
    <td scope="row" nowrap class="text"><input class="text" name="biz_scope_secondary" type="text"  value="<%=biz_scope_secondary %>"></td>
  ...
  <tr>
    ...
    %>
    		<input name="listed_corp_flag" type="radio" value="是" checked="checked">
    		是
						<input name="listed_corp_flag" type="radio" value="否">
													否
										</td>										
    <%
    }else{
    ...
    <td scope="row" nowrap class="text">进出口权标志：</td>
      ...
      if(imp_exp_flag.equals("是")){
       %>
													...
													<input name="imp_exp_flag" type="radio" value="是" checked="checked">
												是
													<input name="imp_exp_flag" type="radio" value="否">
												否
										</td>	
       <%
       }else{
   ...
   <td scope="row" nowrap class="text">备注：</td>
	<td colspan="5"><textarea class="text" name="memo" rows="5"  value="<%=memo%>" maxB="300"><%=memo %></textarea></td>
