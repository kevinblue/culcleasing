...
<tr class="maintab">
 ...
 <tr>
    <td scope="row">发票号</td>
    <td>
  <input name="invoice_number" id="invoice_number" type="text" size="10">
    </td>
	 <td scope="col">发票金额:</td>
    <td> 
    <input name="invoice_total" id="invoice_total" type="text"  readonly maxlength="10" size="10">
	</td>
	</tr>
	<tr>
    ...
    <td> 
    <input name="invoice_date" type="text"   readonly maxlength="10" dataType="Date" Require="true" size="10">
