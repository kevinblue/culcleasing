...
String invoice_method="";
	...
	invoice_total=getDBStr(rs1.getString("invoice_total"));
	    ...
	    invoice_method=getDBStr(rs1.getString("invoice_method"));
	}
...
<tr class="maintab">
 ...
 <%=formatNumberStr(rs1.getString("invoice_total"),"#,##0.00")%>
	...
	<td scope="row">发票类型:<%=invoice_method %></td>
	<td scope="row"> 备注：
	<%=memo %></td>
...
<table border="0" style="border-collapse:collapse;" align="center"
		...
		<th>租息</th>
						...
						String sqls = "select vi_invoice.*,isnull(hct.other_interest,0) other_interest from proj_invoice left join proj_invoice_detail on proj_invoice.id=proj_invoice_detail.proj_invoice_id left join vi_invoice on vi_invoice.contract_id=proj_invoice_detail.contract_id and vi_invoice.rent_list= proj_invoice_detail.rent_list  left join handling_charge_temp hct on vi_invoice.contract_id=hct.contract_id and vi_invoice.rent_list=hct.plan_list "+where_str+"  and  proj_invoice.id="+id+"";
