...
String sqlstr = "select * from proj_invoice_detail" + wherestr; 
System.out.println("&*"+sqlstr);
%>
<body onLoad="public_onload(0);">
<form action="kk.jsp" name="dataNav" onSubmit="return goPage()">
  <!--标题开始-->
...
%>
      ...
      <tr>
		...
		<td align="center"><%= getDBStr( rs.getString("proj_invoice_id") ) %></td>
		<td align="center"><%= getDBStr( rs.getString(("plan_id") )) %></td>
