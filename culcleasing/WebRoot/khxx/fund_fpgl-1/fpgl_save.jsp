...
sqlstr="insert into proj_invoice(invoice_number,invoice_name,invoice_total,invoice_date,creator,create_date,modificator,modify_date) values('"+invoice_number+"','"+invoice_name+"','"+invoice_total+"','"+invoice_date+"','"+dqczy+"','"+systemDate+"','"+dqczy+"','"+systemDate+"')";
