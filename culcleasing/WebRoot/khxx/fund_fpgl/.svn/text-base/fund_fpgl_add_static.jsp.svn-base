...
function invoice_submit(){
	...
	document.search.action="fund_fpgl_add.jsp";
...
<form name="search" method="post" action="fund_fpgl_add_static.jsp">
...
<BUTTON class="btn_2" name="btnSave" value="保存"  type="submit"  onclick="invoice_submit();" >
