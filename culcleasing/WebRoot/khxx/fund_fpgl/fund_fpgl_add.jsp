...
function isSub(obj) {
    ...
    for(i=0;i<names.length;i++){
	    if (names[i].checked){
				...
				if (flag_value>0) {
					//flag_fp++;
					alert("项目"+names[i].attributes["xmNum"].nodeValue+"没有发票号或票据日期!");
					return false;
				}
		}
	}
...
<tr><td width="100%">
 ...
 <tr>
  <td id="Form_tab_0" class="Form_tab" width=70 align=center onclick="chgTabN()"  valign="middle">票据信息</td>
