...
<%
   String id = getStr( request.getParameter("czid") );
	...
	db.close();
%>
<form name="form1" method="post" action="gzdj_mod.jsp" onSubmit="return Validator.Validate(this,3);">
...
<a href="gzdj_mod.jsp?czid=<%= id %>"  accesskey="m" title="修改(Alt+M)" class="fontcolor">
