...
<form name="form1" method="post" action="khdz_save.jsp">
...
<table border="0" cellspacing="0" cellpadding="0" width="100%" class="tab_table_title">
  <tr>
    <td width="16%" height="30" class="cwDDLabel">租赁系统用户ID</td>
    <td width="84%" height="30" class="cwDDValue"><%=getDBStr(rs.getString("cust_id"))%></td>
  </tr>
  <tr>
    <td height="30" class="cwDDLabel" scope="row">财务系统用户名</td>
    <td height="30" class="cwDDValue"><%=getDBStr(rs.getString("cust_name"))%></td>
  </tr>
  <tr>
    <td height="30" class="cwDDLabel" scope="row">财务系统用户名简称</td>
    <td height="30" class="cwDDValue"><%=getDBStr(rs.getString("short_name"))%></td>
  </tr>
  <tr>
    <td height="30" scope="row">财务系统用户名ID</td>
    <td height="30"><%=getDBStr(rs.getString("cust_num"))%></td>
  </tr>
  <tr>
