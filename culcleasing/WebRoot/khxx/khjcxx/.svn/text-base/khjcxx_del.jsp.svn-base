...
<img src="../../images/save.gif" align="absmiddle" border="0">删除</button>
...
<input type="hidden" value="del" name="savetype">
<table  border="0" cellspacing="0" cellpadding="0" width="98%" align="center" class="tab_table_title">
  <tr>
    <th scope="row">客户编号</th>
    <td><input name="cust_id" type="hidden" value="<%=cust_id %>" maxB="20" Require="true"><%=cust_id %></td>
