...
<table  border="0" cellspacing="0" cellpadding="0" width="98%" align="center" class="tab_table_title">
  <tr>
    ...
    <td><input name="czid" type="hidden" value="<%=cust_id %>" ><input name="cust_id" type="text" value="<%=cust_id %>" maxB="20" Require="true"  onblur="searchName(form1.cust_id.value,form1.cust_name.value,form1.short_name.value)"><span class="biTian">*</span></td>
    <th scope="row">客户名称</th>
    <td><input name="cust_name" type="text" value="<%=cust_name %>" maxB="100" Require="true"  onblur="searchName(form1.cust_id.value,form1.cust_name.value,form1.short_name.value)"><span class="biTian">*</span></td>
  </tr>
  <tr>
    <th scope="row">客户简称</th>
    <td><input name="short_name" type="text" value="<%=short_name %>" maxB="50" Require="true"  onblur="searchName(form1.cust_id.value,form1.cust_name.value,form1.short_name.value)"><span class="biTian">*</span></td>
    <th scope="row"></th>
    <td></td>
  </tr>
</table>
...
function searchName(varId,varName,varShort){
	...
	var url = "khjcxx_check.jsp?savetype=zz&cust_id="+varId+"&cust_name="+varName+"&short_name="+varShort+"&czid=<%=czid%>";
