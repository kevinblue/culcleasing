...
<td class="tree_title_txt"  height=26 valign="middle" align="left">客户信息管理 &gt; 删除客户类别大类</td>
</tr>
<tr>
...
<table border="0" cellspacing="0" cellpadding="0" width="100%" class="tab_table_title">
  <tr>
    <td width="22%" class="cwDDLabel">客户类别大类代码</td>
    <td width="78%" class="cwDDValue"><%=getDBStr(rs.getString("id"))%></td>
  </tr>
  <tr>
    <td class="cwDDLabel" scope="row">客户类别大类名称</td>
