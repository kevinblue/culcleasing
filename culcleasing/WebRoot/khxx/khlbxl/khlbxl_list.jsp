...
{
wherestr=wherestr+" and kh_lbxl.ssdl = '"+czid+"' "; 
}

if (request.getParameter("searchKey")!=null)
{
   
   wherestr=wherestr+" and kh_lbxl.lbxlmc like '%"+searchKey+"%' "; 
}
sqlstr = "select kh_lbxl.*,kh_lbdl.lbdlmc,base_user.name from kh_lbxl left join kh_lbdl on kh_lbxl.ssdl=kh_lbdl.id left join base_user on kh_lbxl.czy=base_user.id "+wherestr+"order by kh_lbxl.id asc"; 
...
int canedit=0;
if (right.CheckRight("khxx_khlbxl_list",dqczy)>0) canedit=1;
...
<table border="0" cellspacing="0" cellpadding="0" >    
    <tr class="maintab">
		<form name="searchbar" action="khlbxl_list.jsp">
		<td nowrap>客户类别小类：
		...
		<td><a href="#" accesskey="n" onClick="dataHander('add','khlbxl_add.jsp',dataNav.itemselect);"><img align="absmiddle"  src="../../images/sbtn_new.gif" alt="新增(Alt+N)" align="absmiddle"></a></td>
		<td><a href="#"  accesskey="m" onClick="dataHander('mod','khlbxl_mod.jsp?czid=',dataNav.itemselect);"><img src="../../images/sbtn_mod.gif" alt="修改(Alt+M)" width="19" height="19" align="absmiddle" ></a></td>
		<td><a href="#" accesskey="d" onClick="dataHander('del','khlbxl_del.jsp?czid=',dataNav.itemselect);"><img align="absmiddle" src="../../images/sbtn_del.gif" alt="删除(Alt+D)" align="absmiddle" ></a></td>
...
<form action="khlbxl_list.jsp" name="dataNav" onSubmit="return goPage()">
...
%>
      ...
      <tr onMouseOver="fn_changeTrColor()" onMouseOut="fn_changeTrColor()">
        ...
        <td align="center"><a href="khlbxl.jsp?czid=<%=getDBStr(rs.getString("id"))%>" target="_blank"><%=getDBStr(rs.getString("lbxlmc"))%></a></td>
