...
int canedit=0;
if (right.CheckRight("khxx_khmpxx_del",dqczy)>0) canedit=1;
...
<tr><td width="100%">
 ...
 <tr>
  <td id="Form_tab_0" class="Form_tab" width=70 align=center onClick="chgTabN()"  valign="middle">删除信息</td>
...
<%
	...
	String sqlstr = "select *,dengjiren=dbo.GETUSERNAME(creator),xiugairen=dbo.GETUSERNAME(modificator) from vi_cust_info where cust_id='" + czid + "'"; 
