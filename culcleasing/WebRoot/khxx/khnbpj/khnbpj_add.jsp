...
<table  border="0" cellspacing="0" cellpadding="0" width="98%" align="center" class="tab_table_title">
  ...
  <tr>
	...
	<td><input name="change_date" type="text" size="10" maxlength="50" maxB="50" dataType="Date" ><img  onClick="openCalendar(change_date);return false" style="cursor:pointer; " src="../../images/tbtn_overtime.gif" width="20" height="19" border="0" align="absmiddle"></td>
  
    <th>备注</th>
    <td><textarea name="memo" rows="4" maxB="200"></textarea></td>
  </tr>
</table>
...
<script language="javascript">
 dict_list("rank","withinRank","","name");
</script>
</body>
</html>
