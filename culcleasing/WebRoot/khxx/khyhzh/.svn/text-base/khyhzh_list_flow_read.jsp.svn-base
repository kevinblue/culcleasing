...
<form action="khyhzh_list_flow_read.jsp" name="dataNav" onSubmit="return goPage()">
...
//CustAccountOperationService.flowInitContractApproveAccountData(contract_id,cust_id,doc_id);
...
System.out.println("countsqlstr="+sqlstr);
