...
//select department, dept_name,id,name from v_base_user where role='项目经理' "+wherestr+" order by department,dept_name

//移交给新的项目经理
String sqlstr="select department, dept_name,id,name from v_base_user ";//name-name 
sqlstr+= " where id in ( select user_id from v_base_group where group_name='项目经理') "+wherestr;
sqlstr+= " order by department,dept_name";
