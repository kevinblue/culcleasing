...
if (stype.equals("yj")){        //移交操作
	...
	sqlstr="select department from vi_cust_t where id='"+yhid+"'";
	...
	sqlstr +="select cust_id,creator,creator_dept,'"+yhid+"','"+djbm+"','"+systemDate+"','"+yj_remark+"','"+dqczy+"','"+systemDate+"' from vi_cust_all_info_t where cust_id='"+czid+"'";
