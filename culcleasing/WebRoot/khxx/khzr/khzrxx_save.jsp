...
%>
		...
		<%
} else if("mod2".equals(stype)){
%>
	<script type="text/javascript">
	window.location.href = "khzrxx_flow_edit.jsp?custId=<%=cust_id%>";
	alert("<%=message%>成功!");
	</script>
<%
} else {%>
