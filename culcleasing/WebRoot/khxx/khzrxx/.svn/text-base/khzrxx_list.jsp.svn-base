...
int canedit=0;
if (right.CheckRight("khxx_khzrxx_list",dqczy)>0) canedit=1;
...
//String sqlstr = "select * from vi_cust_ewlp_info_main" + wherestr +" order by modify_date desc"; 
String sqlstr = "select *,dengjiren=dbo.GETUSERNAME(creator),xiugairen=dbo.GETUSERNAME(modificator) from vi_cust_ewlp_info_main" + wherestr+" order by create_date desc"; 
%>
<!--标题开始-->
<table border="0" width="100%" cellspacing="0" cellpadding="0" height="25">
			<tr class="tree_title_txt">
				<td nowrap width="100%" class="tree_title_txt" valign="middle" id="cwCellTopTitTxt">
				客户信息管理(非法人) &gt; 客户名片信息</td>
			</tr>
</table>
<!--标题结束-->
...
<table border="0" width="100%" id="table8" cellspacing="0" cellpadding="0" style="margin-top:2px;">
	 <form name="dataNav1" action="khzrxx_list.jsp">		
			<tr class="maintab">
...
<table border="0" cellspacing="0" cellpadding="0" >    
    <tr class="maintab">		
	<td><a href="#" accesskey="n" onClick="dataHander('add','khzrxx_add.jsp',dataNav.itemselect);"><img   src="../../images/sbtn_new.gif" alt="新增(Alt+N)" align="absmiddle"></a></td>
	<td><a href="#" accesskey="m" onClick="dataHander('mod','khzrxx_mod.jsp?czid=',dataNav.itemselect);"><img   src="../../images/sbtn_mod.gif" alt="修改(Alt+M)" align="absmiddle" ></a></td>
	<td><a href="#" accesskey="d" onClick="dataHander('del','khzrxx_del.jsp?czid=',dataNav.itemselect);"><img src="../../images/sbtn_del.gif" alt="删除(Alt+D)" align="absmiddle" ></a></td>
    </tr>
</table>
<!--操作按钮结束-->
</td>
...
%>
      ...
      <tr>
        ...
        <td align="left"><a href="khzrxx.jsp?czid=<%= getDBStr( rs.getString("cust_id") ) %>" target="_blank"><%= getDBStr(rs.getString("cust_id") ) %></a></td>
...
<td><%= getDBStr( rs.getString("county") ) %></td>
<td><%= getDBStr( rs.getString("certificate_no") ) %></td>
<td><%= getDBStr( rs.getString("home_phone") ) %></td>
