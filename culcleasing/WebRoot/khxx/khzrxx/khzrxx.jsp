...
<%
	...
	//String sqlstr = "select * from cust_ewlp_info where cust_id='" + czid + "'"; 
...
<table border="0" cellspacing="0" cellpadding="0">
 <tr>
  ...
  <td id="Form_s_tab_4" class="Form_tab" width=70 align=center onClick="chgTabSub()"  valign="middle">项目信息</td>
 </tr>
 </table>
...
<iframe style="funny:expression(autoResize())" id="UserBody4" frameborder="0" width="100%" src="../khxmxx/khxmxx_list.jsp?cust_id=<%=czid%>"></iframe>
</div>
</div>
