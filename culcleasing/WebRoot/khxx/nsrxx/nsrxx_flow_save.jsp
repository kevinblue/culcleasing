...
<BODY>
		<%
			...
			if(uid!=""){
				sqlstr="update base_taxPayer set tax_payer_no='"+tax_payer_no+"',is_dk='"+is_dk+"',tax_type_invoice='"+tax_type_invoice+"',address='"+address+"',tel='"+tel+"',bank_name='"+bank_name+"',bank_no='"+bank_no+"' where cust_id='"+cust_id+"' and id="+id;
...
window.location.href = "nsrxx_list_flow.jsp?proj_id=<%=proj_id%>";
alert("纳税人信息更新成功!");
this.close();
</script>
<%
...
<script type="text/javascript">
alert("纳税人信息更新失败!");
window.location.href = "nsrxx_flow_upd.jsp?cust_id=<%=cust_id%>";
</script>
<%}%>
</BODY>
</html>
