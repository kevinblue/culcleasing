...
<form action="projyhzh_list_flow.jsp" name="dataNav" onSubmit="return goPage()" method="post">
...
CustAccountOperationService.flowInitProjApproveAccountData(proj_id,cust_id,doc_id);
...
<table border="0" cellspacing="0" cellpadding="0" > 
    ...
    <tr class="maintab">
		<td><a href="#" accesskey="n" onClick="dataHander('add','projyhzh_add_flow.jsp?cust_id=<%=cust_id%>&proj_id=<%=proj_id %>&doc_id=<%=doc_id %>',dataNav.itemselect);"><img src="../../images/sbtn_new.gif" alt="新增(Alt+N)" width="19" height="19" align="absmiddle"></a></td>
		<td><a href="#" accesskey="m" onClick="dataHander('mod','projyhzh_mod_flow.jsp?cust_id=<%=cust_id%>&proj_id=<%=proj_id %>&doc_id=<%=doc_id %>&czid=',dataNav.itemselect);"><img src="../../images/sbtn_mod.gif" alt="修改(Alt+M)" width="19" height="19" align="absmiddle" ></a></td>
		<td><a href="#" accesskey="d" onClick="dataHander('del','projyhzh_del_flow.jsp?czid=',dataNav.itemselect);"><img src="../../images/sbtn_del.gif" alt="删除(Alt+D)" width="19" height="19" align="absmiddle" ></a></td>
    </tr>
