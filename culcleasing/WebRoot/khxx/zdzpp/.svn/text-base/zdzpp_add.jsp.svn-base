...
<title>客户名片信息 - 新增总对总客户下属品牌</title>
...
<table border="0" cellspacing="0" cellpadding="0" width="98%" align="center" class="tab_table_title">
  <tr>
    ...
    <td>品牌名称</td>
    <td><input name="brand_name" type="text" size="40" maxB="25" Require="true"><span class="biTian">*</span></td>
  </tr>
  <tr>
    <td>产品类型</td>
    <td><textarea name="brand_type" rows="4" maxB="100"></textarea>
	<span class="biTian">*</span></td>

    <td>产品特性</td>
    <td><textarea name="brand_attribute" rows="4" maxB="100"></textarea></td>
  </tr>
</table>
</div>
