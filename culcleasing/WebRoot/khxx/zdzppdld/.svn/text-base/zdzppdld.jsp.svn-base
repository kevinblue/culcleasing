...
<title>总对总客户品牌下属代理商明细 - 客户信息管理</title>
...
<%
	...
	String sqlstr = "select cust_brand_sale.brand_id,cust_brand_sale.sale_id,vi_cust_all_info.cust_name as sale_name,cust_brand.brand_name from cust_brand_sale left join cust_brand on cust_brand_sale.brand_id=cust_brand.brand_id left join vi_cust_all_info on cust_brand_sale.sale_id=vi_cust_all_info.cust_id where id=" + czid ; 
...
<form name="form1" method="post" action="zdzppdld_save.jsp" onSubmit="return checkdata(this);">	
<div id=bgDiv>
...
<table border="0" cellspacing="0" cellpadding="0" height="30">
	  <tr>
		<td><a href="zdzppdld_mod.jsp?czid=<%= czid %>"  accesskey="m" title="修改(Alt+M)" class="fontcolor">
...
<table border="0" cellspacing="0" cellpadding="0" width="98%" align="center" class="tab_table_title">
  <tr>
    <td scope="row" nowrap width="20%">品牌名称：</td>
    <td><%=brand_name %></td>

    <td scope="row" nowrap width="20%">代理商名称：</td>
    <td><%=sale_name %></td>
  </tr>
