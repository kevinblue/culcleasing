...
String expsqlstr = "select raiser as '提出人' "
		+" , dutier as '责任落实人' ,raiser_date as '提出时间',plan_date as '预计落实时间' "
		+" ,  idea as '意见' ,operation_dept as '执行部门' ,flow as '流程' "
		+" , CASE status WHEN 0 THEN '否' ELSE '是' END as '是否完成' "
		+" , CASE status WHEN 0 THEN '未执行' WHEN 1 THEN '已确认' WHEN 2 THEN '未确认' END as '执行状态' " 
		+" , result as '执行结果', remark as '结果意见'  ,end_time as '完成时间' " 
		+" , check_man as '确认人',dbo.GETUSERNAME(creator) as '登记人' "
		+" , create_date as '登记时间'  "
		+" from vi_opinion_execution where proj_id='"+proj_id+"'order by id";
...
<table border="0" width="100%" id="table8" cellspacing="0" cellpadding="0" style="margin-top:2px;">
    <tr class="maintab">
		...
		<input name="excel_name" type="hidden" value="opinion_details">
		<BUTTON class="btn_2"  type="button" onclick="return validata_data_report('../../func/exp_report.jsp','opinion_details.jsp');">
