...
%>
<select name="datalist" size="15" ondblclick="ListSelect('form1.check_man','form1.id');" style="height:100%">
...
<tr>
    <td align="center">
    <input  class="btn3_mouseout" type="button" value="确定" onClick="ListSelect('form1.check_man','form1.id');">  
