...
%>
<select name="datalist" size="15" ondblclick="ListSelect('form1.dutier','form1.id','form1.operation_dept','form1.dept_id');" style="height:100%">
...
<tr>
    <td align="center">
    <input  class="btn3_mouseout" type="button" value="确定" onClick="ListSelect('form1.dutier','form1.id','form1.operation_dept','form1.dept_id');">  
