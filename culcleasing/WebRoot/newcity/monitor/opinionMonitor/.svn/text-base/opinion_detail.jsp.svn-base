...
//模拟proj_id
if("".equals(proj_id)){
	proj_id = "CULCTEST000222";
}

sqlstr = "select project_name,opinion_amount from vi_proj_opinion_state where proj_id='"+proj_id+"'";
String proj_name="";
String opinion_amount="0";
...
%>
	<tr>
	    ...
	    <td align="center">
	    <%
	   // System.out.println("jjjjjjjj"+getDBStr(rs.getString("prower_man")));
	    //判断当前登陆人与意见创建人一致
	    ...
	    <a href='Javascript: updItem(<%=getDBStr(rs.getString("id"))%>)'>修改</a> 
			...
			<%}
	    		...
	    		%>&nbsp;|&nbsp;<a href="opinion_suc_t.jsp?item_id=<%=getDBStr( rs.getString("id"))%>" target="_blank">意见完成</a>
	    		<% }
...
<div id="TD_tab_1" style="display:none;"> 
	<form name="form1" method="post" action="opinion_saves.jsp" onSubmit="return Validator.Validate(this,3);">
	...
	<table border="0" cellspacing="0" cellpadding="0" width="100%" class="tab_table_title">
	  <tr>
		...
		<td scope="row">提出人</td>
	    <td scope="row">
	<input style="width:150px;" name="raiser" id="raiser" type="text" readonly="readonly" style="width: 100">
	<input name="id" type="hidden">
	<img src="../../images/fdmo_65.gif" alt="选" width="19" height="19" align="absmiddle"  
	style="cursor:pointer" onclick="popUpWindow('base_user.jsp',250,350)" >  
	  ...
	  <tr>
	    ...
	    <td scope="row">
		<input style="width:150px;" name="dutier" id="dutier" type="text" readonly="readonly" style="width: 100">
		<input name="id" type="hidden">
		<img src="../../images/fdmo_65.gif" alt="选" width="19" height="19" align="absmiddle"  
   ...
   %>
	...
	<td>意见核实人员</td>
	<td scope="row">
		<input style="width:150px;" name="check_man" id="check_man" type="text" readonly="readonly" style="width: 100">
		<input name="id" type="hidden">
		<img src="../../images/fdmo_65.gif" alt="选" width="19" height="19" align="absmiddle"  
