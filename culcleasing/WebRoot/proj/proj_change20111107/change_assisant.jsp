...
<%
String sqlstr="select group_id,user_id,user_name,group_name from v_base_user_group where group_name='项目助理' "+wherestr+" order by user_id";//name-name 
ResultSet rs = null;
rs=db.executeQuery(sqlstr); 
%>
<select name="datalist" size="15" ondblclick="ListSelect('list.proj_assisant_name','list.proj_assisant_id');" style="height:80%">
...
<tr>
    <td align="center">
    <input  class="btn3_mouseout" type="button" value="确定" onClick="ListSelect('list.proj_assisant_name','list.proj_assisant_id');">  
