...
System.out.println("长度======="+uploadFileName.length());
...
System.out.println("名称======="+uploadFileName);
System.out.println("Period_type======="+conditionBean.getPeriod_type());
...
System.out.println("文件名uploadFileName======="+conditionBean.getSettle_method());
