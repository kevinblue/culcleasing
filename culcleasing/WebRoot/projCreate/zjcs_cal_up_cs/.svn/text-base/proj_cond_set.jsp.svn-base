	...
	<div id="TD_tab_0">
		<table  border="0" cellspacing="0" cellpadding="0" width="100%" height=100%" align="center" class="tab_table_title">
		  ...
		  <tr>
			...
			<input type=text name="equip_amt" id="equip_amt" size=20 value="" 
		   ...
		   <td  scope="row" nowrap>租赁年利率</td>
			<td nowrap="nowrap">
				<input name="year_rate" id="year_rate" type="text" value="0.00"  
					dataType="Rate" size="13" maxlength="11" maxB="11"  Require="true"/>%
				<span class="biTian">*</span>
			</td>
	    ...
	    <tr>
			...
			<td>
				...
				<script language="javascript" class="text">
					dict_list("insure_pay_type","root.insurPayType","root.insurPayType.004","name");
				</script>
   				<span class="biTian">*</span>
			</td>
	    </tr>
