...
$(document).ready(function(){
	...
	//$("#equip_amtt").val("<%=conditionBean.getEquip_amt() %>");
	//首付款 first_payment
	...
	<div id="TD_tab_0">
		<table  border="0" cellspacing="0" cellpadding="0" width="100%" height=100%" align="center" class="tab_table_title">
		  ...
		  <tr>
		    ...
		    <input type=text name="equip_amtt" id="equip_amtt" size=20 value=""  onfocus="huifu('equip_amtt','equip_amt')" 
					onblur="checkDataInvalid('<%=proj_money %>','0'),document.form1.equip_amtt.value=commaSplit(document.form1.equip_amtt.value,'equip_amt');" />
			<input type="hidden" name="equip_amt" id="equip_amt" dataType="Money" value="" />
		       	 <span class="biTian">*</span>
		     </td>
