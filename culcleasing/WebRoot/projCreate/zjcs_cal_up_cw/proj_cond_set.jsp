...
function fun(){
	...
	alert(location.href.lastIndexOf("?opendocument"));
}
</script>
	...
	<div id="TD_tab_0">
		<table  border="0" cellspacing="0" cellpadding="0" width="100%" height=100%" align="center" class="tab_table_title">
		  ...
		  <tr>
		    ...
		    <td>
		    	<input name="equip_amt" id="equip_amt" type="text" style="background-color:#F4F4F4;color:#808080;"
		  ...
		  <tr>
		   ...
		   <td scope="row" nowrap>租赁本金</td>
		     <td>
		    	<input name="lease_money" id="lease_money" value="<%=proj_money %>" class="readonlyShow"
		    	type="text" Require="true" dataType="Money" size="13" maxlength="100" maxB="100" 
		    	Require="true"/>
		    	<span class="biTian">*</span>
			 </td>
		   ...
		   <tr>
		    ...
		    <td>
		    	<input name="before_interest" id="before_interest" type="text" value="0"  onchange="changeTwoData()"
		    		dataType="Money" size="13" maxlength="20" maxB="20"  Require="true" readonly="readonly" />
		    		是否算本
		    		<input type="text" name="before_interest_type" value="" readonly="readonly" size="5">
		    		<!-- sys 财务不可选
		  ...
		  <tr>
		    ...
		    <td >
		    <!-- sys 付租方式 begin-->
		    	<input type="hidden"  name="income_number_year" style="width: 100px;" readonly="readonly">
		    	<select id="income_number_year" style="width: 100px;" disabled="disabled">
					<script type="text/javascript">
