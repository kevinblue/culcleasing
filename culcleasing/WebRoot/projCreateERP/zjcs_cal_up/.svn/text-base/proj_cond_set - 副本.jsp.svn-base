	...
	<div id="TD_tab_0">
		<table  border="0" cellspacing="0" cellpadding="0" width="100%" height=100%" align="center" class="tab_table_title">
			...
			<tr>
				...
				<img src="../../images/save.gif" align="absmiddle" border="0">租金测算&nbsp;<b style="color:red;">请及时更新</b></button>
				<%-- 
				&nbsp;&nbsp;&nbsp;
		  ...
		  <tr>
			...
			<td scope="row" nowrap>是否批量调息</td>
	   		...
	   		<td id="bj_1"></td>
	   		<td id="bj_2" style="display: none;"><input name="ratio_param" type="text" dataType="Double" value="0.00" size="13" maxlength="10" maxB="10"></td>
		</tr>
