...
System.out.print("sssssssssssshhhhh"+sqlstr);
/* 
名称	收支情况
1-设备金额	支  equip_amt
...
db.executeUpdate(sqlstr);
LogWriter.logDebug(request, "删除资金计划付款前提|资金计划完成");
...
if(!"".equals(first_payment) && first_payment!=null && !"0".equals(first_payment)  && !"0.00".equals(first_payment)){
