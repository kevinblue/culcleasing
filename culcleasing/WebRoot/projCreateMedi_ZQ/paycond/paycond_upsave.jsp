...
sqlstr+= " where proj_Id='"+proj_id+"' and measure_id='"+doc_id+"' and fee_type='"+fee_type+"' and id<>'"+item_id+"' ";
rs = db.executeQuery(sqlstr);
if(rs.next()){
...
}else if("30".equals(fee_type)){//退款保证金
	fee_type_name = "退款保证金";
	cond_plan_money = caution_money;
}else{
	fee_type_name = "资金款项";
...
if(outFlag==0){//没有超出则插入数据库
	...
	sqlstr = "update proj_fund_fund_charge_plan_temp set fee_name='"+fee_name+"',pay_obj='"+pay_obj+"',plan_date='"+plan_date+"',curr_plan_money='"+plan_money+"',plan_money='"+plan_money+"',currency='"+currency+"',pay_bank_name='"+pay_bank_name+"',pay_bank_no='"+pay_bank_no+"',";
