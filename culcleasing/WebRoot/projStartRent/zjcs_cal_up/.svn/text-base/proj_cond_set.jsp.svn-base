...
function changeCalcWay(){
	...
	if( settle_methodVal=="RentCalcType8" || settle_methodVal=="RentCalcType9" 
		|| settle_methodVal=="RentCalcType10"){
		$("#uplLoadBt").css("display","inline");
	}else{
		$("#uplLoadBt").css("display","none");
	}
}
...
if( beginInfoBean!=null ){
	//System.out.println("aaaaaaaaaaaaaaaaaaaa"+=beginInfoBean.getLease_money());
%>
...
$(document).ready(function(){
	...
	$("input[name='rate_float_amt']").val(parseFloat("<%=Double.parseDouble(beginInfoBean.getRate_float_amt()) %>"));
		...
		<table  border="0" cellspacing="0" cellpadding="0" width="100%" height="80%" align="center" class="tab_table_title">
			<tr height="40" style="font-weight: bold;">
				<%
					...
					if("0".equals(leftLeaseMoney)){
						leftLeaseMoney = "888888888888888";
					}
				%>
			...
			<tr>
		        ...
		        &nbsp;&nbsp;|
				<BUTTON class="btn_2" id="uplLoadBt"  onClick="dataHander('add_modal','cond_upload.jsp?contract_id=<%=contract_id %>&begin_id=<%=begin_id %>&doc_id=<%=doc_id %>&flowSysDate=<%=flow_date %>');">
				<img src="../../images/fdmo_23.gif" align="absmiddle" border="0">上传</button>
				&nbsp;&nbsp;|
				<BUTTON class="btn_2" onClick="submitForm()">
				<img src="../../images/save.gif" align="absmiddle" border="0">数据更新</button>
		  ...
		  <tr>
		    ...
		    <td>
		    	<input name="contract_id" style="width: 150" id="contract_id" type="text" value="<%=contract_id%>" size="25" maxlength="50"/>
		  ...
		  <tr>
		    ...
		    <td>
		    	<input name="assets_value" id="assets_value" style="width: 100" type="text" value="0" dataType="Money" size="13" maxlength="10" maxB="10" />
			</td>
		  	<td  scope="row" nowrap>租赁年利率</td>
			<td nowrap="nowrap">
				<input name="year_rate" id="year_rate" type="text" value="0.00"  
					dataType="Double" size="13" maxlength="11" maxB="11"  Require="true" style="width: 100"/>%
				<span class="biTian">*</span>
			</td>  
			...
			<td>
				<input name="fact_irr" id="fact_irr" type="text" value="0" size="13" maxlength="10" style="width: 100" readonly="readonly"/>
			</td>
		  </tr>
		  ...
		  <tr>
			...
			<td>
				<input name="plan_irr" id="plan_irr" type="text" value="0" size="13" maxlength="10" readonly="readonly" style="width: 100"/>
			</td>
		  </tr>
		  ...
		  <tr>
		    ...
		    <td>
		    	<input name="lease_term" id="lease_term" type="text" value="0"  onClick="changLeaseT_value()" 
		    		dataType="Integer" size="13" maxlength="10" maxB="10"  Require="true" readonly style="width: 100"/>
		    	<span class="biTian">*</span>
			</td>
		  ...
		  <tr>
		    ...
		    <td scope="row">
		    <input style="width:150px;" name="plan_bank_no" id="plan_bank_no" Require="true" label="计划收款银行账号" type="text" readonly="readonly" style="width: 100">
		    <span class="biTian">*</span>
		    ...
		    <td scope="row">
		    <input style="width:150px;" name="plan_bank_name" id="plan_bank_name" Require="true" label="计划收款开户银行" type="text" readonly="readonly" style="width: 100">
			<span class="biTian">*</span>
		    </td>
		  	<td  scope="row" nowrap>利率对外公开</td>
			<td>
				<input type="radio" name="is_open" value="是" Require="true">是 &nbsp;
		  ...
		  <tr>
		    ...
		    <td>
		    	<select name="rate_float_type" onchange="changeOne()" style="width:150px;">
		        <script type="text/javascript">
			...
			<select style="width:140px;" name="invoice_type" id="invoice_type" Require="true" label="租金开票方式">
				...
				<!--
				<select  name="invoice_type" id="invoice_type" Require="true" label="租金开票方式" style="width:130px;" ></select>
				<script language="javascript">
		  ...
		  <td>
		    	<select name="adjust_style" style="width:150px;">
			        <script type="text/javascript">
		    ...
		    <td>
		        <input type="radio" name="factoring" value="是" checked="checked" Require="true">是
...
function alertChange(){
	...
	var rate_float_amt =  $("#rate_float_amt").val();//利率调整值
	...
	//var rate_float_type = $("#rate_float_type").val();
	...
	if(rate_float_amt == '' || rate_float_amt == null){
		...
		if(rate_float_type == '0'){//2010-11-23需求修改
			name = "按央行利率浮动比率";
			$("#div_rate").html ( "<font color='red'>按央行利率浮动比率调整为：央行调整值×(1+"+rate_float_amt+")+旧利率</font>" );
		}
		if(rate_float_type == '1'){
			name = "按央行利率加点";
			$("#div_rate").html ( "<font color='red'>按央行利率加点调整为：(央行基础利率+幅度)</font>" );
		}
		if(rate_float_type == '2'){
			name = "隐含利率";
			$("#div_rate").html ( "<font color='red'>隐含利率调整为: 1+央行调整值/上次利率值*"+rate_float_amt+"</font>" );
		}
		if(rate_float_type == '3'){
			name = "固定不变";
			$("#div_rate").html (  "<font color='red'>固定不变: "+($(":input[name='year_rate']").val())+"</font>" );
		}
		if(rate_float_type == '4'){
			name = "隐含加点";
			$("#div_rate").html ( "<font color='red'>隐含加点: (央行基础利率+幅度)</font>" );
		}
	}
}
/**
