...
<%
	...
	sqlstr +=" from fund_begin_plan_mark_temp where begin_id='"+begin_id+"' and doc_id='"+doc_id+"' order by plan_date"; 
	LogWriter.logDebug(request, "起租 - 合同现金流 -- sqlstr查询sql语句==>> "+sqlstr);
