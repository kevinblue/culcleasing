...
$(document).ready(function(){
	...
	//财务对开票方式、实际Irr允许编辑
	$("input[name='begin_id']").removeAttr("disabled");
	$("input[name='doc_id']").removeAttr("disabled");

	$("input[name='fact_irr']").removeAttr("disabled");
	$("select[name='invoice_type']").removeAttr("disabled");
	
	$("#btsm").removeAttr("disabled");
});
/**
 * 租金测算方法改变
 */
...
<%
	...
	BeginInfoBean beginInfoBean = BeginService.initBeginInfoBean(begin_id, doc_id);
%> 
	...
	<div id="TD_tab_0">
		<table  border="0" cellspacing="0" cellpadding="0" width="100%" height="80%" align="center" class="tab_table_title">
			...
			<tr>
		        ...
		        &nbsp;&nbsp;|
				<BUTTON class="btn_2" id="btsm" onClick="form1.submit()">
		  ...
		  <tr>
			...
			<td>
				...
				<img style="cursor:pointer;"  src="../../images/fdmo_63.gif" width="20" height="19" border="0" align="absmiddle">
				<span class="biTian">*</span>
			</td>
		  ...
		  <tr>
			...
			<td>
				<input name="fact_irr" type="text" value="0" size="13" maxlength="10"/>
			</td> 
		</tr>
