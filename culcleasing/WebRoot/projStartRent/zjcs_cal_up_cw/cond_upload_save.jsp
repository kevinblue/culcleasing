...
<script type="text/javascript">
	window.open("http://domino.culc.com/eleasing/PMAgent.nsf/CreateQZNotice2?openagent&fileno=111&contractid=<%=contract_id %>&docid=<%=doc_id %>&beginid=<%=begin_id %>","","status=no,scrollbars=no,location=no,menubar=yes,resizable=yes");
