	...
	for(int j=0;j<saObjectFile.length;j++){
	   if(saObjectFile[j]!=null&&!saObjectFile[j].equals("")){
		  ...
		  System.out.println("aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa");
		   System.out.println("aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa"+execlBean.isFlag());
		  if(execlBean.isFlag()){
				...
				**/
				...
				System.out.println("7777777777777777777777777777777777777777777777777"+conditionBean.getLease_term());
				conditionBean.setEnd_date(obj[11+Integer.parseInt(conditionBean.getIncome_number())][0]);//结束日期
				System.out.println("7777777777777777777777777777777777777777777777777"+conditionBean.getEnd_date());
