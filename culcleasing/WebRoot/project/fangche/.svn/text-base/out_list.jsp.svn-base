...
<table border="0" cellspacing="0" cellpadding="0" >    
    <tr class="maintab">
    	<td align="left" width="25%">
					 &nbsp;按&nbsp;<select name="searchFld"><script>w(mSetOpt("<%= searchFld %>","|合同编号|客户名称","|info.contract_id|dbo.getcustname(info.cust_id)"));</script></select>&nbsp;查询
...
<table border="0" cellspacing="0" cellpadding="0" >    
    <tr class="maintab">
		<td><a href="#" accesskey="n" onClick="dataHander('mod','out_add.jsp?czid=',dataNav.itemselect);"><img  src="../../images/sbtn_mod.gif" alt="保存(Alt+N)" align="absmiddle"></a></td>
    </tr>
</table>
<!--操作按钮结束-->
</td>
...
%>
      ...
      <tr>
        ...
        <td align="left"><a href=out.jsp?czid=<%= getDBStr( rs.getString("contract_id") ) %> target="_blank"><%= getDBStr(rs.getString("contract_id") ) %></a></td>
        ...
        <td><%= getDBStr( rs.getString("out_people") ) %></td>
      </tr>
<%
		rs.next();
		i++;
