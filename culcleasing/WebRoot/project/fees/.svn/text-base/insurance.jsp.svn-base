...
<table border="0" cellspacing="0" cellpadding="0" height="30">
	  <tr>
		<td><a href="insurance_update.jsp?czid=<%= czid %>"  accesskey="m" title="修改(Alt+M)" class="fontcolor">
...
<table border="0" cellspacing="0" cellpadding="0" width="98%" align="center" class="tab_table_title">
 <tr>
	...
	if("1".equals(fees_way)){
		fees_way_show="非平安保险计算方法";
	}else if("2".equals(fees_way)){
		fees_way_show="平安保险计算方法";
	}else if("3".equals(fees_way)){
		fees_way_show="平安保险计算方法(送首年保费)";
	}
	%>
	<%= fees_way_show %></td>
     </tr>
