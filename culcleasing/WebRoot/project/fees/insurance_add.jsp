...
int canedit=0;
if (right.CheckRight("insurance-fees-add",dqczy)>0) canedit=1;
...
<table border="0" cellspacing="0" cellpadding="0" width="98%" align="center" class="tab_table_title">
  <tr>
    <td>保险公司</td>
    <td><select name="insurer" width="80px" Require="true">
    	<script language="javascript">
			dict_list("insurer","insurance","","name");
		</script>	
    </select>
    ...
    <td><select name="fees_way" width="80px" Require="true">
            ...
            <option value="1">非平安保险计算方法</option>
    		<option value="2">平安保险计算方法</option>
          	<option value="3">平安保险计算方法(送首年保费)</option>
    </select>
    <span class="biTian">*</span></td>
     </tr>
    <tr>
	<td>险种</td>
    <td colspan="3"><textarea name="insurance_type" cols="20" rows="5" maxb="100" style="width:536px"></textarea></td>
    <td>备注</td>
    <td colspan="3"><textarea name="note" cols="20" rows="5" maxb="100" style="width:536px"></textarea></td>
  </tr>
</table>
</div>
