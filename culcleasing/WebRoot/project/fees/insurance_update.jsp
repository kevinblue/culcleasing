...
int canedit=0;
if (right.CheckRight("insurance-fees-mod",dqczy)>0) canedit=1;
...
<table border="0" cellspacing="0" cellpadding="0" width="98%" align="center" class="tab_table_title">
  <tr>
    <td>保险公司</td>
    <td><input name="insurer1" type="text" value="<%= insurer1 %>" size="20" maxB="50" readonly ></td>
    <td>计算方法</td>
    ...
    <tr> 
	<td>险种</td>
    <td colspan="3"><textarea name="insurance_type" cols="20" rows="5" maxb="100" style="width:536px"><%= insurance_type%></textarea></td>
    <td>备注</td>
