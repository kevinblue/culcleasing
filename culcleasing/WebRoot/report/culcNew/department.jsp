...
<td class="tree_title_txt"   valign="middle" align="center">选择部门</td>
</tr>
...
<table id="" border="0" cellspacing="0" cellpadding="0" style="float:left " >
      <tr>
        <td nowrap>部门: <input type="text" name="fv"  value="<%=filtervalue%>" style="width:90px">
...
<%
String sqlstr=" select distinct dept_name from base_department where is_select is null  and superior_dept  = 'root'  "+wherestr+" order by dept_name";//name-name 
ResultSet rs = null;
...
<tr>
    <td align="center">
    <input  class="btn3_mouseout" type="button" value="确定" onClick="ListSelect('parent_deptname','parent_deptname');">  
