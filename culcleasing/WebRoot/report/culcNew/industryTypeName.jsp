...
<td class="tree_title_txt"   valign="middle" align="center">选择行业</td>
</tr>
...
%>
<form name="searchbar" action="industryTypeName.jsp">
<table id="" border="0" cellspacing="0" cellpadding="0" style="float:left " >
      <tr>
        <td nowrap>行业: <input type="text" name="fv"  value="<%=filtervalue%>" style="width:90px">
...
<%
String sqlstr="select trade   from base_trade where 1= 1 "+wherestr+" order by trade";//name-name 
ResultSet rs = null;
