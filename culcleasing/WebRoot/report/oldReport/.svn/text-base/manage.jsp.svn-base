...
%>
<select name="datalist" size="15" ondblclick="ListSelect('manage_name','manage_name');" style="height:100%">
...
<tr>
    <td align="center">
    <input  class="btn3_mouseout" type="button" value="确定" onClick="ListSelect('manage_name','manage_name');">  
