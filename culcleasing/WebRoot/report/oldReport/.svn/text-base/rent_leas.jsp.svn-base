...
<td class="tree_title_txt"   valign="middle" align="center">选择业务板块</td>
</tr>
...
%>
<form name="searchbar" action="rent_leas.jsp">
...
<%
String sqlstr="select distinct title from ifelc_conf_dictionary where 1=1 and parentid='lease_type' "+wherestr+" order by title";//name-name 
ResultSet rs = null;
rs=db.executeQuery(sqlstr); 

%>
<select name="datalist" size="15" ondblclick="ListSelect('leas_type','leas_type');" style="height:100%">
...
<tr>
    <td align="center">
    <input  class="btn3_mouseout" type="button" value="确定" onClick="ListSelect('leas_type','leas_type');">  
