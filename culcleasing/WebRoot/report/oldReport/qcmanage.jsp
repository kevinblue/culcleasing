...
<td class="tree_title_txt"   valign="middle" align="center">选择质控经理</td>
</tr>
...
%>
<form name="searchbar" action="qcmanage.jsp">
<table id="" border="0" cellspacing="0" cellpadding="0" style="float:left " >
      <tr>
        <td nowrap>质控经理: <input type="text" name="fv"  value="<%=filtervalue%>" style="width:90px">
...
%>
<select name="datalist" size="15" ondblclick="ListSelect('qcmanage_name','qcmanage_name');" style="height:100%">
...
<tr>
    <td align="center">
    <input  class="btn3_mouseout" type="button" value="确定" onClick="ListSelect('qcmanage_name','qcmanage_name');">  
