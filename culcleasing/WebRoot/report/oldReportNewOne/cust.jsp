...
<td class="tree_title_txt"   valign="middle" align="center">选择客户</td>
</tr>
...
%>
<form name="searchbar" action="cust.jsp">
...
<%
String sqlstr="select distinct cust_name from cust_info where 1=1  "+wherestr+" order by cust_name";//name-name 
ResultSet rs = null;
rs=db.executeQuery(sqlstr); 

%>
<select name="datalist" size="15" ondblclick="ListSelect('cust_name','cust_name');" style="height:100%">
<option returnlist=""></option>
<%
while (rs.next())
{
%>
	<option value="<%=getDBStr(rs.getString("cust_name"))%>" returnlist="<%=getDBStr(rs.getString("cust_name"))%>">
	<%=getDBStr(rs.getString("cust_name"))%>
	</option>
<%} %>
</select>
</div>
...
<tr>
    <td align="center">
    <input  class="btn3_mouseout" type="button" value="确定" onClick="ListSelect('cust_name','cust_name');">  
