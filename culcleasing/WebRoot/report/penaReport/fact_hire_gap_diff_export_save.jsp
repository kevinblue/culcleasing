...
<%@page import="com.tenwa.culc.util.reportExp.FactHireGapDiffExport"%>
...
<%
	...
	FactHireGapDiffExport t= new FactHireGapDiffExport();
	response.reset();
	response.setContentType("application/x-msexcel;charset=gbk");
	response.setHeader("Content-disposition",
	"attachment; filename=fact_hire_gap_diff.xlsx");
