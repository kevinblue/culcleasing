...
%> 
<%
if( conditionBean!=null && conditionBean.getEquip_amt()!=null ){
%>
...
<tr valign="top">
	...
	<!-- 隐藏域传值  -->
	<div id="divH" class="tabBody" style="background:#ffffff;width:100%;height:430px;">
	<div id="TD_tab_0">
		...
		<table  border="0" cellspacing="0" cellpadding="0" width="100%" height=100%" align="center" class="tab_table_title">
			...
			<tr>
				...
				<input type="hidden" name="settle_method">
				 <select style="width:130px;" name="settle_method2" id="settle_method" disabled="disabled">
					<script type="text/javascript">
						w(mSetOpt('',
				...
				<div id="bj_2" style="display: none;float: left;margin-left: 24px;">
		   			<input name="ratio_param" type="text" dataType="Double" value="0.00" size="13" maxlength="10" maxB="10" readonly="readonly">
				</div>
		  ...
		  <tr>
		    ...
		    <td>
		    	<input name="equip_amt" id="equip_amt" type="text" 
		    		readonly value="<%=proj_money %>" onchange="changeFirst_payment()" onblur="checkDataInvalid('<%=proj_money %>','0')"
		    		disabled="disabled" dataType="Money" size="13" maxlength="50" maxB="50"  Require="true" readonly="readonly"/>
		       	<span class="biTian">*</span>
		     </td>
		      <td scope="row" nowrap>首付款</td>
		      <td>
		    	<input name="first_payment" id="first_payment" type="text" value="0" 
		    	disabled="disabled" onchange="changeFirst_payment()" dataType="Money" size="13" maxlength="50" 
		    	maxB="50"  Require="true" readonly="readonly"/>
		    	<span class="biTian">*</span>
		   	   </td> 
		   ...
		   <td scope="row" nowrap>租赁本金</td>
		     <td>
		    	<input name="lease_money" id="lease_money" value="<%=proj_money %>"
		    	 disabled="disabled" readonly="readonly" type="text" Require="true" dataType="Money" size="13" maxlength="100" maxB="100" 
		    	Require="true"/>
		    	<span class="biTian">*</span>
			 </td>
			...
			<td>
				<input name="caution_money" id="caution_money" value="0" 
				 disabled="disabled" readonly="readonly"	dataType="Money" size="13" maxlength="20" maxB="20"  Require="true" 
					onchange="assignment()" type="text" readonly="readonly"/>
				<span class="biTian">*</span>
			</td>
			<td  scope="row" nowrap>租赁手续费</td>
			<td>
				<input name="handling_charge" id="handling_charge" type="text" value="0" 
				 	 readonly="readonly"  disabled="disabled" dataType="Money" size="13" maxlength="20" 
				 	maxB="20"  Require="true" onchange="assignment()" readonly="readonly"/>
				<span class="biTian">*</span>
			</td>
			<td scope="row" nowrap>管理费</td>
		    <td colspan="">
		    	<input name="management_fee" id="management_fee" type="text" value="0"  
		    	disabled="disabled" readonly="readonly"	dataType="Money" size="13" maxlength="20" maxB="20"  Require="true" onchange="" readonly="readonly"/> 
				<span class="biTian">*</span>
			</td>
		  </tr>
		  ...
		  <tr>
			<td scope="row" nowrap>咨询费收入</td>
		  	<td>
		  		<input name="consulting_fee_in" id="consulting_fee_in" type="text" value="0"  
					disabled="disabled" dataType="Money" size="13" maxlength="20" maxB="20"  Require="true" onchange="assignment()" readonly="readonly"/>
				<span class="biTian">*</span>
			</td>
			...
			<td>
				<input name="other_income" id="other_income" type="text" value="0" dataType="Money"
					disabled="disabled"  size="13" maxlength="20" onchange="assignment()" readonly="readonly" />
			</td>
			<td scope="row" nowrap>其他支出</td>
		    <td colspan="">
		    	<input name="other_expenditure" id="other_expenditure" type="text" value="0" dataType="Money"
		    	disabled="disabled"	disabled="disabled"  size="13" maxlength="20" onchange="assignment()"  readonly="readonly"/> 
			</td>
		  </tr>	
		  ...
		  <tr>	
			...
			<td>
				<input name="nominalprice" id="nominalprice" type="text" value="0" onchange="assignment()"
					 disabled="disabled" dataType="Money" size="13" maxlength="20" maxB="20"  Require="true" readonly="readonly"/>
				<span class="biTian">*</span>
			</td>
			...
			<td>
				<input name="plan_irr" disabled="disabled" id="plan_irr" type="text" value="0" size="13" maxlength="10" readonly="readonly"/>%
			</td> 
		  </tr>
		   ...
		   <tr>
		    ...
		    <td>
		    	<input name="before_interest" id="before_interest" type="text" value="0"  onchange="changeTwoData()"
		    		disabled="disabled" dataType="Money" size="13" maxlength="20" maxB="20"  Require="true" readonly="readonly" />
		    		是否算本
		    		<input type="text" name="before_interest_type" value="" size="5" readonly>
		    		<!-- sys 财务不可选
		    		<input type="radio" name="before_interest_type" value="是" >是
		    		<input type="radio" name="before_interest_type" value="否" checked="checked">否
		    		 -->
		    	<span class="biTian">*</span>
			</td>
			<td scope="row" nowrap>利息补贴</td>
		  	<td>
				...
				disabled="disabled"	dataType="Money" size="13" maxlength="20" maxB="20"  Require="" onchange="assignment()" readonly="readonly"/>
				<span class="biTian"></span>
			</td>
		    ...
		    <td>
		    	<input name="assets_value" id="assets_value" type="text" disabled="disabled"  value="0" dataType="Money" size="13" maxlength="20" maxB="20" readonly="readonly" />
			</td>
		  </tr>
		  ...
		  <tr>
		    ...
		    <td>
		    	...
		    	<input name="actual_fund" id="actual_fund" type="text" readonly on onClick="assignment()" 
		    	dataType="Money" size="13" maxlength="20" maxB="20"/> 
		    	
		    		净融资额比例
    				<input name="actual_fund_ratio" id="actual_fund_ratio" type="text" 
					value="" size="5" disabled="disabled"
		    ...
		    <td>
				...
				<input type="hidden"  name="income_number_year" style="width: 100px;" value="" readonly="readonly">
		    	 ...
		    	 <select name="income_number_year1" id="income_number_year" style="width: 100px;" disabled="disabled">
					<script type="text/javascript">
		    ...
		    <td>
		    	<input name="income_number" id="income_number"  disabled="disabled" type="text" value="0" onChange="changLeaseT_value()"
		   ...
		   <td  scope="row" nowrap>租赁年利率</td>
			<td nowrap="nowrap">
				<input name="year_rate" id="year_rate" type="text" value="0.00"  
					disabled="disabled" dataType="Double" size="13" maxlength="13" maxB="13"  Require="true" readonly="readonly"/>%
				<span class="biTian">*</span>
			</td>
		...
		<tr>
			...
			<td>
				<input name="start_date" id="start_date" type="text"  
					 size="13" maxlength="20"  Require="true" readonly="readonly" label="预计起租日"/>
		    ...
		    <td colspan="">
		    	<input name="pena_rate" id="pena_rate" type="text" value="10"  
		         size="13" maxlength="20" dataType="Double" size="13" maxlength="10" maxB="10"  Require="true" label="罚息日利率"/>%%
		    ...
		    <td> 
		    	<input name="free_defa_inter_day" id="free_defa_inter_day" type="text" value="3"  
		            ...
		            alert('请正确输入逾期宽限日');document.all.free_defa_inter_day.focus();}" label="逾期宽限日"/>
		    	<span class="biTian">*</span>
			</td>
		</tr>
		 <tr>
	    <td scope="row" nowrap>利率浮动类型</td>
		    ...
		    <td>
		    	<input name="rate_float_amt" id="rate_float_amt" type="text" value="0"  onblur="alertChange()"
		    		dataType="Double" size="13" maxlength="13" maxB="13"  Require="true" label="利率调整值"/>
		    	<span class="biTian">*</span>
			</td>
	    </tr>
		<tr>
		    ...
		    <td>
		    	<input type="text" dataType="Double" style="width: 140" name="StandardIrr" value="0" label="达标IRR"/>%
				  是否达标
			...
			<td>
				<input name="irr" id="irr" type="text" value="0" size="13" maxlength="10" label="实际IRR"/>%
			</td> 
	    ...
	    <tr>
			...
			<td>
			<select style="width:140px;" name="invoice_type" disabled="disabled" id="invoice_type" Require="true" label="租金开票方式">
					  <script type="text/javascript">
			...
			<td>
			<select style="width:100" name="insure_type" id="insure_type" disabled="disabled" Require="true" label="投保方式">
					  <script type="text/javascript">
			...
			<td>
			<select style="width:100" name="insure_pay_type" disabled="disabled" id="insure_pay_type" Require="true" label="保险收取方式">
					  <script type="text/javascript">
			...
			<td>
			<select style="width:100" name="tax_type_invoice" id="tax_type_invoice" disabled="disabled"  Require="true" label="保险收取方式">
					  <script type="text/javascript">
	    ...
	    <tr>
		    ...
		    <td>
		    	<input name="assess_adjust" type="text" value="0" disabled="disabled"  dataType="Money" size="13" maxlength="10" maxB="10" onchange="changeFirst_payment()" label="考核调整"/>
			</td>
			 -->
			 <!-- sys考核调整隐藏域 -->
			 <input type="hidden" name="assess_adjust" value="0" disabled="disabled"  dataType="Money" size="13" maxlength="10" maxB="10" onchange="changeFirst_payment()"/>
	    </tr>
		</table>
		</div>
		</div>
