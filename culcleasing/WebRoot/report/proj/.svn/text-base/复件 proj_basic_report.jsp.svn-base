...
height:25px;
		...
		<script type="text/javascript" src="../../js/stleasing_function.js">
</script>
		...
		<script language="javascript" src="/dict/js/js_dictionary.js">
</script>
		<script language="javascript" src="/dict/js/ajax_popupDialog.js">
</script>
		<script type="text/javascript" src="../../js/numberseparation.js">
</script>

		<script src="../../js/delitem.js">
</script>
...
function waitSub() {
	...
	if ((proj_id == null || proj_id == "")
		...
		<%
			...
			//LogWriter.logDebug(request, "项目基本信息###"+sqlstr);
			...
			if (rs.next()) {
				...
				proj_assistant_name = getDBStr(rs
						.getString("proj_assistant_name"));
		...
		<%
			...
			ConditionBean conditionBean = ConditionService
					.initFactConditionContractBean(contract_id);
			conditionBean = ConditionService1
					.initConditionContractBean(conditionBean);
			//2.查询该项目已签约项目金额
						...
						<div>
							...
							<table border="0" style="border-collapse:collapse;" align="center" 
								...
								<tr>
									...
									<td colspan="2" align="left"><%=cust_name2%></td>
								</tr>
								<tr>
									<td align="left" style="font-weight: bold;" class="first">
										出单部门:
									...
									cellpadding="2" cellspacing="1" width="100%" class="maintab_content_table">
												...
												<td colspan="8" align="left" class="first">
													...
													<% 
														...
														%>
														<input  name="settle_method" disabled="disabled"
																				value="<%=settle_method%>"/>
				...
				dict_list("currencyVal","currency_type","currency_type1","name");
																	...
																	<tr>
																		...
																		<td>
																			<input type="text" name="adjust_style"
																				...
																				value="<%=("2".equals(conditionBean.getAdjust_style()) ? "按次期"
					: "按次日")%>" />											批量调息
		          ...
		          -->
																	...
																	<tr>
																		...
																		<td>
																			<input type="text" disabled="disabled"
																				value="<%=(conditionBean.getTax_type())==null?"无":conditionBean.getTax_type()%>" />
																			<span class="biTian">*</span>
																		</td>
																	</tr>
					...
					dict_list("insure_pay_type","root.insurPayType","root.insurPayType.001","name");
																		...
																		<td>
																			<input name="tax_type_invoice" disabled="disabled"
																				value="<%=(conditionBean.getTax_type_invoice())==null?"无":"conditionBean.getTax_type_invoice()"%>" />
																			<!-- <select style="width: 100" name="tax_type_invoice"
																				id="tax_type_invoice" disabled="disabled"
																				Require="true" label="保险收取方式">
																				<script type="text/javascript">
								...
								<div>
									...
									<table  width="100%" class="maintab_content_table">
										...
										<tr>
											...
											<td colspan="2"><%=getDBStr(rs.getString("sum_penalty_day_amount"))%></td>
										</tr>
										<tr>
											...
											<td colspan="1" align="left"  class="first">罚息总额:</td><td colspan="2"><%=formatNumberStr(getDBStr(rs.getString("sum_penalty")),"#,##0.00")%></td>
										</tr>
										<tr>
											...
											<td colspan="1" align="left"  class="first">欠收利息:</td><td colspan="4"><%=qs_interest%></td>
										</tr>
										<tr>
											...
											<td colspan="1" align="left"  class="first">未回收利息:</td><td colspan="4"><%=formatNumberStr(getDBStr(rs.getString("whs_interest")),"#,##0.00")%></td>
										</tr>
								...
								<div>
									...
									<div>
										...
										<tr>
											...
											<td colspan="1" align="left"  class="first">欠收利息:</td><td colspan="4"><%=qs_interest2.equals("-0.00")?"0.00":qs_interest2%></td>
										</tr>
										<tr>
											...
											<td colspan="1" align="left"  class="first">回收率：</td><td colspan="4"><%=rate*100%>%</td>
										</tr>
										<tr>
											<td colspan="20">
												&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
