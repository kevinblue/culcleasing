...
//导出类型1
String exesqlstr1 = "select qy 区域,khmc 代理店全称,khjc 代理店简称,overdueProjAmount 二期逾期项目数量,overdueEquipAmount 二期逾期设备数量 from report_two_overdue where agent_id in ";

//导出类型2--数据导出
String exesqlstr2 = "select qy 区域,khmc 代理店全称,khjc 代理店简称,overdueProjAmount 二期逾期项目数量,overdueEquipAmount 二期逾期设备数量 from report_two_overdue where overdueProjAmount>0 and year(create_date)= "+year+" and month(create_date)="+month+filterAgent+wherestr+"order by overdueProjAmount desc,bmid";
...
<table border="0" width="100%" cellspacing="0" cellpadding="0"
	...
	<tr class="tree_title_txt">
		<td nowrap width="100%" class="tree_title_txt" valign="middle" id="cwCellTopTitTxt">
			代理商逾期统计 &gt;<font color="color:red;"> <%=year %>年<%=month %>月</font>&gt; 二期逾期
		</td>
	</tr>
</table><!--标题结束-->
