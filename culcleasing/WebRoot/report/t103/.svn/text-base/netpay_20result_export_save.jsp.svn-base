...
titleList.add("20日成功");
titleList.add("20日失败");
titleList.add("20日失败率");

titleList.add("25日成功");
titleList.add("25日失败");
titleList.add("25日失败率");

titleList.add("30日成功");
titleList.add("30日失败");
titleList.add("30日失败率");
...
//创建报表头部
exportExcel.createNormalHead("20日网银扣款结果统计", number);
//设置第二行
...
//导出excel
exportExcel.outputExcel("20r_wykk__"+curr_date, wb, response, pageContext);
