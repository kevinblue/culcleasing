...
<form action="two_overdue_list_report.jsp" name="dataNav" onSubmit="return goPage()">
...
countSql = "select count(*) as amount from vi_report_overdue_two where overdueProjAmount>0 "+filterAgent+wherestr;

//导出类型1
String exesqlstr1 = "select qy 区域,khmc 代理店全称,khjc 代理店简称,overdueProjAmount 二期逾期项目数量,overdueEquipAmount 二期逾期设备数量 from vi_report_overdue_two where agent_id in ";

//导出类型2--数据导出
String exesqlstr2 = "select qy 区域,khmc 代理店全称,khjc 代理店简称,overdueProjAmount 二期逾期项目数量,overdueEquipAmount 二期逾期设备数量 from vi_report_overdue_two where overdueProjAmount>0 "+filterAgent+wherestr;
	...
	<tr class="maintab">
		...
		<table border="0" cellspacing="0" cellpadding="0" >    
			<tr class="maintab">
				...
				<BUTTON class="btn_2"  type="button" onclick="return validata_data_report_exp('../../func/exp_report.jsp','two_overdue_list_report.jsp');">
...
<table border="0" style="border-collapse:collapse;" align="center"
	...
	<tbody id="data">
<%	  
sqlstr = "select top "+ intPageSize +" * from vi_report_overdue_two where overdueProjAmount>0 and bmid not in( ";
sqlstr += " select top "+ (intPage-1)*intPageSize +" bmid from vi_report_overdue_two where overdueProjAmount>0 "+filterAgent+wherestr+" order by overdueProjAmount desc,bmid  ) "+filterAgent+wherestr;
...
<tr>
	...
	<td align="left">
	<a href="two_overdue_detail_list.jsp?agent_id=<%=item_id %>" target="_blank">
