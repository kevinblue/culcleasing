...
//导出类型1
String exesqlstr1 = "select qy 区域,khmc 代理店全称,khjc 代理店简称,cast(overdueProjAmount as decimal) 二期逾期项目数量,cast(overdueEquipAmount as decimal) 二期逾期设备数量 from vi_report_overdue_two where agent_id in ";

//导出类型2--数据导出
String exesqlstr2 = "select qy 区域,khmc 代理店全称,khjc 代理店简称,cast(overdueProjAmount as decimal) 二期逾期项目数量,cast(overdueEquipAmount as decimal) 二期逾期设备数量 from vi_report_overdue_two where overdueProjAmount>0 "+filterAgent+wherestr;
...
sqlstr = "select top "+ intPageSize +" "+col_str+" from vi_report_overdue_two where overdueProjAmount>0 and bmid not in( ";
