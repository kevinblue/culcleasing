...
//导出类型1
String exesqlstr1 = "select qy 区域,dls 代理店,proj_id 项目编号,cname 客户名称, manufacturer 制造商,zlwmc 租赁物类型, ";
...
//导出类型2--数据导出
String exesqlstr2 = "select qy 区域,dls 代理店,proj_id 项目编号,cname 客户名称, manufacturer 制造商,zlwmc 租赁物类型, ";
