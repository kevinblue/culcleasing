...
String sql_str =" ";
String col_str = "";
col_str =" qy 区域,dld 代理商,subcompany 分支机构,vt.proj_id 项目编号,khmc 客户名称,cust_id 客户编号,card_id 身份证号,phone 联系方式,";
col_str+=" prod_id 租赁物类型,manufacturer 制造商,method 规则付款,model_id 机型,equip_sn 出厂编号,";
