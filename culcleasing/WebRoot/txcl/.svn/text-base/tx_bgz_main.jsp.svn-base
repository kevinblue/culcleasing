 ...
 <tr>
  <td valign="top" height="1%">
	  <div>
	      ...
	      <div name="expContent">
		  <iframe name="ifmXghtList" class="w100p" frameborder="0" height="300" src="tx_bgz_choice.jsp?czid=<%=czid%>" scrolling="auto">
		  </iframe>
		  </div>
	  </div>
  </td>
 ...
 <tr>
  <td>
	  <div>
	    ...
	    <div name="expContent">
			<iframe name="ifmFxghtList" class="w100p" frameborder="0" height="700" src="tx_bgz_wait_choice.jsp?czid=<%=czid%>" scrolling="auto">
			</iframe>
		</div>
	  </div>
  </td>
