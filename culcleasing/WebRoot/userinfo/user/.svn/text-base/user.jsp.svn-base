...
<form name="form1" method="post" action="user.jsp" onSubmit="return Validator.Validate(this,3);">
<%
...
<a href="user_mod.jsp?id=<%= id %>"  accesskey="m" title="修改(Alt+M)" class="fontcolor">
