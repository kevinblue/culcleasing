...
int canedit=0;
if (right.CheckRight("ywygl-ywygl-mod",dqczy)>0) canedit=1;
...
int canmod=0;
	...
	String sqlstr = "select manage_id, compid, dbo.FK_GETCOMPNAME(compid) compname, manage_name, manage_phone, overArea from userInfo where manage_id='"+id+"'"; 
	...
	if ( rs.next() ) {
		...
		compid = getDBStr( rs.getString("compid") );
...
<table border="0" cellspacing="0" cellpadding="0" width="98%" align="center" class="tab_table_title">
  <tr>
    ...
    <td><input name="manage_name" type="text" value="<%= manage_name %>" /></td>
  </tr>
  <tr>
    ...
    <td>
    	<select name="compid" id="compid">
        	<script language="javascript" type="text/javascript">
					dict_list("compid","branch","<%=compid%>","name")
				</script>
        </select>
  ...
  <tr>
    ...
    <td><input name="manage_phone" type="text" value="<%= manage_phone %>" size="15" /></td>
  </tr>
  <tr>
  	<td align="right">负责区域：</td>
    <td>
    	<textarea name="overArea" cols="15" rows="5"><%= overArea %></textarea>
    </td>
  </tr>
</table>
</div>
