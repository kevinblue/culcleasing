...
int canedit=0;
if (right.CheckRight("eback-wydr-up",dqczy)>0) canedit=1;
if (canedit==0) response.sendRedirect("../../noright.jsp");
%>
<html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=gbk">
<title>网银导入 - 网银数据上传</title>
<link href="../../css/global.css" rel="stylesheet" type="text/css">
<script src="../../js/comm.js"></script>
</head>

<body>
<form name="list" action="wydr_save.jsp" enctype="multipart/form-data" method="post" onSubmit="Validator.Validate(this,3)">
...
function fun_save(){
	...
	document.forms[0].action="wydr_save.jsp";
