...
<tr>
<td>项目编号<input name="proj_id" type="text" value="<%=proj_id %>"></td>
<td>项目名称<input name="proj_name" type="text" value="<%=proj_name %>"></td>
<td>承租客户<input name="cust_name" type="text" value="<%=cust_name %>">
