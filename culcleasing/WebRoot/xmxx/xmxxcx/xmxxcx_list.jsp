...
if ( isExit1 ) {
wherestr+="and (proj_dept in (select filiale_id from base_governor where user_id='"+dqczy+"') or proj_manage in (select id from base_user where department in(select id from base_department where charIndex(vi_proj_info.vdeptname,dept_name)>0 and dept_manager='"+dqczy+"'))or proj_work='"+dqczy+"' )";}
