...
<td class="tree_title_txt"  height=26 valign="middle" align="left">基础信息管理 &gt; 新增提取比例分类</td>
</tr>
<tr>
...
<table border="0" cellspacing="0" cellpadding="0" width="100%" class="tab_table_title">
  <tr >
    <td width="120" scope="row">五级分类</td>
    <td >
   ...
   <tr>
    ...
    <td><input name="scale" type="text" label="提取比例" Require="true">%<span class="biTian">*</span></td>
  </tr>
</table>
</div>
