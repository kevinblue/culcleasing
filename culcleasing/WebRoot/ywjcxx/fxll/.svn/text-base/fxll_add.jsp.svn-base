...
<div id="cwCellTop">
	<table id="cwCellTopTit" width="100%" border="0" cellpadding="0" cellspacing="0" >
      <tr>
        ...
        <td id="cwCellTopTitTxt">新增罚息利率</td>
...
<table   border="0" cellpadding="2" cellspacing="5" class="cwDataInput">
  ...
  <tr>
    ...
    <td><input type="text" name="contract_id" readonly Require="ture" size=20><input type="hidden" name="contract_id_data"><img src="../../images/sbtn_more.gif" alt="选" width="19" height="19" align="absmiddle"  style="cursor:pointer" onclick="OpenDataWindow('','','','','合同编号','v_dw_contract','target_name','contract_id','target_name','target_name','asc','form1.contract_id_data','form1.contract_id');"><span class="biTian">*</span></td>
  </tr>
  <tr>
      <th scope="row">罚息利率类型</th>
      <td><select name="pena_rate_type">
        <script>w(mSetOpt('',"固定|浮动"));</script>
        </select>
