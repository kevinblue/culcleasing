...
<table border="0" cellspacing="0" cellpadding="0" >    
    <tr class="maintab">
		...
		<%//if(right.CheckRight("gszh_add",dqczy)>0){%><td><a href="#" accesskey="n" onClick="dataHander('add','fyxx_add.jsp',dataNav.itemselect);"><img align="absmiddle"  src="../../images/sbtn_new.gif" alt="新增(Alt+N)" align="absmiddle"></a></td><%//}%>
		<%//if(right.CheckRight("gszh_mod",dqczy)>0){%><td><a href="#" accesskey="m" onClick="dataHander('mod','fyxx_mod.jsp?czid=',dataNav.itemselect);"><img align="absmiddle"  src="../../images/sbtn_mod.gif" alt="修改(Alt+M)" align="absmiddle" ></a></td><%//}%>
		<%//if(right.CheckRight("gszh_del",dqczy)>0){%><td><a href="#" accesskey="d" onClick="dataHander('del','fyxx_del.jsp?czid=',dataNav.itemselect);"><img align="absmiddle" src="../../images/sbtn_del.gif" alt="删除(Alt+D)" align="absmiddle" ></a></td><%//}%>
