...
<table id="cwCellToolbar" border="0" cellspacing="5" cellpadding="0" >
      <tr>
		...
		<td><a href="#" accesskey="n"><img src="../../images/sbtn_new.gif" alt="新增(Alt+N)" width="19" height="19" align="absmiddle" onclick="dataHander('add','gszh_add.jsp',list.itemselect);"></a></td>
		<td><a href="#" accesskey="d"><img src="../../images/sbtn_del.gif" alt="删除(Alt+D)" width="19" height="19" align="absmiddle"  onclick="dataHander('del','gszh_del.jsp?czid=',list.itemselect);"></a></td>
		<td><a href="#"  accesskey="m"><img src="../../images/sbtn_mod.gif" alt="修改(Alt+M)" width="19" height="19" align="absmiddle"  onclick="dataHander('mod','gszh_mod.jsp?czid=',list.itemselect);"></a></td>
...
%>
        <form name="searchbar" action="gszh_list_bk.jsp">
          <td nowrap>开户帐号：<input name="searchKey" accesskey="s" type="text" size="15" value="<%=searchKey%>"><input name="image" type="image" src="../../images/tbtn_searh.gif" alt="查询" align="absmiddle"  onclick="searchbar.submit();">
          </td>
        </form>
      </tr>
</table>
