...
<table id="cwCellToolbar" border="0" cellspacing="5" cellpadding="0" >
      <tr>
        <td>&nbsp;</td>
        <td><a href="#" accesskey="n" onclick="dataHander('add','hlxx_add.jsp',list.itemselect);"><img src="../../images/sbtn_new.gif" alt="新增(Alt+N)" width="19" height="19" align="absmiddle"></a></td>
        <td><a href="#" accesskey="d" onclick="dataHander('del','hlxx_del.jsp?czid=',list.itemselect);"><img src="../../images/sbtn_del.gif" alt="删除(Alt+D)" width="19" height="19" align="absmiddle" ></a></td>
        <td><a href="#"  accesskey="m" onclick="dataHander('mod','hlxx_mod.jsp?czid=',list.itemselect);"><img src="../../images/sbtn_mod.gif" alt="修改(Alt+M)" width="19" height="19" align="absmiddle" ></a></td>
...
if (request.getParameter("searchKey")!=null)
{
   ...
   wherestr=wherestr+" and jb_bzxx.bz like '%"+searchKey+"%' "; 
}
%>
        <form name="searchbar" action="hlxx_list.jsp">
          <td nowrap>币种名称：
...
<% 
sqlstr = "SELECT jb_hlxx.*, jb_bzxx.bz, V_yhxx.xm FROM jb_hlxx LEFT OUTER JOIN jb_bzxx ON jb_hlxx.bzid = jb_bzxx.id LEFT OUTER JOIN V_yhxx ON jb_hlxx.czy = V_yhxx.id"+wherestr+"order by jb_hlxx.jsrq asc,jb_hlxx.ksrq desc"; 
...
%>
      ...
      <tr class="cwDLRow" >
        ...
        <td align="center"><%=getDBStr(rs.getString("bz"))%></td>
        <td><a href="hlxx.jsp?czid=<%=getDBStr(rs.getString("id"))%>" target="_blank"><%=getDBStr(rs.getString("hl"))%></a></td>
        <%
...
<div id="cwDataNav" >
<form name="dataNav" action="hlxx_list.jsp">
