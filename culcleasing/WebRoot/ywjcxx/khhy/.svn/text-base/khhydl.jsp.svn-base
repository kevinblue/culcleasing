...
<table border="0" cellspacing="0" cellpadding="0" width="100%" class="tab_table_title">
  <tr>
    <td width="20%" height="30" class="cwDDLabel">客户行业大类代码</td>
    <td width="80%" height="30" class="cwDDValue"><%=getDBStr(rs.getString("hydlbh"))%></td>
  </tr>
  <tr>
    <td height="30" class="cwDDLabel" scope="row">客户行业大类名称</td>
    <td height="30" class="cwDDValue"><%=getDBStr(rs.getString("hydlmc"))%></td>
  </tr>
    <tr>
    <td height="30" class="cwDDLabel" scope="row">所属客户行业门类代码</td>
...
<tr valign="top">
<form action="khhydl_mod.jsp?czid=<%=czid%> " target="_self">
