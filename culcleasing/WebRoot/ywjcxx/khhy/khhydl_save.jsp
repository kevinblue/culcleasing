...
String datestr=getSystemDate(1); 
    ...
    if (request.getParameter("savetype")!=null)
    {
        ...
        if (stype.indexOf("add")>=0)     //新增操作
       {
            ...
            //判断主键是否重复
            sqlstr="select * from kh_hydl_gb where hydlbh='"+hydldm+"'";
            ...
            {
            sqlstr="insert into kh_hydl_gb(hydlbh,hydlmc,hymlbh,gxrq,czy) values ('"+hydldm+"','"+hydlmc+"','"+hymlbh+"',"+datestr+",'"+czy+"')";
       ...
       if (stype.indexOf("mod")>=0)      //修改操作
       {
		...
		{}
            ...
            if (tempFlag!=0){
                sqlstr="update kh_hydl_gb set hydlbh='"+hydldm+"',hydlmc='"+hydlmc +"',hymlbh='"+hymlbh +"',gxrq="+datestr+",czy='"+czy+"' where hydlbh='"+kid+"'";
                i=db.executeUpdate(sqlstr); 
       ...
       if (stype.indexOf("del")>=0)         //删除操作
       {
            ...
            sqlstr="delete from kh_hydl_gb where hydlbh='"+czid+"'";
            i=db.executeUpdate(sqlstr); 
