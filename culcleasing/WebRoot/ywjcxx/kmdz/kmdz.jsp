...
<%
sqlstr = "select * from dbo.inter_fee_subject_join where id='"+czid+"' "; 
...
<table border="0" cellspacing="0" cellpadding="0" width="100%" class="tab_table_title">
  <tr >
    ...
    <td height="30" >
     <input name="feetype_number" type="text" label="费用ID" value="<%=getDBStr(rs.getString("feetype_number")) %>" Require="true" readonly="readonly" ><span class="biTian">*</span>
	</td>
  </tr>
   <tr>
