...
<td class="tree_title_txt"  height=26 valign="middle" align="left">基础信息维护 &gt; 新增课目对照</td>
</tr>
<tr>
...
<table border="0" cellspacing="0" cellpadding="0" width="100%" class="tab_table_title">
  <tr >
    ...
    <td height="30" >
     <input name="subject_num" type="text" label="课目编号"  Require="true" ><span class="biTian">*</span>
	</td>
  </tr>
   <tr>
    <td height="30" scope="row">课目名</td>
    <td height="30"><input name="subject_name" type="text" label="课目名"  Require="ture"><span class="biTian">*</span></td>
  </tr>
