...
<td class="tree_title_txt"  height=26 valign="middle" align="left">基础信息管理 &gt; 删除课目对照表</td>
</tr>
<tr>
<td align=center width=100% height=100% valign="top">
<div class="mydivtab" id="mydiv">

<form name="form1" method="post" action="kmdz_save.jsp">
...
<table border="0" cellspacing="0" cellpadding="0" width="100%" class="tab_table_title">
   <tr >
    ...
    <td height="30" >
     <input name="subject_num" type="text" label="课目编号" value="<%=getDBStr(rs.getString("subject_num")) %>" Require="true" readonly="readonly"><span class="biTian">*</span>
	</td>
  </tr>
   <tr>
    <td height="30" scope="row">课目名</td>
    <td height="30"><input name="subject_name" type="text" label="课目名"  value="<%=getDBStr(rs.getString("subject_name")) %>"  Require="ture" readonly="readonly"><span class="biTian">*</span></td>
  </tr>
