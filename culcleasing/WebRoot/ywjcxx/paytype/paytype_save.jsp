...
if ( stype.equals("add") ){        //添加操作
		...
		<%
			...
			sqlstr = "insert into base_paytype(pay_type_code,finance_code,pay_type_name,create_date ,creator ) values ('" + pay_type_code + "','"+finance_code+"','" + pay_type_name  + "','" + datestr  + "','" + dqczy + "')";
	...
	sqlstr = "update base_paytype set pay_type_code='"+pay_type_code+"',finance_code='"+finance_code+"',pay_type_name='" + pay_type_name  + "',create_date='" + datestr + "',creator='" + dqczy + "' where id='" + kid + "'";
	db.executeUpdate(sqlstr);
	%>
	<script type="text/javascript">
		window.close();
