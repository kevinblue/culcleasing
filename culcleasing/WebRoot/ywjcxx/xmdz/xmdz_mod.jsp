...
<td class="tree_title_txt"  height=26 valign="middle" align="left">基础信息维护 &gt; 项目对照</td>
</tr>
<tr>
...
<table border="0" cellspacing="0" cellpadding="0" width="100%" class="tab_table_title">
  <tr >
    ...
    <td height="30" >
     <input name="subject_name" type="text" label="项目名" value="<%=getDBStr(rs.getString("subject_name")) %>" Require="true" ><span class="biTian">*</span>
	</td>
  </tr>
   <tr>
    <td height="30" scope="row">项目编码</td>
    <td height="30"><input name="subject_number" type="text" label="项目编码"  value="<%=getDBStr(rs.getString("subject_number")) %>"  Require="ture"><span class="biTian">*</span></td>
  </tr>
   <tr>
    <td height="30" scope="row">项目编号</td>
    <td height="30"><input name="project_id" type="text" label="项目编号"  value="<%=getDBStr(rs.getString("project_id")) %>"  Require="ture"><span class="biTian">*</span></td>
  </tr>
