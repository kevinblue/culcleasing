...
<div id="cwCellTop">
	...
	<table id="cwCellTopTit" width="100%" border="0" cellpadding="0" cellspacing="0" >
      <tr>
        ...
        <td id="cwCellTopTitTxt">资料类别大类列表</td>
...
<table id="cwCellToolbar" border="0" cellspacing="5" cellpadding="0" >
      <tr>
		...
		<td><a href="#" accesskey="n" onclick="dataHander('add','zllbdl_add.jsp',list.itemselect);"><img src="../../images/sbtn_new.gif" alt="新增(Alt+N)" width="19" height="19" align="absmiddle"></a></td>
		<td><a href="#" accesskey="d" onclick="dataHander('del','zllbdl_del.jsp?czid=',list.itemselect);"><img src="../../images/sbtn_del.gif" alt="删除(Alt+D)" width="19" height="19" align="absmiddle" ></a></td>
		<td><a href="#"  accesskey="m" onclick="dataHander('mod','zllbdl_mod.jsp?czid=',list.itemselect);"><img src="../../images/sbtn_mod.gif" alt="修改(Alt+M)" width="19" height="19" align="absmiddle" ></a></td>
...
if (request.getParameter("searchKey")!=null)
{
   ...
   wherestr=wherestr+" and jb_zldl.lbdlmc like '%"+searchKey+"%' "; 
}
%>
        <form name="searchbar" action="zllbdl_list.jsp">
          <td nowrap>客户类别大类名称：<input name="searchKey" accesskey="s" type="text" size="15" value="<%=searchKey%>"><input name="image" type="image" src="../../images/tbtn_searh.gif" alt="查询" align="absmiddle"  onclick="searchbar.submit();">
          </td>
        </form>
      </tr>
</table>
...
<%
sqlstr = "select jb_zldl.*,v_yhxx.xm from v_yhxx right outer join jb_zldl on v_yhxx.id = jb_zldl.czy"+wherestr+"order by jb_zldl.id asc"; 
...
%>
      ...
      <tr class="cwDLRow" >
        ...
        <td><a href="zllbdl.jsp?czid=<%=getDBStr(rs.getString("id"))%>" target="_blank"><%=getDBStr(rs.getString("lbdlmc"))%></a></td>
        <td align="center"><%=getDBDateStr(rs.getString("gxrq"))%></td>
        <td align="center"><%=getDBStr(rs.getString("xm"))%></td>
		<td align="center"><a href="../zllbxl/zllbxl_list.jsp?czid=<%=getDBStr(rs.getString("id"))%>" target="_blank">查看</a></td>
	  </tr>
...
<div id="cwDataNav">
<form action="zllbdl_list.jsp" name="dataNav" onSubmit="return goPage()">
