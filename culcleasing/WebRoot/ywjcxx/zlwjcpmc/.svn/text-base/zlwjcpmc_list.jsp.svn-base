...
{
wherestr=wherestr+" and jb_zlwjlx.zlid = '"+czid+"' "; 
}
if (request.getParameter("searchKey")!=null)
{
   searchKey=getStr(request.getParameter("searchKey"));
   wherestr=wherestr+" and jb_zlwjlx.lxmc like '%"+searchKey+"%' "; 
}
%>
...
<div id="cwCellTop">
	...
	<table id="cwCellTopTit" width="100%" border="0" cellpadding="0" cellspacing="0" >
      <tr>
        ...
        <td id="cwCellTopTitTxt">租赁物件产品名称列表</td>
...
<table id="cwCellToolbar" border="0" cellspacing="5" cellpadding="0" >
      <tr>
		...
		<td><a href="#" accesskey="n" onclick="dataHander('add','zlwjcpmc_add.jsp?czid=<%=czid%>',list.itemselect);"><img src="../../images/sbtn_new.gif" alt="新增(Alt+N)" width="19" height="19" align="absmiddle"></a></td>
		<td><a href="#" accesskey="d" onclick="dataHander('del','zlwjcpmc_del.jsp?czid=',list.itemselect);"><img src="../../images/sbtn_del.gif" alt="删除(Alt+D)" width="19" height="19" align="absmiddle" ></a></td>
		<td><a href="#"  accesskey="m" onclick="dataHander('mod','zlwjcpmc_mod.jsp?czid=',list.itemselect);"><img src="../../images/sbtn_mod.gif" alt="修改(Alt+M)" width="19" height="19" align="absmiddle" ></a></td>
		<td><img src="../../images/sbtn_split.gif" width="2" height="14"></td>

        <form name="searchbar" action="zlwjcpmc_list.jsp" method="post">
          <td nowrap>产品名称：<input name="searchKey" accesskey="s" type="text" size="15" value="<%=searchKey%>">
...
<!-- end cwCellTop -->
<%
sqlstr = "select jb_zlwjlb.lxmc as zlmc, jb_zlwjlx.*,v_yhxx.xm from v_yhxx right outer join jb_zlwjlx on v_yhxx.id = jb_zlwjlx.czy left outer join jb_zlwjlb on jb_zlwjlx.zlid = jb_zlwjlb.id"+wherestr+"order by jb_zlwjlx.id asc"; 
...
%>
      ...
      <tr class="cwDLRow" >
       <td><input class="rd" type="radio" name="itemselect" value="<%=getDBStr(rs.getString("id"))%>"></td>
        ...
        <td align="center"><%=getDBStr(rs.getString("zlmc"))%></td>
        <td align="center"><a href="../zlwjcptx/zlwjcptx_list.jsp?czid=<%=getDBStr(rs.getString("id"))%>" target="_blank">查看</a></td>
...
<div id="cwDataNav" >
<form action="zlwjcpmc_list.jsp" name="dataNav" onSubmit="return goPage()"  method="post">
