...
<form name="searchbar" action="zlsel.jsp">
<br>


<table id="cwCellToolbar" border="0" cellspacing="5" cellpadding="0" style="float:left " >
      <tr>
        <td nowrap>总类名称: <input type="text" name="fv"   value="<%=filtervalue%>" style="width:90px"><input name="image" type="image" src="../../images/tbtn_searh.gif" alt="查询" align="absmiddle" >
</td>
      </tr>
</table>
...
<%
String sqlstr = "select id,lxmc from jb_zlwjlb "+wherestr+" order by id asc";
ResultSet rs;
...
<select name="datalist" size="30" ondblclick="ListSelect('form1.zliddata','form1.zlid');" style="width:100%">
...
%>
  ...
  <tr>
    <td align="center" height="30"><input class="btn" type="button" value="确定" onclick="ListSelect('form1.zliddata','form1.zlid');">  <input class="btn" type="button" value="取消" onclick="window.close()"></td>
  </tr>
</table>
</div>
</body>
