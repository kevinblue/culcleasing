...
%>
<div id="cwMain" >
<form name="form1" method="post" action="zlwjcptx_save.jsp">
...
<div id="cwCellTop">
	...
	<table id="cwCellTopTit" width="100%" border="0" cellpadding="0" cellspacing="0" >
      <tr>
        ...
        <td id="cwCellTopTitTxt">删除租赁物件产品特性</td>
...
<table  class="cwDataDetail" width="100%" border="0" cellspacing="1" cellpadding="1">
  <tr>
    <th width="20%" class="cwDDLabel">所属产品名称</th>
    <td width="80%" class="cwDDValue"><%=getDBStr(rs.getString("cpmc"))%></td>
  </tr>
  <tr>
    <th class="cwDDLabel" scope="row">租赁物件产品特性代码</th>
    <td class="cwDDValue"><%=getDBStr(rs.getString("id"))%></td>
  </tr>
  <tr>
    <th class="cwDDLabel" scope="row">租赁物件产品特性名称</th>
