...
<title>租赁物件供应商情况列表 - 租赁物件供应商情况</title>
...
<div id="cwCellTop">
	...
	<table id="cwCellTopTit" width="100%" border="0" cellpadding="0" cellspacing="0" >
      <tr>
        ...
        <td id="cwCellTopTitTxt">租赁物件供应商情况列表</td>
...
<table id="cwCellToolbar" border="0" cellspacing="5" cellpadding="0" >
      <tr>
		...
		<td><a href="#" accesskey="n"><img src="../../images/sbtn_new.gif" alt="新增(Alt+N)" width="19" height="19" align="absmiddle" onclick="dataHander('add','zlwjgys_add.jsp',list.itemselect);"></a></td>
		<td><a href="#" accesskey="d"><img src="../../images/sbtn_del.gif" alt="删除(Alt+D)" width="19" height="19" align="absmiddle"  onclick="dataHander('del','zlwjgys_del.jsp?czid=',list.itemselect);"></a></td>
		<td><a href="#"  accesskey="m"><img src="../../images/sbtn_mod.gif" alt="修改(Alt+M)" width="19" height="19" align="absmiddle"  onclick="dataHander('mod','zlwjgys_mod.jsp?czid=',list.itemselect);"></a></td>
...
%>
        <form name="searchbar" action="zlwjgys_list.jsp">
          <td nowrap>物件名称：<input name="searchKey" accesskey="s" type="text" size="15" value="<%=searchKey%>"><input name="image" type="image" src="../../images/tbtn_searh.gif" alt="查询" align="absmiddle"  onclick="searchbar.submit();">
          </td>
        </form>
      </tr>
</table>
...
%>
      ...
      <tr class="cwDLRow" >
        ...
        <td><a href="zlwjgys.jsp?czid=<%=rs.getString("id")%>" target="_blank"><%=rs.getString("wjmc")%></a></td>
        <td><%=rs.getString("khmc")%></td>
        <td align="center"><%=rs.getString("dj")%></td>
        <td align="center"><%=rs.getString("bzmc")%></td>
        <td align="center"><%=rs.getString("zt")%></td>
	  </tr>
...
<div id="cwDataNav" >
<form name="dataNav" action="zlwjgys_list.jsp">
