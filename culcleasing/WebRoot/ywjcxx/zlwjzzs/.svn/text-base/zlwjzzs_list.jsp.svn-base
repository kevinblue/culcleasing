...
<div id="cwCellTop">
	...
	<table id="cwCellTopTit" width="100%" border="0" cellpadding="0" cellspacing="0" >
      <tr>
        ...
        <td id="cwCellTopTitTxt">租赁物件制造商列表</td>
...
{
%>
		<td><a href="#" accesskey="n" onclick="dataHander('add','zlwjzzs_add.jsp',list.itemselect);"><img src="../../images/sbtn_new.gif" alt="新增(Alt+N)" width="19" height="19" align="absmiddle"></a></td>
<%
}
%>
		<td><a href="#" accesskey="d"><img src="../../images/sbtn_del.gif" alt="删除(Alt+D)" width="19" height="19" align="absmiddle"  onclick="dataHander('del','zlwjzzs_del.jsp?czid=',list.itemselect);"></a></td>
<%
if (1==1)
{
%>
		<td><a href="#"  accesskey="m"><img src="../../images/sbtn_mod.gif" alt="修改(Alt+M)" width="19" height="19" align="absmiddle"  onclick="dataHander('mod','zlwjzzs_mod.jsp?czid=',list.itemselect);"></a></td>
<%
}
%>
...
if (request.getParameter("searchKey")!=null)
{
   ...
   wherestr=wherestr+" and jb_zlwjzzs.zzsmc like '%"+searchKey+"%' "; 
}
%>
        <form name="searchbar" action="zlwjzzs_list.jsp">
          <td nowrap>制造商名称：<input name="searchKey" accesskey="s" type="text" size="15" value="<%=searchKey%>"><input name="image" type="image" src="../../images/tbtn_searh.gif" alt="查询" align="absmiddle"  onclick="searchbar.submit();">
          </td>
        </form>
      </tr>
</table>
...
<%
sqlstr = "SELECT jb_zlwjzzs.*,jb_yhxx.xm FROM jb_zlwjzzs LEFT OUTER JOIN jb_yhxx ON jb_zlwjzzs.czy = jb_yhxx.id"+wherestr+"order by jb_zlwjzzs.id desc"; 
...
<div id="cwDataNav" >
<form action="zlwjzzs_list.jsp" name="dataNav" onSubmit="return goPage()">
