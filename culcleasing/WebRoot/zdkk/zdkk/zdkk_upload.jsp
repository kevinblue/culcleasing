...
int canedit=0;
if (right.CheckRight("zdkk-zdkk-up",dqczy)>0) canedit=1;
if (canedit==0) response.sendRedirect("../../noright.jsp");
%>
<html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=gbk">
<title>主动扣款信息 - 主动扣款信息上传</title>
<link href="../../css/global.css" rel="stylesheet" type="text/css">
<script src="../../js/comm.js"></script>
</head>

<body>
<form name="list" action="zdkk_save.jsp" enctype="multipart/form-data" method="post" onSubmit="Validator.Validate(this,3)">
				...
				<tr>
					<td>
						<table border="0" cellspacing="0" cellpadding="0">    
							<tr class="maintab_dh">
								<td nowrap id="saveTd">
									<BUTTON class="btn_2" name="btnSave" value="保存主动扣款信息"  type="button" onClick="fun_save()">
									<img src="../../images/save.gif" align="absmiddle" border="0">保存主动扣款信息</button>
								</td>
							</tr>
						</table>
					</td>
...
function fun_save(){
	if(confirm("确认要上传此文件"+document.forms[0].name1.value)){
	document.forms[0].action="zdkk_save.jsp";
