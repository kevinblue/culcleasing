...
<table border="0" cellspacing="0" cellpadding="0" width="98%" align="center" class="tab_table_title">
  ...
  <tr>
    ...
    <td><input name="corpus" type="text" size="20" maxB="20" Require="true" dataType="Money"><span class="biTian">*</span></td>
  	<td>利息</td>
    <td colspan="2"><input name="interest" type="text" size="20" maxB="20" Require="true" dataType="Double"><span class="biTian">*</span><input name="doc_id" type="hidden" value="<%= doc_id%>"></td>
  </tr>
