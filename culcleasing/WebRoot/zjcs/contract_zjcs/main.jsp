...
<%
	...
	String main_proj_id = getStr(request.getParameter("main_proj_id"));;//主项目编号 2011-03-21需求修改为从domino中传入住项目编号过来
	//调用初始化表数据方法
...
<div style="vertical-align:top;width:100%;overflow:auto;position: relative; left: 0px; top: 0px"  id="mydiv";>
	    <div>
			...
			<iframe frameborder="0" name="con" width="100%" height=390" 
				src="zjcs_contractAdd.jsp?proj_id=<%=proj_id%>&model=<%=model%>&doc_id=<%=doc_id%>&contract_id=<%=contract_id%>&main_proj_id=<%=main_proj_id%>">
			</iframe>
		</div>
<% 
