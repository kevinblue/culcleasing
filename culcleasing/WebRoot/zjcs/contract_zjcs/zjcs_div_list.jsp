...
<html>
	...
	<body onLoad="">
		<form name="form1" method="post" action="zics_div_list.jsp"
						...
						<td align=center width=100% height=100%>
							...
							<center>
								<div id="divH" class="tabBody"
									style="background: #ffffff; width: 100%;  overflow: auto;">
									<div id="TD_tab_0">
										<div style="text-align: left; width: 100%; height: 100%;">
											<table border="0" cellspacing="0" cellpadding="0">
												<tr>
													<td id="Form_s_tab_0" class="Form_tab" width=70
														align=center onClick="chgTabSub()" valign="middle"> &nbsp;合同租金偿还计划&nbsp;
													</td>
													<td id="Form_s_tab_1" class="Form_tab" width=70
														align=center onClick="chgTabSub()" valign="middle"> &nbsp;合同现金流列表&nbsp;
													</td>
													<td id="Form_s_tab_2" class="Form_tab" width=70
														align=center onClick="chgTabSub()" valign="middle"> &nbsp;会计租金偿还计划&nbsp;
													</td>
													<td id="Form_s_tab_3" class="Form_tab" width=70
														align=center onClick="chgTabSub()" valign="middle"> &nbsp;会计现金流列表&nbsp;
													</td>
												</tr>
											</table>
											<table border="0" cellspacing="0" cellpadding="0"
												width="100%">
												<tr>
													<td bgcolor="#8DB2E3" width="100%">
														<img height="1" width="1">
													</td>
												</tr>
											</table>
											<div id="TD_s_tab_0" style="display: none;">
												<iframe style="funny: expression(autoResize() )"
													id="UserBody0" frameborder="0" width="100%" height="100%"
													src="../contract_zjcs/rentplan_frame_mark.jsp?proj_id=<%=proj_id%>&doc_id=<%=doc_id%>&measure_type=<%=measure_type%>&contract_id=<%=contract_id%>">
												</iframe>
											</div>
											<div id="TD_s_tab_1" style="display: none;">
												<iframe style="funny: expression(autoResize() )"
													id="UserBody1" frameborder="0" width="100%" height="100%"
													src="../contract_zjcs/zjcs_xjl_mark.jsp?contract_id=<%=contract_id%>&doc_id=<%=doc_id%>&market_irr=<%=market_irr%>">
												</iframe>
											</div>
											<div id="TD_s_tab_2">
												<iframe style="funny: expression(autoResize() )"
													id="UserBody2" frameborder="0" width="100%" height="100%"
													src="../contract_zjcs/rentplan_frame.jsp?proj_id=<%=proj_id%>&doc_id=<%=doc_id%>&measure_type=<%=measure_type%>&temp_type=<%=temp_type%>&contract_id=<%=contract_id%>">
												</iframe>
											</div>
											<div id="TD_s_tab_3" style="display: none;">
												<iframe style="funny: expression(autoResize() )"
													id="UserBody3" frameborder="0" width="100%" height="100%"
