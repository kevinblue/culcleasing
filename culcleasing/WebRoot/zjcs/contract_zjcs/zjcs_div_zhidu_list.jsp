...
<table border="0" cellspacing="0" cellpadding="0" width="100%"><tr><td bgcolor="#8DB2E3" width="100%"><img height="1" width="1"></td></tr></table>
	...
	<div id="TD_s_tab_2" >
		<iframe style="funny:expression(autoResize())" id="UserBody2" 
			frameborder="0" width="100%" src="../contract_zjcs/show_contractRentplan.jsp?proj_id=<%=proj_id%>&doc_id=<%=doc_id%>&measure_type=<%=measure_type%>&temp_type=<%=temp_type%>&contract_id=<%=contract_id%>" 
			align="center">
		</iframe>
	</div>
