...
<%
	...
	//央行基准利率表
	String sqlstr = " select * from fund_contract_plan_temp where 1=1  "; 
	//获取查询条件
...
db.close();
%>
      <tr><td nowrap align="left" colspan="7">
      <font color="red">
      	合同编号为:<%=contract_id%>&nbsp;|&nbsp;文档编号为:<%=doc_id%>&nbsp;|&nbsp;财务IRR为:<%=getDBStr(plan_irr)%>&nbsp;%
      </font>
      	</td></tr>
    </table>
  </div>
