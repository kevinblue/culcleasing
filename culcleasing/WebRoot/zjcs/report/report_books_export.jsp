...
<%
	...
	while (rs.next()) {
		...
		for(int i=0;i<list.size();i++){
			...
			String sql2="select dbo.bb_getMonthRent('"+getDBStr(rs.getString("cust_id"))+"','"+l_date_list.get(i/3-1)+"',1) as total_rent";
			...
			String sql2="select dbo.bb_getMonthCorpus('"+getDBStr(rs.getString("cust_id"))+"','"+l_date_list.get(i/3-1)+"',1) as total_corpus ";
			...
			String sql2="select dbo.bb_getMonthInterest('"+getDBStr(rs.getString("cust_id"))+"','"+l_date_list.get(i/3-1)+"',1) as total_interest";
