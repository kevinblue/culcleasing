...
<table border="0" cellspacing="0" cellpadding="0" height="30">
	  <tr>
		<td><a href="frkh_mod.jsp?custId=<%= custId %>"  accesskey="m" title="修改(Alt+M)" class="fontcolor">
...
<div id="TD_tab_0">
	...
	<table border="0" cellspacing="0" cellpadding="0" width="98%" align="center" class="tab_table_title">
	  <tr>
	   ...
	   <tr>
		<td scope="row" nowrap width="15%">法人代表：</td>
	    <td><%=legal_representative %></td>
	    <td scope="row" nowrap width="15%">法人代表身份证号：</td>
	    <td><%=id_card_no %></td>
