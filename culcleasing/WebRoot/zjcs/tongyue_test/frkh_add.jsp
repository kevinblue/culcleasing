...
<td nowrap class="text">客户所属行业中类：</td>
   ...
   <td>企业规模定级：</td>
    ...
    <td nowrap class="text"><input class="text" name="org_code" type="text" maxlength="10" maxB="10"  onchange="CheckOrgCode()" 
    onBlur="codecheck()">
    </td>
   </tr>
   ...
   <img onClick="openCalendar(license_exp_date);return false;" style="cursor:pointer; " src="../../images/fdmo_63.gif" border="0" align="absmiddle">
			...
			<tr>
	<td>备注：</td>
	<td colspan="20" nowrap><textarea class="text" id="memo" name="memo" rows="5" value=""  maxB="300"></textarea></td>
	<td></td>
	<td></td>
   </tr>
