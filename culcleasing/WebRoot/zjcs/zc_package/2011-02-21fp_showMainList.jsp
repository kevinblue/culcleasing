...
<%
	...
	//权限处理  取得登录人的ID
	String dqczy = "ADMN-857CH2";//(String) session.getAttribute("czyid");//ADMN-857CHJ  资产管理部   计划财务部 ADMN-857CH2
	//根据登录人编号查询登录部门名称
      ...
      <td align="center" colspan="2">
        <table width="100%" border="0" cellpadding="0" cellspacing="0" >
          <tr class="maintab">
	        ...
	        <% } %>
            <%if(qx_value.equals("2") && !"审核完毕".equals(status_tem)){//计划财务部才能进入操作，并且‘审核完毕’的发票不允许做任何操作
            	//计划财务部 进入添加发票编号
            %>
            <!--  -->
...
<div style="vertical-align:top;width:100%;overflow:auto;position: relative; left: 0px; top: 0px"  id="mydiv";>
   ...
   <table border="0" style="border-collapse:collapse;" align="center" cellpadding="2" cellspacing="1" width="100%" class="maintab_content_table" >
      <tr class="maintab_content_table_title">
      	 <%if(!"审核完毕".equals(status_tem) || !qx_value.equals("2")){  %>
		<th width="1%"> 选择 </th>
		<%} %>
		<th>编号</th>
		<th>发票编号</th>
