...
%>
	...
	<tr>
	    ...
	    <td>
	    	...
	    	<!-- 登记人  -->
	    	<input type="hidden" name="creator" value="<%=getDBStr(list.get(12))%>" />
			<!-- 登记时间 -->
	    	<input type="hidden" name="create_date"  value="<%=getDBDateStr(list.get(13))%>" />
	    	<!-- 更新人 -->
