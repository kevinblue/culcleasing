...
String zq = getStr(request.getParameter("zq"));
 %>
<form name="form1" method="post" action="zjbcht_save.jsp" onSubmit="return Validator.Validate(this,3);">
...
<%
	...
	int iCount = 0;
	sqlstr = "select count(*) as count from contract_condition where contract_id='" + contract_id + "'"; 
	...
	if(iCount>0){
		...
		sqlstr = "select proj_condition.* from proj_condition inner join contract_info on proj_condition.proj_id = contract_info.proj_id where contract_info.contract_id='"+contract_id+"'";
	}
	System.out.println(sqlstr);
...
<table  border="0" cellspacing="0" cellpadding="0" width="98%" align="center" class="tab_table_title">
  <tr>
    ...
    <td><input name="lease_money" type="text" value="<%=lease_money %>" size="20" dataType="money" maxlength="50" maxB="50" value="<%=lease_money %>"  Require="true">
  ...
  <tr>
	...
	<td><input name="rate_float_type" type="text" value="<%=rate_float_type %>"  dataType="Number" size="20" maxlength="20" maxB="20"  Require="true"><span class="biTian">*</span></td>
  </tr>
   <tr>
