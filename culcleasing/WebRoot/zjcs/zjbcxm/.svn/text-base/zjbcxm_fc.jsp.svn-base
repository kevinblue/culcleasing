...
<title>项目租金测算 - 租金期次</title>
<link href="../../css/global.css" rel="stylesheet" type="text/css">
<script src="../../js/comm.js"></script>
</head>

<body>
<form name="list" target="xj" action="zjbcxm_zj.jsp" method="post">
...
function fun_hl(){
	document.forms[0].action="zjbcxm_zjhl.jsp";
	document.forms[0].target="hl";
	document.forms[0].submit();
}
function fun_xj(){
	document.forms[0].action="zjbcxm_zj.jsp";
