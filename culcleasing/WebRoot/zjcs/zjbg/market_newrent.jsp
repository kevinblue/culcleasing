...
<%
	...
	if (rs.next()) {
		...
		income_number_year = getDBStr(rs
...
<%
   ...
   %>
	<tr class="maintab_content_table_title" >
		...
		<td align="center">
			<%=formatNumberStr(getDBStr(rs.getString("corpus")),"#,##0.00")%>
			<input type="hidden" name="<%=corpus_nameValue%>" value="<%=getDBStr(rs.getString("corpus"))%>"/>
		</td>
		<td align="center">
			<%=formatNumberStr(getDBStr(rs.getString("interest")),"#,##0.00")%>
			<input type="hidden" name="<%=interest_nameValue%>" value="<%=getDBStr(rs.getString("interest"))%>"/>
		</td>
		<td align="center">
			<%=formatNumberStr(getDBStr(rs.getString("corpus_overage")),"#,##0.00")%>
			<input type="hidden" name="<%=corpus_overage_nameValue%>" value="<%=getDBStr(rs.getString("corpus_overage"))%>"/>
