...
<table border="0" cellspacing="0" cellpadding="0" width="100%"><tr><td bgcolor="#8DB2E3" width="100%"><img height="1" width="1"></td></tr></table>
	<div id="TD_s_tab_0" style="display:none;">
		<iframe style="funny:expression(autoResize())" id="UserBody0" 
			frameborder="0" width="100%" src="../zjcs/rentplan_frame_mark.jsp?proj_id=<%=proj_id%>&doc_id=<%=doc_id%>&measure_type=<%=measure_type%>">
		</iframe>
	</div>
	<div id="TD_s_tab_1" style="display:none;"> 
		<iframe style="funny:expression(autoResize())" id="UserBody1" 
			frameborder="0" width="100%" src="../zjcs/zjcs_xjl_mark.jsp?proj_id=<%=proj_id%>&doc_id=<%=doc_id%>&market_irr=<%=market_irr%>">
		</iframe>
	</div>
	<div id="TD_s_tab_2" >
		<iframe style="funny:expression(autoResize())" id="UserBody2" 
			frameborder="0" width="100%" src="../zjcs/show_projrentplan.jsp?proj_id=<%=proj_id%>&doc_id=<%=doc_id%>&measure_type=<%=measure_type%>&temp_type=<%=temp_type%>" 
			align="center">
		</iframe>
	</div>
	<div id="TD_s_tab_3" style="display:none;"> 
		<iframe style="funny:expression(autoResize())" id="UserBody3" 
			frameborder="0" width="100%" src="../zjcs/zjcs_xjl.jsp?proj_id=<%=proj_id%>&doc_id=<%=doc_id%>&plan_irr=<%=plan_irr%>">
		</iframe>
	</div>
</div>
</div>
