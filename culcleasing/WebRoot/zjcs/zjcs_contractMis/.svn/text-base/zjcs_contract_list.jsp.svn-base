					...
					<td align="left" width="1%">
						...
						<table border="0" cellspacing="0" cellpadding="0">
							<tr class="maintab">
								<td>
									<a href="#" accesskey="n"
										onclick="dataHander('add','zjcs_contract_add.jsp?contract_id=<%=contract_id%>&savetype=add&itemselect=',dataNav.itemselect);"><img
								...
								<td>
									<a href="#" accesskey="m"
										onclick="dataHander('mod','zjcs_contract_mod.jsp?contract_id=<%=contract_id%>&savetype=mod&itemselect=',dataNav.itemselect);"><img
								...
								<td>
									<a href="#" accesskey="d"
										onclick="dataHander('del','zics_contract_del.jsp?contract_id=<%=contract_id%>&savetype=del&itemselect=',dataNav.itemselect);"><img
			...
			<div style="vertical-align: top; width: 100%; overflow: auto; position: relative;" id="mydiv";>
				<table border="0" style="border-collapse: collapse;" align="center"
					...
					<tr>
						<td>
						<%
							String plan_status = getDBStr(rs.getString("plan_status"));
