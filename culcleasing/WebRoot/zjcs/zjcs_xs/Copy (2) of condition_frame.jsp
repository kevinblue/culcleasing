...
<table  border="0" cellspacing="0" cellpadding="0" width="98%" align="center" class="tab_table_title">
  ...
  <tr>
    <th>租金支付日期</th>
    <td><input name="income_day" value="<%=income_day %>" type="text"   size="10" maxB="20" dataType="Integer" Re<td><input name="year_rate" value="<%=year_rate %>" type="text"   size="15" maxB="20" dataType="Double" Require="ture"> % <span class="biTian">*</span></td>" dataType="Double" Require="ture"> % <span class="biTian">*</span></td>
    <th>每期租金</th>
