...
//	String income_number =  getStr(request.getParameter("income_number"));
	...
	if(alstage!=null&&alstage.size()>0){
		al = getRentPlan(alstage,dallRent,dallprincipal,income_number,charge_first_date,rent_first_date,0,12/income_number,true);
	}
 %>
...
<div id="TD_tab_0">
	...
	<%if(al!=null&&al.size()>0){
		...
		<td><%=formatNumberStr(String.valueOf(hm.get("corpus_overage")),"#,##0.00") %></td>
      </tr>
	<%}} %>
