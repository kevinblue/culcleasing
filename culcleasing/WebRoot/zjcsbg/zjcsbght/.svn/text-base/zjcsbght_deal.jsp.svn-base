...
<body onload="setDivHeight('divH',-55);fun_rent();"  style="overflow:auto;">
...
<%
	...
	db.close();
 %>
<form name="form1" method="post" action="zjcsbght_save.jsp" onSubmit="return Validator.Validate(this,3);">
...
<BUTTON class="btn_2" name="btnSave" value="保存"  type="button" onclick="if(Validator.Validate(document.getElementById('form1'),3)){fun_save();}">
...
<table  border="0" cellspacing="0" cellpadding="0" width="98%" align="center" class="tab_table_title">
  ...
  <tr>
   ...
   <tr>
	...
	<td><input name="first_payment_ratio" type="text" value="<%=first_payment_ratio %>"  dataType="Rate" size="10" maxlength="10" maxB="10" Require="true" onblur="getMoney(document.forms[0].first_payment_ratio.value,document.forms[0].first_payment,document.forms[0].equip_amt.value);" onPropertychange="fun_sub(document.forms[0].equip_amt.value,document.forms[0].equip_amt.value*document.forms[0].first_payment_ratio.value/100,document.forms[0].lease_money)">%<span class="biTian">*</span></td>
  	...
  	<td>租金首付款</td>
    <td><input name="first_payment" type="text" value="<%=first_payment %>"  dataType="Rate" size="20" maxlength="20" maxB="20"  Require="true" onblur="fun_getRadio(document.forms[0].first_payment.value,document.forms[0].first_payment_ratio,document.forms[0].equip_amt.value)"><span class="biTian">*</span>
	</td>
</tr>
  ...
  <tr>
   ...
   <tr>
	...
	<td>手续费</td>
	<td><input name="handling_charge" type="text" value="<%=handling_charge %>"  dataType="Rate" size="20" maxlength="20" maxB="20"  Require="true"><span class="biTian" onblur="fun_getRadio(document.forms[0].handling_charge.value,document.forms[0].handling_charge_ratio,document.forms[0].equip_amt.value)">*</span></td>
  </tr>
  <tr>
  	<td>厂商返利比率</td>
	...
	<td>厂商返利</td>
	<td><input name="return_amt" type="text" value="<%=return_amt %>"  dataType="Rate" size="20" maxlength="20" maxB="20"  Require="true" onblur="fun_getRadio(document.forms[0].return_amt.value,document.forms[0].return_ratio,document.forms[0].equip_amt.value)"><span class="biTian">*</span></td>
  </tr>
  <tr>
  	<td>监管费比率</td>
  ...
  <tr>
	...
	<td>我司支付的其他费用</td>
	<td><input name="other_fee" type="text" value="<%=other_fee %>"  dataType="Rate" size="20" maxlength="20" maxB="20"  Require="true"><span class="biTian">*</span></td>
  </tr>
  <tr>
  	<td>期末残值（或名义留购价）</td>
  ...
  <tr>
	...
	<td>租金</td>
	<td><input type="hidden" name="allRent"  onPropertyChange="fun_contract()"><input type="text" name="rent" size="20" value="<%=rent %>" dataType="Rate" onPropertyChange="fun_subRent()"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<%if(readonly!=null&&readonly.equals("1")){}else{ %><input type="button" value="预算" onclick="fun_prodRentInterest()"><%} %></td>
  </tr>	
</table>
</div>
</div>
...
function fun_period(varValue){
	fun_period_rent(varValue,"zjcsbght_check.jsp");
}
function fun_interest(){
	fun_interest_rent("zjcsbght_check.jsp");
}

function fun_rentSub(){
	fun_rentSub_rent("zjcsbght_rent.jsp","rentplan");
}
function fun_save(){
		document.forms[0].action="zjcsbght_save.jsp";
