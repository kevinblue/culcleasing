...
<%
	...
	if(rs.next()){
		...
		if(iCount>0){
		plan_irr = formatNumberDoubleFour(getDBStr(rs.getString("plan_irr")));
		}
...
<table  border="0" cellspacing="0" cellpadding="0" width="98%" align="center" class="tab_table_title">
  ...
  <tr>
	...
	<td>租金</td>
	<td><input type="hidden" name="allRent" value="<%=sumrent %>" onPropertyChange="fun_contract()"><input type="text" name="rent" size="20" value="<%=rent %>" dataType="Rate" onPropertychange="fun_subRent('<%=sumrent %>')"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<%if(readonly!=null&&readonly.equals("1")){}else{ %><input type="button" value="预算" onclick="if(Validator.Validate(document.getElementById('form1'),3)){fun_prodRent();}"><%} %></td>
  </tr>	
</table>
...
function fun_rentSub(){
	fun_rentSub_rent("zjcsbght_save.jsp","rentplan","add_deal");
}
function fun_save(){
