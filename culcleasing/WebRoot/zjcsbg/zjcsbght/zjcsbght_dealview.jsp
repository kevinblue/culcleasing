...
<body  style="overflow:auto;"  style="overflow:auto;">
...
<%
	...
	db.close();
 %>
<form name="form1" method="post" action="zjcsbght_deal.jsp" onSubmit="return Validator.Validate(this,3);">
...
function fun_edit(){
		document.forms[0].action="zjcsbght_deal.jsp";
