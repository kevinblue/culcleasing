...
<%
	...
	String second_date = getDateAdd(getSystemDate(0),1,"mm");
	...
	db.close();
 %>
<form name="form1" method="post" action="zjcsbgxm_save.jsp" onSubmit="return Validator.Validate(this,3);">
...
<%if(readonly!=null&&readonly.equals("1")){}else{ %><BUTTON class="btn_2" name="btnSave" value="保存"  type="submit" >
...
<table  border="0" cellspacing="0" cellpadding="0" width="98%" align="center" class="tab_table_title">
  ...
  <tr>
	...
	<td>租金</td>
	<td><input type="hidden" name="readonly" value="<%=readonly %>"><input type="hidden" name="allRent" value="0" onPropertyChange="fun_contract()"><input type="text" name="rent" dataType="Rate" size="20" value="<%=rent %>"  onPropertyChange="fun_subRent()"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" value="预算" onclick="fun_prodRentInterest()"></td>
  </tr>	
</table>
</div>
</div>
...
function fun_rentSub(){
	fun_rentSub_rent("zjcsbgxm_rent.jsp","rentplan");
}
</script>