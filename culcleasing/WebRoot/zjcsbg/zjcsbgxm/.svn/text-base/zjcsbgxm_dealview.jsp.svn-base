...
<%
	...
	int iCount = 0;
	String sqlstr = "select * from proj_condition_temp where proj_id='" + proj_id + "' and measure_id='"+doc_id+"'"; 
	...
	db.close();
 %>
<form name="form1" method="post" action="zjcsbgxm_deal.jsp" onSubmit="return Validator.Validate(this,3);">
...
<%if(readonly!=null&&readonly.equals("1")){}else{ %><BUTTON class="btn_2" name="btnSave" value="取消"  type="submit" >
<img src="../../images/save.gif" align="absmiddle" border="0">取消</button><%} %>
    </td></tr>
</table>
<!--操作按钮结束-->
</td>
...
<table  border="0" cellspacing="0" cellpadding="0" width="98%" align="center" class="tab_table_title">
  <tr>
  	<td width="25%">申请金额（设备金额）</td>
    <td width="25%"><%=equip_amt %>
	</td>
    <td width="25%">租金概算本金</td>
    <td width="25%"><%=lease_money %></td>
  </tr>
  <tr>
  	<td>租赁合同总金额</td>
	<td><%=total_amt %></td>
  ...
  <tr>
	...
	<td><%=rough_earn %></td>
	<td>租金</td>
	<td><input type="hidden" name="rent" size="20" value="<%=rent %>"><%=rent %></td>
