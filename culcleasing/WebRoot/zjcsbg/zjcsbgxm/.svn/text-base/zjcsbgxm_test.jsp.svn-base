...
<%
	...
	if(rs.next()){
		...
		income_number_year = formatNumberDoubleFour(getDBStr(rs.getString("income_number_year")));
	...
	while (rsPena.next()){
		...
		valuePena+="|"+formatNumberDoubleFour(getDBStr(rsPena.getString("pena_rate")));
	}
	rsPena.close();
	db.close();
 %>
...
<table  border="0" cellspacing="0" cellpadding="0" width="98%" align="center" class="tab_table_title">
   <tr>
  	<td>申请金额（设备金额）</td>
    <td><input name="equip_amt" type="text" value="<%=equip_amt %>" dataType="money" size="20" maxlength="100" maxB="100"  Require="true"  onPropertychange="fun_sub(document.forms[0].equip_amt.value,document.forms[0].equip_amt.value*document.forms[0].first_payment_ratio.value/100,document.forms[0].lease_money)"><span class="biTian">*</span>
	</td>
    <td>租金概算本金</td>
    <td><input name="lease_money" type="text" value="<%=lease_money %>" dataType="money" size="20" maxlength="50" maxB="50" value="<%=lease_money %>"  Require="true"  readonly  onPropertychange="fun_corpusToRent()">
    <span class="biTian">*</span></td>
  </tr>
  <tr>
  	<td>租赁合同总金额</td>
	<td><input type="button" value="=" onclick="fun_contract()"><input name="total_amt" type="text" value="<%=total_amt %>" dataType="money" size="20" maxlength="20" maxB="20"  Require="true"><span class="biTian">*</span></td>
  	<td>我司实际需动用资金</td>
    <td><input type="button" value="=" onclick="fun_charge()"><input name="actual_fund" type="text" value="<%=actual_fund %>"  dataType="money" size="20" maxlength="20" maxB="20"  Require="true"><span class="biTian">*</span>
	</td>
</tr>
<tr>
  	<td>还租次数</td>
  ...
  <tr>
	<td>租赁年利率</td>
    <td><input name="year_rate" type="text" value="<%=year_rate %>"  dataType="money" size="10" maxlength="10" maxB="10"  Require="true" onPropertychange="fun_rent()">%<span class="biTian">*</span>
	</td>
	<td>租金计算方式</td>
  ...
  <tr>
	<td>首付款比率</td>
	<td><input name="first_payment_ratio" type="text" value="<%=first_payment_ratio %>"  dataType="money" size="10" maxlength="10" maxB="10"  Require="true" onPropertychange="getMoney(document.forms[0].first_payment_ratio.value,document.forms[0].first_payment,document.forms[0].equip_amt.value);fun_sub(document.forms[0].equip_amt.value,document.forms[0].equip_amt.value*document.forms[0].first_payment_ratio.value/100,document.forms[0].lease_money)">%<span class="biTian">*</span></td>
  
  
  	<td>租金首付款</td>
    <td><input name="first_payment" type="text" value="<%=first_payment %>"  dataType="money" size="20" maxlength="20" maxB="20"  Require="true" onblur="fun_getRadio(document.forms[0].first_payment.value,document.forms[0].first_payment_ratio,document.forms[0].equip_amt.value)"><span class="biTian">*</span>
	</td>
</tr>

  <tr>
	<td>保证金比率</td>
	<td><input name="caution_money_ratio" type="text" value="<%=caution_money_ratio %>"  dataType="money" size="10" maxlength="10" maxB="10"  Require="true" onPropertychange="getMoney(document.forms[0].caution_money_ratio.value,document.forms[0].caution_money,document.forms[0].equip_amt.value);fun_margin();">%<span class="biTian">*</span></td>
  
  	<td>租赁保证金</td>
    <td><input name="caution_money" type="text" value="<%=caution_money %>"  dataType="money" size="20" maxlength="20" maxB="20"  Require="true" onblur="fun_getRadio(document.forms[0].caution_money.value,document.forms[0].caution_money_ratio,document.forms[0].equip_amt.value)"><span class="biTian">*</span>
	</td>
	 </tr>
  <tr>
	<td>承租人保证金比率</td>
	<td><input name="lessee_caution_ratio" type="text" value="<%=lessee_caution_ratio %>"  dataType="money" size="10" maxlength="10" maxB="10"  Require="true" onPropertychange="getMoney(document.forms[0].lessee_caution_ratio.value,document.forms[0].lessee_caution_money,document.forms[0].equip_amt.value)">%<span class="biTian">*</span></td>
 
  <td>承租人保证金金额</td>
	<td><input name="lessee_caution_money" type="text" value="<%=lessee_caution_money %>"  dataType="money" size="20" maxlength="20" maxB="20"  Require="true" onblur="fun_getRadio(document.forms[0].lessee_caution_money.value,document.forms[0].lessee_caution_ratio,document.forms[0].equip_amt.value)"><span class="biTian">*</span></td>
  	</tr>
  <tr>
  	<td>供应商保证金比率</td>
    <td><input name="vndr_caution_ratio" type="text" value="<%=vndr_caution_ratio %>"  dataType="money" size="10" maxlength="10" maxB="10"  Require="true" onPropertychange="getMoney(document.forms[0].vndr_caution_ratio.value,document.forms[0].vndr_caution_money,document.forms[0].equip_amt.value)">%<span class="biTian">*</span>
	</td>
	<td>供应商保证金金额</td>
	<td><input name="vndr_caution_money" type="text" value="<%=vndr_caution_money %>"  dataType="money" size="20" maxlength="20" maxB="20"  Require="true" onblur="fun_getRadio(document.forms[0].vndr_caution_money.value,document.forms[0].vndr_caution_ratio,document.forms[0].equip_amt.value)"><span class="biTian">*</span></td>
  </tr>
  <tr>
  	<td>代理商保证金比率</td>
    <td><input name="sale_caution_ratio" type="text" value="<%=sale_caution_ratio %>"  dataType="money" size="10" maxlength="10" maxB="10"  Require="true" onPropertychange="getMoney(document.forms[0].sale_caution_ratio.value,document.forms[0].sale_caution_money,document.forms[0].equip_amt.value)">%<span class="biTian">*</span>
	</td>
	<td>代理商保证金金额</td>
	<td><input name="sale_caution_money" type="text" value="<%=sale_caution_money %>"  dataType="money" size="20" maxlength="20" maxB="20"  Require="true" onblur="fun_getRadio(document.forms[0].sale_caution_money.value,document.forms[0].sale_caution_ratio,document.forms[0].equip_amt.value)"><span class="biTian">*</span></td>
  </tr>
  <tr>
  	<td>保证金抵扣比率</td>
    <td><input name="caution_deduction_ratio" type="text" value="<%=caution_deduction_ratio %>"  dataType="money" size="10" maxlength="10" maxB="10"  Require="true" onPropertychange="getMoney(document.forms[0].caution_deduction_ratio.value,document.forms[0].caution_deduction_money,document.forms[0].equip_amt.value)">%<span class="biTian">*</span>
	</td>
	<td>保证金抵扣金额</td>
	<td><input name="caution_deduction_money" type="text" value="<%=caution_deduction_money %>"  dataType="money" size="20" maxlength="20" maxB="20"  Require="true" onblur="fun_getRadio(document.forms[0].caution_deduction_money.value,document.forms[0].caution_deduction_ratio,document.forms[0].equip_amt.value)"><span class="biTian">*</span></td>
  </tr>
   <tr>
  	<td>手续费比率</td>
    <td><input name="handling_charge_ratio" type="text" value="<%=handling_charge_ratio %>"  dataType="money" size="10" maxlength="10" maxB="10"  Require="true"  onPropertychange="getMoney(document.forms[0].handling_charge_ratio.value,document.forms[0].handling_charge,document.forms[0].equip_amt.value)">%<span class="biTian">*</span>
	</td>
	<td>手续费</td>
	<td><input name="handling_charge" type="text" value="<%=handling_charge %>"  dataType="money" size="20" maxlength="20" maxB="20"  Require="true"  onblur="fun_getRadio(document.forms[0].handling_charge.value,document.forms[0].handling_charge_ratio,document.forms[0].equip_amt.value)"><span class="biTian">*</span></td>
  </tr>
  <tr>
  	<td>厂商返利比率</td>
    <td><input name="return_ratio" type="text" value="<%=return_ratio %>"  dataType="money" size="10" maxlength="10" maxB="10"  Require="true" onPropertychange="getMoney(document.forms[0].return_ratio.value,document.forms[0].return_amt)">%<span class="biTian">*</span>
	</td>
	<td>厂商返利</td>
	<td><input name="return_amt" type="text" value="<%=return_amt %>"  dataType="money" size="20" maxlength="20" maxB="20"  Require="true" onblur="fun_getRadio(document.forms[0].return_amt.value,document.forms[0].return_ratio,document.forms[0].equip_amt.value)"><span class="biTian">*</span></td>
  </tr>
  <tr>
  	<td>监管费比率</td>
    <td><input name="supervision_fee_ratio" type="text" value="<%=supervision_fee_ratio %>"  dataType="money" size="10" maxlength="10" maxB="10"  Require="true" onPropertychange="getMoney(document.forms[0].supervision_fee_ratio.value,document.forms[0].supervision_fee,document.forms[0].equip_amt.value)">%<span class="biTian">*</span>
	</td>
	<td>监管费</td>
	<td><input name="supervision_fee" type="text" value="<%=supervision_fee %>"  dataType="money" size="20" maxlength="20" maxB="20"  Require="true" onblur="fun_getRadio(document.forms[0].supervision_fee.value,document.forms[0].supervision_fee_ratio,document.forms[0].equip_amt.value)"><span class="biTian">*</span></td>
  </tr>
  <tr>
  	<td>我司支付的介绍费</td>
  ...
  <tr>
	...
	<td>K系数</td>
	<td><input name="redressalk" type="text" value="<%=redressalk %>"  dataType="money" size="10" maxlength="20" maxB="20"  Require="true"><span class="biTian">*</span></td>
  </tr>
  <tr>
  	<td>罚息利率</td>
    <td><select name="pena_rate" Require="true"><script>w(mSetOpt('<%=pena_rate %>',"<%=textPena%>","<%=valuePena%>"));</script></select><span class="biTian">*</span>
  	...
  	<td>年平均收益（静态收益）</td>
    <td><input type="button" value="=" onclick="fun_earn()"><input name="year_earn" type="text" value="<%=year_earn %>"  dataType="money" size="10" maxlength="20" maxB="20"  Require="true"><span class="biTian">*</span>
	</td>
	</tr>
	<tr>
	<td>年内部收益率IRR</td>
	<td><input name="irr" type="text" value="<%=irr %>"  dataType="money" size="10" maxlength="20" maxB="20"  Require="true"><span class="biTian">*</span></td>
  ...
  <tr>
  <td>项目粗利</td>
	<td><input name="rough_earn" type="text" value="<%=rough_earn %>" size="20" maxlength="20" maxB="20"  Require="true"><span class="biTian">*</span></td>
	<td>租金<input type="submit"></td>
	<td><input type="hidden" name="allRent" value="<%=sumrent %>" onPropertyChange="fun_contract()"><input type="text" name="rent" size="20" value="<%=rent %>"  onPropertyChange="fun_subRent('<%=sumrent %>')"><input type="button" value="预算" onclick="fun_prodRent();"></td>
  </tr>	
</table>
</div>
</div>
