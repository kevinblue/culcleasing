...
<%
	...
	int iCount = 0;
	String sqlstr = "select * from proj_condition_temp where proj_id='" + proj_id + "'"; 
	...
	db.close();
 %>
<form name="form1" method="post" action="zjcsbgxm_cdt.jsp" onSubmit="return Validator.Validate(this,3);">
