...
int canedit=0;
if (right.CheckRight("zjwjgl-dywj-view",dqczy)>0) canedit=1;
%>
<script>
if (<%=canedit%>==0){
	window.close();
...
<table border="0" cellspacing="0" cellpadding="0" height="30">
	  <tr>
		...
		<td>
		<%if (right.CheckRight("zjwjgl-dywj-mod",dqczy)>0){ %>
		<a href="dywj_mod.jsp?czid=<%= czid %>"  accesskey="m" title="修改(Alt+M)" class="fontcolor">
