...
int canedit=0;
if (right.CheckRight("zjwjgl-zlwjzt-contract",dqczy)>0) canedit=1;
...
%>
      ...
      <tr>
      	<td align="left"><a href="../htsb/htsb_list.jsp?contract_id=<%= getDBStr( rs.getString("contract_id") ) %>" target="_blank"><%= getDBStr(rs.getString("contract_id") ) %></a></td>
