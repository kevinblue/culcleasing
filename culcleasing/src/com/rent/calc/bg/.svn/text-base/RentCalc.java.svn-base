...
public class RentCalc {
	...
	public String getIrr(String type, List rent_list, List l_plan_date)
		...
		System.out.println("rentCala____rent_list_1"+rent_list_1.size()+"_______l_plan_date_1"+l_plan_date_1);
		// 计算市场的irr
	...
	public static void main(String[] args) throws Exception {
		...
		rent.setLease_money("12000000.00");
