...
public class RentGraceCalc {
	...
	public RentGraceCalc() {

	}

	public RentGraceCalc(String year_rate, String income_number,
	...
	public static void main(String[] args) throws Exception {
		...
		for (int i = 0; i < l_plan_date_.size(); i++) {
			System.out.println("Markirr:"+l_plan_date_.get(i).toString());
		}
		System.out.println("Markirr:"+l_plan_date_.size());
