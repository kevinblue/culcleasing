...
public class RentDelayCalc {
	...
	public RentDelayCalc() {

	}

	public RentDelayCalc(String year_rate, String income_number,
	...
	public String getIrr(String type, List rent_list, List l_plan_date)
		...
		// 添加延期的时间值
		l_plan_date_1 = this.getDelayDateList(this.period_type, Integer
		...
		if ("1".equals(type)) {// 每月计算
			...
			// 租金
			irr.getRentCashFlow(l_plan_date_cw, l_rent_cw);
			// 后期的租金流
			irr.getRentAfterCashFlow(afterDate, afterCash);
			// 时间，资金流的处理类
			irr.getUniqueByDate();
	...
	public HashMap getPlanByEqRent(String p_year_rate, List rent_c_list) {
		...
		List l_corpus_overage = this.getCorpusOvergeList(this.cle_cau_Money,
				l_corpus);
		List l_plan_dt = this.getPlanDateList(l_rent, this.period_type, Integer
				.parseInt(this.delay));
	...
	public static void main(String[] args) throws Exception {
		...
		List l_plan_date_ = rent
				.getPlanDateList(rent_list, rent.period_type, 3);// 计划时间
