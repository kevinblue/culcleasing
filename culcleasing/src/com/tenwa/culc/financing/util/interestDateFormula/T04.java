...
public class T04 {
	 ...
	 * @throws Exception
	 */
	public double getT04Interest(String searchDateStr , String drawingDateStr ,double adjustNumber ,String interestType)  throws Exception{
		T04 T04 = new T04();
		Date date = T04.getSearchDate(searchDateStr, drawingDateStr);
	...
	public Date getSearchDate(String inputDateStr , String drawingDateStr) throws Exception{
		...
		int month = drawingDateMonth/7*6+7;
		...
		if(inputDate.getTime() < compareDate.getTime()){
			...
			int searchMonth = inputDateMonth/7*6+1;
