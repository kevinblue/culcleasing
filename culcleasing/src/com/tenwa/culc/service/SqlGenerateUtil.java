...
public class SqlGenerateUtil {
	...
	public static String generateSelectCondTemp(String proj_id, String doc_id) {
		...
		sqBuffer
				...
				.append(
						"invoice_type,StandardF,StandardIrr,Insure_pay_type from proj_condition_temp");
	...
	public static String generateSelectCondContractTemp(String contract_id,
		...
		sqBuffer
				...
				.append(
						"total_amt,amt_return,apply_contract_number,insure_type,into_batch,insure_money,assets_value,assess_adjust,ratio_param,")
				.append(
						"creator,create_date,modify_date,modificator,invoice_type,StandardF,StandardIrr,insure_pay_type from contract_condition_temp");
	...
	public static String generateSelectBeginInfoTemp(String begin_id,
		...
		sqBuffer
				.append(
						"Select doc_id,contract_id,begin_id,equip_amt,lease_money,actual_fund,assets_value,income_number,income_number_year,")
				.append(
						"lease_term,currency,settle_method,period_type,rate_float_type,rate_float_amt,ratio_param,adjust_style,is_open,")
				.append(
						"plan_bank_name,plan_bank_no,year_rate,pena_rate,start_date,income_day,end_date,plan_irr,fact_irr,rent_start_date,free_defa_inter_day,")
				.append(
						"into_batch,total_amt,amt_return,apply_contract_number,invoice_type,creator,create_date,modify_date,modificator,begin_order_index,factoring")
				.append(" from begin_info_temp ");
