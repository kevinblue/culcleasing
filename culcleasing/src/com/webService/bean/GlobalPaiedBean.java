 ...
 * @author Jaffe
 * 
 * Date:Sep 12, 2011 9:49:24 PM Email:JaffeHe@hotmail.com
 */
public class GlobalPaiedBean {
	private int id;// 关联id号
	private String invcode;// 单据号 年+项目+流水号
	private String bcode;// 项目经理 传入对应的南北编码
	private String rdate;// 实际支付日期 示例格式为：2008-1-1
	private String ccode;// 收款人 传入对应的南北编码
	...
	private String ccodetrust;// 承租客户
	private String nccode;// nc客商编码
	private String settlement;// 是否结汇 0：否； 1：是 仅标识，用以财务识别,提示财务手工添加购汇分录。

	private String pawnsign;// 坐扣标志 0：不坐扣； 1：坐扣 仅标识
	private String pawnrmb;// 坐扣后金额 仅标识
	private String acode;// 支付账号,对应南北编码
	private String o_acode;// 外币账号 - 针对是结汇情况下
	 ...
	 *            the o_acode to set
	 */
	public void setO_acode(String o_acode) {
		this.o_acode = o_acode;
	}
